...
| `position`     | `position`      | Event used to execute some action when the action button on the toast is clicked                                                                                                                                                                         | `"bottomleft" \| "bottomright" \| "topleft" \| "topright"`          | `'bottomleft'` |
...
| ------------------ | -------------------------------------------------------------------------------------------------------------------- | ------------------ |
| `toastButtonClick` | The toast position on the screen. Can be one of: 'topright', 'topleft', 'bottomright', 'bottomleft' (default value); | `CustomEvent<any>` |
