...
| `color`             | `color`      | Specifies the label to use for accessibility. Defaults to the icon name. | `string`               | `'black'`   |
| `height`            | `height`     | Specifies the icon height (eg.: 50)                                      | `string`               | `'32'`      |
...
| `width`             | `width`      | Specifies the icon width (eg.: 50)                                       | `string`               | `'32'`      |
