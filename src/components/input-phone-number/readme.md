...
| `language`             | `language`               | **Nova prop:** Define a linguagem do componente. Valores possíveis: "pt_BR", "en_US", "es_ES". Se nenhum for informado, utiliza o arquivo padrão (countries.json). | `"en_US" \| "es_ES" \| "pt_BR"` | `'pt_BR'`        |
