...
| `contentStyle`   | `content-style`   | Inline styles to be applied to the tab group content element.                                                       | `string`  | `null`      |
...
| `headerStyle`    | `header-style`    | Inline styles to be applied to the tab group header element.                                                        | `string`  | `null`      |
