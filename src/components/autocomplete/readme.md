...
| `language`         | `language`            | Language. Can be one of: 'pt_BR', 'es_ES', 'en_US'.                                                                                                                                                                                                                                           | `"en_US" \| "es_ES" \| "pt_BR"`  | `'pt_BR'`   |
...
| `selected`         | `selected`            | the item selected.                                                                                                                                                                                                                                                                            | `HTMLBdsSelectOptionElement`     | `undefined` |
