...
export class AvatarGroup {
  ...
  * users='[
      {"id": "1", "name": "Michael Scott", "thumbnail": ""},
      {"id": "2", "name": "Dwight Schrute", "thumbnail": ""},
      {"id": "3", "name": "Jim Halpert", "thumbnail": ""},
      {"id": "4", "name": "Pam Beesly", "thumbnail": ""},
      {"id": "5", "name": "Ryan Howard", "thumbnail": ""},
      {"id": "6", "name": "Andy Bernard", "thumbnail": ""}
    ]'
