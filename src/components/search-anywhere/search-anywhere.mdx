...
<Meta title="Components/SearchAnywhere" />
...
<Canvas of={SearchStories.Properties}></Canvas>

<br></br>

As seguintes propriedades são compartilhadas pelo Search Anywhere.
...
<Source of={SearchStories.Events} />
...
<Source of={SearchStories.Methods} />

<br></br>

## Usando no React

<Source of={SearchStories.FrameworkReact} />
