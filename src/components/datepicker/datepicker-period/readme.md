...
| `endDateSelect`   | `end-date-select`   | EndDateSelect. Insert a limiter to select the date period.                                                              | `Date`                          | `null`                            |
...
| `startDateSelect` | `start-date-select` | StartDateSelect. Insert a limiter to select the date period.                                                            | `Date`                          | `null`                            |
...
| ------------------- | ------------------------------------------------------------ | --------------------------------------- |
| `bdsClickDayButton` | bdsClickDayButton. Event to return when click on day button. | `CustomEvent<{ state?: stateSelect; }>` |
| `bdsEndDate`        | bdsEndDate. Event to return selected end date value.         | `CustomEvent<{ value: Date; }>`         |
| `bdsStartDate`      | bdsStartDate. Event to return selected date value.           | `CustomEvent<{ value: Date; }>`         |
