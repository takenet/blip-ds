...
| ------------------------- | -------------------------------------------------------------------------------------------------- | ------------------------------- |
| `bdsEndDate`              | bdsStartDate. Event to return selected end date value.                                             | `CustomEvent<{ value: Date; }>` |
...
| `emptyConcludeDatepicker` | emptyConcludeDatepicker. Event to emit when the datepicker is concluded without any date selected. | `CustomEvent<void>`             |
