...
const Chip = class {
  ...
  render() {
    return (index.h(index.Host, { class: Object.assign(Object.assign(Object.assign({ chip: true }, this.getClickClass()), this.getStateClass()), this.getSizeClass()) }, this.icon && (index.h("div", { class: "chip__icon" }, index.h("bds-icon", { size: "x-small", name: this.icon }))), index.h("slot", null), this.deletable && (index.h("div", { class: "chip__delete", onClick: this.handleClickDelete.bind(this) }, index.h("bds-icon", { size: "x-small", theme: "solid", name: "error" })))));
  }
