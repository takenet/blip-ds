...
const calendar = require('./calendar-aa145c56.js');
...
const DatePicker = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { ref: this.refActionElement, class: { datepicker: true } }, this.typeOfDate == 'single' ? (index.h("div", { class: {
