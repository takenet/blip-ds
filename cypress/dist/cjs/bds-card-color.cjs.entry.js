...
const CardColor = class {
  ...
  render() {
    return (index.h("bds-paper", { class: "card", width: "240px", height: "140px", onClick: () => this.handleCopyVariable(this.variable) }, index.h("bds-grid", { direction: "column", height: "100%" }, index.h("bds-grid", { height: "70%", xxs: "12", class: {
        'card-color--color': true,
        [`card-color--${this.variable}`]: true,
      } }), index.h("bds-grid", { "justify-content": "center", "align-items": "center", height: "30%" }, !this.showMessage ? (index.h("bds-typo", { class: "card-text", variant: "fs-14", bold: "bold" }, "$", this.variable)) : (index.h("bds-typo", { class: "card-text-copie", variant: "fs-14", bold: "bold" }, "Cor copiada!"))))));
  }
};
CardColor.style = cardColorCss;

exports.bds_card_color = CardColor;
