...
const tableBodyCss = ".sc-bds-table-body-h{display:table-row-group;height:64px}.multiple.sc-bds-table-body-h{border-bottom:1px solid var(--color-border-2, #e0e0e0)}.sc-bds-table-body-h:last-child{border-bottom:none}";
