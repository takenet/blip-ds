...
const InputPhoneNumber = class {
  ...
  render() {
    ...
    return (index.h("div", { class: {
      ...
      }, onFocus: this.setFocusWrapper, onBlur: this.removeFocusWrapper, onKeyPress: this.keyPressWrapper }, index.h("div", { class: { element_input: true }, "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { class: {
        input: true,
      ...
      }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { onClick: this.toggle, onKeyDown: this.handleKeyDown.bind(this), "data-test": this.dtSelectFlag, class: "select-phone-number__icon", tabindex: "0" }, index.h("bds-icon", { size: "medium", theme: "solid", name: this.selectedCountry, color: "primary" }), index.h("bds-icon", { size: "x-small", name: iconArrow })), index.h("div", { class: "input__container" }, this.renderLabel(), index.h("div", { class: { input__container__wrapper: true } }, index.h("div", { class: "select-phone-number__country-code" }, index.h("bds-typo", { "no-wrap": "true", variant: "fs-14" }, this.value)), index.h("input", Object.assign({ class: { input__container__text: true }, type: "phonenumber", required: this.required, pattern: "/^(\\(?\\+?[0-9]*\\)?)?[0-9_\\- \\(\\)]*$/", ref: this.refNativeInput, onInput: this.changedInputValue, onFocus: this.onFocus, onBlur: this.onBlur, value: this.text, disabled: this.disabled, "data-test": this.dataTest }, { maxlength: this.value === '+55' ? 25 : null })))), this.success && index.h("bds-icon", { class: "icon-success", name: "check", theme: "outline", size: "xxx-small" }), index.h("slot", { name: "input-right" })), this.renderMessage()), index.h("div", { class: {
        'select-phone-number__options': true,
        'select-phone-number__options--open': this.isOpen,
      } }, this.isOpen &&
      flagsNames.map((flag) => (index.h("bds-select-option", { key: flag, onOptionSelected: this.handler, selected: flag == this.selectedCountry, value: { code: countries$1[flag].code, isoCode: countries$1[flag].isoCode, flag }, status: countries$1[flag].isoCode }, countries$1[flag].name, " ", countries$1[flag].code))))));
  }
