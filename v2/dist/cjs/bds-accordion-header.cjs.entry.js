...
const AccordionHeader = class {
    ...
    render() {
        return (index.h("div", { key: '187061591a0438fad6432f12708fb0b1d6ae2f2a', onClick: this.toggleHeader, class: { accordion_header: true }, "data-test": this.dataTest }, this.avatarName || this.avatarThumb ? (index.h("bds-avatar", { name: this.avatarName, thumbnail: this.avatarThumb, size: "extra-small" })) : (this.icon && index.h("bds-icon", { size: "x-large", name: this.icon, color: "inherit" })), this.accordionTitle && (index.h("bds-typo", { key: '7bdadadb86dc1cc7e5aa85a28e9e6b70b39eed24', bold: "bold", variant: "fs-16", "line-height": "double" }, this.accordionTitle)), index.h("slot", { key: '94a857b65dbdc8ebe1621e4436d8c0414444fd95' }), index.h("bds-icon", { key: '9733311a10ebe3849f53cb13614d52dc56b2b7ab', class: {
                accButton: true,
