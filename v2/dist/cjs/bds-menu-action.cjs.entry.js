...
const BdsMenuAction = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'b9f9caf458a8c3f952795efdd18e0cf90742d8ae', class: {
                menuaction: true,
                [`position-${this.positionSubMenu}`]: true,
            }, onMouseOver: openSubmenu, onMouseOut: closeSubmenu }, index.h("button", { key: '3a522234c26ab1b0046dacf22fea9ba27860ec76', class: {
            ...
            } }, this.iconLeft && index.h("bds-icon", { key: 'ca30051f4ae864827b7b7a20ea1cfd3a60d4bd5c', class: "icon-item", name: this.iconLeft, theme: "outline", size: "small" }), index.h("div", { key: '864cc771bee560c1dc718c8a4effe4c5c01a87f6', class: "content-item" }, this.buttonText && (index.h("bds-typo", { key: 'cd5561a2f0fa704916705d564e873971f42005c8', class: "title-item", variant: "fs-16", tag: "span" }, this.buttonText)), this.subtitle && (index.h("bds-typo", { key: '8ffe3cb6353ee527cd14e3459bf64b6638b6b40c', class: "subtitle-item", variant: "fs-10", tag: "span" }, this.subtitle)), this.description && (index.h("bds-typo", { key: 'fc5287ef56d1deffae836b3857234bf96e2b824e', class: "description-item", variant: "fs-10", tag: "span" }, this.description))), this.subMenu && (index.h("bds-icon", { key: '2d8b4bfbf8e01c958f21537377876390ccb4e5eb', class: { arrow: true }, name: `arrow-${this.positionSubMenu}`, theme: "outline", size: "small" }))), this.subMenu && (index.h("div", { key: 'b31c0aa4bba403d6c047acafa47a6704ec0a7dff', class: {
                menuaction__submenu: true,
                menuaction__submenu__open: this.delaySubMenu,
            }, style: zIndexSubmenu }, index.h("slot", { key: '04001d9ffe36c58fc0515b0fb83397589a40e905' })))));
    }
