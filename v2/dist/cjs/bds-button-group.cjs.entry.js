...
const ButtonGroup = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4e0238820d5167d4a569e33eadb95f90b101358a', class: "button_group" }, index.h("bds-grid", { key: 'd39ddf41a04d2bda4906da8311b8a455d6224f97', direction: this.direction }, index.h("slot", { key: 'c76401b3941e44fee48435a26a1e687d1ab1955d' }))));
    }
