...
const RichText = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: 'c999362f5a4b21be9ea35e1980625340b4a97c83', class: {
                [`rich-text`]: true,
                [`rich-text-${this.positionBar}`]: true,
            }, style: { height: this.height, maxHeight: this.maxHeight }, tabindex: "0", onMouseEnter: () => (this.insideComponent = true), onMouseLeave: () => (this.insideComponent = false) }, index.h("div", { key: '8f332dcee1945fc3987daac92a53fd12b5f7e69b', class: "preview" }, index.h("div", { key: 'c6caf9ad5374c0343d9a399bdfa3ec3269a99c1f', "data-test": this.dataTest, ref: (el) => this.refeditorElement(el), contentEditable: "true", class: "editor-uai-design-system", tabindex: "0", onBlur: this.onBlur, onFocus: this.onFocus, onMouseUp: () => this.updateToolbarState(), onKeyUp: () => this.updateToolbarState(), onKeyDown: (ev) => this.onKeydown(ev), onInput: (ev) => this.onInput(ev), onPaste: this.handlePaste.bind(this) })), index.h("bds-grid", { key: '25293239c232b2892c45f6e752f1e7298a01c1e9', class: {
                [`format-buttons`]: true,
                [`format-buttons-active`]: this.weightButton ||
                    ...
                    this.headingButtons ||
                    this.unstyledButton,
            } }, index.h("div", { key: '966632dc57043dd1713b6e857701d57c85fb9cb1', class: "accordion-header" }, index.h("bds-grid", { key: '7a2d11d1079f43720e2df3672645e180dc6f42cc', ref: (el) => this.refButtonsListElement(el), class: "buttons-list", "flex-wrap": "wrap" }, index.h("div", { key: 'ace7c117765d2380b64f79ae875855b4bd85561c', onFocus: (ev) => this.onFocusEditorBar(ev), tabindex: "1", class: "editor-bar" }), this.weightButton && (index.h("bds-tooltip", { key: '385ba188ddd3626307f2d243bc5ca2656fe03943', "tooltip-text": `${termTranslate(this.language, 'bold')}`, position: "top-center" }, index.h("bds-button", { key: '9afb6bc48df8cb0a3b8ba104c1fbff2a2e57a673', variant: this.buttomBoldActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.wrapSelection(ev, 'b'), "icon-left": "text-style-bold", "aria-label": `${termTranslate(this.language, 'bold')}` }))), this.italicButton && (index.h("bds-tooltip", { key: 'ff3a49cd17525060ba6b2cf80a242b5fecd96044', "tooltip-text": `${termTranslate(this.language, 'italic')}`, position: "top-center" }, index.h("bds-button", { key: 'b66b15f719c5929c4e31723e0ece10318c2e88fc', variant: this.buttomItalicActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.wrapSelection(ev, 'i'), "icon-left": "text-style-italic", "aria-label": `${termTranslate(this.language, 'italic')}` }))), this.strikeThroughButton && (index.h("bds-tooltip", { key: 'e2df95bbfa1ba36613d1cf1ffff5fd08d82fb6d4', "tooltip-text": `${termTranslate(this.language, 'strike')}`, position: "top-center" }, index.h("bds-button", { key: 'f7fe99cace160db06f08b43273ecb926563e0cb7', variant: this.buttomStrikeActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.wrapSelection(ev, 'strike'), "icon-left": "text-style-strikethrough", "aria-label": `${termTranslate(this.language, 'strike')}` }))), this.underlineButton && (index.h("bds-tooltip", { key: '88de01a4002c31e4d728d4a4909dabe05816e081', "tooltip-text": `${termTranslate(this.language, 'underline')}`, position: "top-center" }, index.h("bds-button", { key: 'a831a6304677b4191dd65644e4d27119a8bfedb9', variant: this.buttomUnderlineActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.wrapSelection(ev, 'u'), "icon-left": "text-style-underline", "aria-label": `${termTranslate(this.language, 'underline')}` }))), this.linkButton && (index.h("bds-tooltip", { key: '01454068b357ebf891d802e9333a3ed067e816a1', "tooltip-text": `${termTranslate(this.language, 'link')}`, position: "top-center" }, this.buttomLinkActive ? (index.h("bds-button", { variant: "solid", color: "content", size: "short", onBdsClick: (ev) => this.wrapSelection(ev, 'a'), "icon-left": "link", "aria-label": `${termTranslate(this.language, 'link')}` })) : (index.h("bds-dropdown", { ref: (el) => this.refDropDownLinkElement(el), activeMode: "click", position: "bottom-left" }, index.h("div", { slot: "dropdown-activator" }, index.h("bds-button", { slot: "dropdown-activator", variant: "text", color: "content", size: "short", onBdsClick: (ev) => this.addSelectionLink(ev), "icon-left": "link", "aria-label": `${termTranslate(this.language, 'link')}` })), index.h("bds-grid", { padding: "half", alignItems: "center", gap: "half", slot: "dropdown-content" }, index.h("bds-input", { ref: this.refInputSetLink, onBdsInput: (ev) => this.addLinkInput(ev.detail), style: { flexShrink: '99999' }, placeholder: "adcione o link aqui", onKeyDown: (ev) => this.createLinkKeyDown(ev), tabindex: ((_a = this.dropDownLink) === null || _a === void 0 ? void 0 : _a.open) ? '1' : '-1' }), index.h("bds-button", { disabled: this.buttomLinkValidDisabled, "icon-left": "check", onBdsClick: (ev) => this.createLink(ev), tabindex: ((_b = this.dropDownLink) === null || _b === void 0 ? void 0 : _b.open) ? '1' : '-1', "aria-label": `${termTranslate(this.language, 'link')}` })))))), this.codeButton && (index.h("bds-tooltip", { key: 'a65e96afa027ac8a344d4f16ebb315d3ac7e5ff6', "tooltip-text": `${termTranslate(this.language, 'code')}`, position: "top-center" }, index.h("bds-button", { key: '0e044ca1a38a8629cd999b7e3185bcb951048b87', variant: this.buttomCodeActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.wrapSelection(ev, 'code'), "icon-left": "code", "aria-label": `${termTranslate(this.language, 'code')}` }))), this.alignmentButtons && (index.h("bds-tooltip", { key: 'a907ea4e693f26a6ebadb2a82dfd751257ac8e99', "tooltip-text": `${termTranslate(this.language, 'align_left')}`, position: "top-center" }, index.h("bds-button", { key: '1cd9125f392659548b53c04c3c9ef472913dfac9', variant: this.buttomAlignLeftActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.alignText(ev, 'left'), "icon-left": "align-left", "aria-label": `${termTranslate(this.language, 'align_left')}` }))), this.alignmentButtons && (index.h("bds-tooltip", { key: '43df04f39ef0256cb38f0158ac045b478e5d103d', "tooltip-text": `${termTranslate(this.language, 'align_center')}`, position: "top-center" }, index.h("bds-button", { key: '7d6831ede83bc3f0b42ec884d74564cec93269f5', variant: this.buttomAlignCenterActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.alignText(ev, 'center'), "icon-left": "align-center", "aria-label": `${termTranslate(this.language, 'align_center')}` }))), this.alignmentButtons && (index.h("bds-tooltip", { key: '3d56fd360ce914224048089741936fdf477eb1b5', "tooltip-text": `${termTranslate(this.language, 'align_right')}`, position: "top-center" }, index.h("bds-button", { key: '21b47578fa7e2ed5bf59e77ddbd099287f6176e9', variant: this.buttomAlignRightActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.alignText(ev, 'right'), "icon-left": "align-right", "aria-label": `${termTranslate(this.language, 'align_right')}` }))), this.listButtons && (index.h("bds-tooltip", { key: 'eb1cc7d669fd9f937215a9747c9ca7277644716a', "tooltip-text": `${termTranslate(this.language, 'unordered_list')}`, position: "top-center" }, index.h("bds-button", { key: 'b9b91ead4465548db7aea4624888206d86264947', variant: this.buttomUnorderedListActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.createList(ev, 'ul'), "icon-left": "unordered-list", "aria-label": `${termTranslate(this.language, 'unordered_list')}` }))), this.listButtons && (index.h("bds-tooltip", { key: 'b5996585be69b45a4707175e6bcad4839371eab5', "tooltip-text": `${termTranslate(this.language, 'ordered_list')}`, position: "top-center" }, index.h("bds-button", { key: '7be6ea18bde5e72e09b8d6fc95d876045e6cde71', variant: this.buttomOrderedListActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.createList(ev, 'ol'), "icon-left": "ordered-list", "aria-label": `${termTranslate(this.language, 'ordered_list')}` }))), this.quoteButton && (index.h("bds-tooltip", { key: 'f5242d4211e93e6db6f898140ee58dfea1a7a517', "tooltip-text": `${termTranslate(this.language, 'quote')}`, position: "top-center" }, index.h("bds-button", { key: '8378e9fc27781cec890319dbe2b10bde4b80155a', variant: this.buttomQuoteActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.createHeading(ev, 'blockquote'), "icon-left": "quote", "aria-label": `${termTranslate(this.language, 'quote')}` }))), this.headingButtons && (index.h("bds-tooltip", { key: '452a83d486c55c8755031185c8ef3efbc353f8ec', "tooltip-text": `${termTranslate(this.language, 'h1')}`, position: "top-center" }, index.h("bds-button", { key: 'e3170f33787355fb0b8974331360bcdaf1b9ee13', variant: this.buttomH1Active ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.createHeading(ev, 'h1'), "icon-left": "h-1", "aria-label": `${termTranslate(this.language, 'h1')}` }))), this.headingButtons && (index.h("bds-tooltip", { key: 'ab5529325164c96583eb5dd2743363a9e39e1776', "tooltip-text": `${termTranslate(this.language, 'h2')}`, position: "top-center" }, index.h("bds-button", { key: '47170819d102d5c834e124ed6520beeb151b4915', variant: this.buttomH2Active ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.createHeading(ev, 'h2'), "icon-left": "h-2", "aria-label": `${termTranslate(this.language, 'h2')}` }))), this.headingButtons && (index.h("bds-tooltip", { key: '1e9a0fb32a77be9f8d58cb0c5a46738ff42c9e83', "tooltip-text": `${termTranslate(this.language, 'h3')}`, position: "top-center" }, index.h("bds-button", { key: '413473a94857d81044f59f9af69398ce2d9b7821', variant: this.buttomH3Active ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.createHeading(ev, 'h3'), "icon-left": "h-3", "aria-label": `${termTranslate(this.language, 'h3')}` }))), this.headingButtons && (index.h("bds-tooltip", { key: '9f81171d1a233adc96553da25394ee607a205569', "tooltip-text": `${termTranslate(this.language, 'h4')}`, position: "top-center" }, index.h("bds-button", { key: '368a0cdced53aa7b64f0ee1d8db94048ed803178', variant: this.buttomH4Active ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.createHeading(ev, 'h4'), "icon-left": "h-4", "aria-label": `${termTranslate(this.language, 'h4')}` }))), this.headingButtons && (index.h("bds-tooltip", { key: '334cccec56a39ffb9b867d81c445cf448c8582c3', "tooltip-text": `${termTranslate(this.language, 'h5')}`, position: "top-center" }, index.h("bds-button", { key: '19dce1f1b2640afce07eea39e678afb3e7241ca7', variant: this.buttomH5Active ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.createHeading(ev, 'h5'), "icon-left": "h-5", "aria-label": `${termTranslate(this.language, 'h5')}` }))), this.headingButtons && (index.h("bds-tooltip", { key: '67dde34ae2abc2824954d0fda1bd0fcae37f2123', "tooltip-text": `${termTranslate(this.language, 'h6')}`, position: "top-center" }, index.h("bds-button", { key: '6258c2fc0ac33e1933dd3c600500a535649102ae', variant: this.buttomH6Active ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.createHeading(ev, 'h6'), "icon-left": "h-6", "aria-label": `${termTranslate(this.language, 'h6')}` }))), this.unstyledButton && (index.h("bds-tooltip", { key: 'e4ef415df20e6e71e838fafbeadb22bcbebb4d70', "tooltip-text": `${termTranslate(this.language, 'clear_formatting')}`, position: "top-center" }, index.h("bds-button", { key: '6766c7e88754738af3b61ccc5062d3074d40e76f', variant: "text", color: "content", size: "short", onBdsClick: (ev) => this.clearFormatting(ev), "icon-left": "unstyled", "aria-label": `${termTranslate(this.language, 'clear_formatting')}` })))), index.h("bds-button", { key: '4989f02bc93175d9c474b1a0f33d9f32f17fa55f', id: "buttonAccordion", variant: this.buttomAccordionActive ? 'solid' : 'text', class: "arrow-down", color: "content", size: "short", onBdsClick: () => this.setheaderHeight(), "icon-left": this.positionBar == 'top'
