...
const ChipSelected = class {
    ...
    render() {
        return (index.h(index.Host, { key: '18075d116fbfd2778ead391f6eabe73f4cc4ba9b' }, index.h("div", { key: 'e58dc939ed85f6c0bb8d36fc872a5cc56fc3bda7', class: Object.assign(Object.assign({ chip: true }, this.getStyleChip()), this.getDisabledChip()), onClick: (ev) => this.handleClick(ev), "data-test": this.dataTest }, !this.disabled && index.h("div", { key: 'b8c686322397598a1280c67f2754a48403334266', class: "chip_focus", onKeyDown: this.handleKeyDown.bind(this), tabindex: "0" }), !this.isSelected && !this.disabled && index.h("div", { key: '1c475b5e7a51324f031c2c6953f5116fd2edca9c', class: "chip_darker" }), this.icon && !this.isSelected && (index.h("div", { key: '954ca24707820e1780f9cd78bdd1c79a1645b921', class: "chip--icon" }, index.h("bds-icon", { key: '1fe6e7a56d1cdf2e94bef4ef8c845c364de6d77d', size: this.getSizeIconChip(), name: this.icon }))), this.isSelected && (index.h("div", { key: '83da6efe0dd55781a4a94c47974be22d313a94a0', class: "chip_selected--icon" }, index.h("bds-icon", { key: '5b8de80b511814c2315654c9dd0a69cdaa7b8ba1', size: this.getSizeIconChip(), name: "checkball" }))), index.h("div", { key: 'b1f1d265c4bcf4bbd05dc35bbd8aeca99c2bdeb4', class: this.isSelected ? `chip_selected--container-text--half` : `chip_selected--container-text--full` }, index.h("bds-typo", { key: '6245650ace38bb0ef3115c61e84fb1ccf75396e3', class: Object.assign({ 'chip--text': true }, this.getStyleText()), variant: "fs-12", "no-wrap": true, bold: "bold" }, index.h("slot", { key: 'd9c7d48ada626b245e5b9eefe1cc029649eb56bf' }))))));
    }
