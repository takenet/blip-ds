...
const BdsAutocomplete = class {
    constructor(hostRef) {
        ...
        this.bdsSelectedChange = index.createEvent(this, "bdsSelectedChange");
        this.bdsMultiselectedChange = index.createEvent(this, "bdsMultiselectedChange");
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '47da2306938ead7f3213d58f83e97de5151ca080', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '2f41a9eecd8d97614d55664ea7303a7e6b08df3c', class: {
                input: true,
                select: true,
            ...
            }, onClick: this.onClickWrapper }, this.renderIcon(), index.h("div", { key: 'd4a2d0601d51d230890b4d174b7528a957f8b983', class: "input__container", tabindex: "0", onFocusout: this.onFocusout }, this.renderLabel(), index.h("div", { key: '143fc2050114825c17c17a4b8ccb5a7f61e27390', class: { input__container__wrapper: true } }, ((_a = this.textMultiselect) === null || _a === void 0 ? void 0 : _a.length) > 0 && (index.h("bds-typo", { key: 'f5e0c78723a41d3062d0aaa499b2325ae11ab024', variant: "fs-14", class: "inside-input-left" }, this.textMultiselect)), index.h("input", { key: '945e986b720854b838f86e4ea1ff55e1b4e729a0', class: { input__container__text: true }, ref: (input) => (this.nativeInput = input), disabled: this.disabled, onBlur: this.onBlur, onFocus: this.onFocus, onInput: this.changedInputValue, placeholder: this.placeholderState, type: "text", value: this.text, "data-test": this.dataTest, onKeyDown: this.keyPressWrapper.bind(this) }))), index.h("div", { key: '312eaafa0abf780aba1bed1d168dd9cc34ad6d60', class: "select__icon" }, index.h("bds-icon", { key: 'ce8c766e9407b13c84270a20ee11017ea3cde6fc', size: "small", name: "error", theme: "solid", onClick: this.cleanInputSelection, class: {
                'icon-hidden': (this.clearIconOnFocus && (!this.isFocused || !this.isOpen)) || !this.value,
            } }), index.h("bds-icon", { key: '7f9bb1b87a173c68fac35d444abeb6bf5efeca36', ref: (el) => this.refIconDrop(el), size: "small", color: "inherit" }))), this.renderMessage(), this.loading ? (index.h("div", { ref: (el) => this.refDropdown(el), class: {
                select__options: true,
                'select__options--open': this.isOpen,
            } }, index.h("bds-loading-spinner", { class: "load-spinner", size: "small" }))) : (index.h("div", { ref: (el) => this.refDropdown(el), class: {
                select__options: true,
                'select__options--open': this.isOpen,
            } }, this.selectionTitle && this.selectionType == 'multiple' && (index.h("bds-typo", { class: "selection-title", variant: "fs-10", bold: "bold" }, this.selectionTitle)), this.selectionType == 'multiple' && this.selectedAll && (index.h("bds-checkbox", { ref: this.refCheckAllInput, refer: `refer-multiselect`, label: `Selecionar Todos`, name: "chack-all", class: "select-all", onBdsChange: (ev) => this.handleCheckAll(ev) })), ((_b = this.checkedOptions) === null || _b === void 0 ? void 0 : _b.length) > 0 && (index.h("span", { class: "content-divisor" }, index.h("span", { class: "divisor" }))), this.internalOptions ? (this.internalOptions.map((option, idx) => (index.h("bds-select-option", { onOptionSelected: this.handler, onOptionChecked: this.handlerMultiselect, selected: this.value === option.value, value: option.value, key: idx, bulkOption: option.bulkOption, status: option.status, "type-option": this.selectionType == 'multiple' ? 'checkbox' : 'default' }, option.label)))) : (index.h("slot", null))))));
    }
...
//# sourceMappingURL=bds-autocomplete.entry.cjs.js.map

//# sourceMappingURL=bds-autocomplete.cjs.entry.js.map