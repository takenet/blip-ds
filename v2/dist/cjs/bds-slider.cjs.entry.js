...
const Slider = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0cb0e5d7feb24f152bfe4bf0857ffba9349710e0' }, index.h("input", { key: '6ea98a9753d17a41f00e2d894946d1d55ca13adf', ref: this.refInputSlide, type: "range", class: {
                input_slide: true,
            }, value: this.value, onInput: this.onInputSlide, onMouseEnter: this.onInputMouseEnter, onMouseLeave: this.onInputMouseLeave, "data-test": this.dataTest }), index.h("div", { key: '69b4b78e7c790810d48a5dfaffa9934fa489501e', class: "track-bg" }, index.h("div", { key: 'c18f68a9847341c0ac50b3c82d2c5f86ad2db97a', class: { [`progress-bar`]: true, [`progress-bar-liner`]: this.type !== 'no-linear' }, ref: this.refProgressBar }, index.h("bds-tooltip", { key: '4f3be35713caddf9405137a10bc171e912220cae', ref: this.refBdsTooltip, class: { [`progress-bar-tooltip`]: true }, position: "top-center", "tooltip-text": this.inputValue }, index.h("div", { key: '17f6bf6c8a67c2bd23cc8cfac831c851c89489d6', class: { [`progress-bar-thumb`]: true } }))), this.markers &&
