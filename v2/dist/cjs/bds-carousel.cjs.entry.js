...
const BdsCarousel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '2bdd066c0585b3b11ec1fda97f2b7e82f2e95515', class: { carousel: true } }, index.h("div", { key: '0abfe9d65269861509bbdb0b359bda36edc25b5e', class: {
                carousel_slide: true,
                carousel_slide_fullwidth: this.arrows != 'outside',
                [`carousel_slide_state_${this.autoplayState}`]: this.autoplay,
            }, tabindex: "0", onKeyDown: (ev) => this.setKeydownNavigation(ev), "data-test": this.dtSlideContent }, index.h("div", { key: 'a976fd196209f58b0c7033483fc4607fbe50ba05', ref: (el) => this.refFrame(el), class: { carousel_slide_frame: true, carousel_slide_frame_loading: this.loading }, onMouseOver: () => this.onMouseOver(), onMouseOut: () => this.onMouseOut(), onMouseDown: (ev) => this.onMouseDown(ev), onMouseEnter: () => this.onMouseEnter(), onMouseUp: () => this.onMouseUp(), onMouseMove: (ev) => this.onMouseMove(ev) }, index.h("div", { key: 'b1aba391c3b39929d77d6b018a6ec8bedbdcc7ee', ref: (el) => this.refFrameRepeater(el), class: { carousel_slide_frame_repeater: true } }, index.h("slot", { key: 'ef83b21899e9b764efba50776d283b747799513e' }))), index.h("bds-grid", { key: '00596912dfa7d3327de9b927a21f76c46baa4165', class: { carousel_slide_loading: true, carousel_slide_loading_visible: this.loading } }, index.h("bds-skeleton", { key: 'ec24848fcf4192ab5bb466052f5df8f5e3173283', height: "100%", shape: "square", width: "100%" })), this.arrows != 'none' && !this.loading && (index.h(ThemeOrDivArrows, { key: '44b6c5401f33bf1e2ae5294a3da96f9c3dc3aceb', ref: (el) => this.refThemeProviderArrows(el), class: {
                carousel_buttons: true,
                carousel_buttons_fullwidth: this.arrows != 'outside',
            } }, index.h("bds-button", { key: 'af28b8506a05d27d0473ab881c9ef11721347efb', variant: "text", iconLeft: "arrow-left", color: "content", onBdsClick: () => this.prevSlide(), disabled: !this.infiniteLoop && this.itemActivated <= 1, dataTest: this.dtButtonPrev }), index.h("bds-button", { key: 'a4e8bd3aaa3f2e841c90b1a597fa4aae52c218cf', variant: "text", iconLeft: "arrow-right", color: "content", onBdsClick: () => this.nextSlide(), disabled: !this.infiniteLoop && this.itemActivated >= this.internalItens.length, dataTest: this.dtButtonNext })))), this.internalItens.length > 1 && this.bullets != 'none' && (index.h("div", { key: '17ba8028515022882737f7306e5fbccf30ee91b8', class: {
            ...
            } }))))))))))), index.h("slot", { key: 'ad0704a55d0cae0e4452b304a43f30a862a62a8c', name: "after" })));
    }
