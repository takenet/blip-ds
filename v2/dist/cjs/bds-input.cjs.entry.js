...
const Input = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a40007ea074c137d2388f727115557269a61a62e', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '5df5d9917959a69cbe5b17c3677d48e8abae86d1', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("slot", { key: '5af4646c99c554b8fbc4c207ff1a25ed529eeaed', name: "input-left" }), index.h("div", { key: 'd2a4be8f9127096d9bc9aebc99ea802cdb5d54ec', class: "input__container" }, this.renderLabel(), index.h("div", { key: '69a222cdfd0dc12e30eb5e162d0a48107fc4f8b0', class: { input__container__wrapper: !this.chips, input__container__wrapper__chips: this.chips } }, index.h("slot", { key: 'd2a6f7518106c52b49693d3ff3c50c2c13410494', name: "inside-input-left" }), index.h(Element, { key: '5a436cdda58f5763f69fde3143789f486171da24', class: { input__container__text: true, input__container__text__chips: this.chips }, ref: (input) => (this.nativeInput = input), rows: this.rows, cols: this.cols, autocapitalize: this.autoCapitalize, autocomplete: this.autoComplete, disabled: this.disabled, min: this.min, max: this.max, minLength: this.minlength, maxLength: this.maxlength, name: this.inputName, onBlur: this.onBlur, onFocus: this.onFocus, onInput: this.onInput, placeholder: this.placeholder, readOnly: this.readonly, type: this.type, value: this.encodeValue(this.value), pattern: this.pattern, required: this.required, part: "input", "data-test": this.dataTest }))), this.counterLength && (index.h("bds-counter-text", Object.assign({ key: '285d5ad9a5d5cfe07658d4646b5a9cc93d8beddb', length: this.value.length, max: this.maxlength, active: isPressed }, this.counterLengthRule))), this.success && index.h("bds-icon", { key: '3bbf5a4308a3c1b0788b014aeb71f0f47ffcb269', class: "icon-success", name: "check", theme: "outline", size: "small" }), index.h("slot", { key: '90444f5d49a8a4b225220cecdbc4e57e8f20c7ba', name: "input-right" })), this.renderMessage()));
    }
