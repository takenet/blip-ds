...
const Radio = class {
    ...
    render() {
        return (index.h(index.Host, { key: '31adeb4809c2ef3eacd5bddfbda001bc8e288baa' }, index.h("label", { key: '99574dc9df08079070fc19e45004e4714953d3ea', class: "radio", htmlFor: this.radioId }, index.h("input", { key: '035f95804233ce3138ccb0b47c2ebe44f637f7cd', class: "radio__input", type: "radio", ref: this.refNativeInput, id: this.radioId, onClick: this.onClick, disabled: this.disabled, checked: this.checked, value: this.value, name: this.name, "data-test": this.dataTest }), index.h("div", { key: '4aedd309c53fc1b2211eb5c8ce20a86474273658', class: "radio__circle" }, !this.disabled ? index.h("div", { class: "focus", tabindex: "0", onKeyDown: this.handleClickKey.bind(this) }) : '', !this.disabled ? index.h("div", { class: "hover" }) : '', index.h("div", { key: '48c8bf51b4be33284f022e2d9be4308de2b33492', class: "radio__circle__pointer" })), this.label && (index.h("bds-typo", { key: 'd2b8e9bd1552417eb048fa947914f721055d6200', class: "radio__text", variant: "fs-14", bold: this.checked ? 'bold' : 'regular', tag: "span" }, this.label)), index.h("slot", { key: '2232a5f27aee2679af81cafb73ff0f0b368b216e' }))));
    }
...
const Switch = class {
    ...
    render() {
        ...
        return (index.h("label", { key: '95d3b92232abd0273a9ae86320d4a2a41f09cdaa', class: { [sizeClass]: true } }, index.h("div", { key: '92cf268fc85154d8bd1975687ae1865fb70278d6', tabindex: "0", onKeyDown: (ev) => this.handleClick(ev), class: "focus" }), index.h("input", { key: '1374eac16eccccd6801dfe3345e3b75677d025fa', type: "checkbox", ref: this.refNativeInput, id: this.switchId, name: this.name, onClick: this.onClick, checked: this.checked, disabled: this.disabled, "data-test": this.dataTest }), index.h("span", { key: '24b47125aecef86886ece5536c1e639bf8665c03', class: { [sizeSliderClass]: true, [styleState]: true } })));
    }
    static get watchers() { return {
        "checked": ["checkedChanged"]
    }; }
