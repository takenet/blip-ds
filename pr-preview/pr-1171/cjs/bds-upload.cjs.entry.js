...
const bdsUploadCss = ".upload{min-width:400px;display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;gap:16px}.upload .upload-header{display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-wrap:nowrap;flex-wrap:nowrap;-ms-flex-align:center;align-items:center;gap:8px;color:var(--contents-content-primary, var(--color-content-default, #282828))}.upload .upload-header_text{color:var(--contents-content-primary, var(--color-content-default, #282828));display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column}.upload__edit--label{display:-ms-flexbox;display:flex;-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center;border:1px solid var(--borders-border-actions, var(--color-border-2, rgba(0, 0, 0, 0.16)));border-radius:8px;cursor:pointer;font-weight:normal;-webkit-box-sizing:border-box;box-sizing:border-box;padding:23px 16px;position:relative}.upload__edit--label::before{content:\"\";position:absolute;inset:-4px;border:2px solid transparent;border-radius:4px}.upload__edit--label:focus-visible{outline:none}.upload__edit--label:focus-visible::before{border-color:var(--color-focus, #c226fb)}.upload__edit--label .upload__img--visible{display:-ms-flexbox;display:flex;width:100%;height:100%;border-radius:8px;position:absolute;background-color:var(--color-surface-2, #ededed);z-index:1}.upload__edit--label .text-box{display:-ms-flexbox;display:flex;padding:8px;width:100%;text-align:center;z-index:2}.upload__edit--label .text-box .text{color:var(--contents-content-primary, var(--color-content-default, #282828));width:100%;-ms-flex-wrap:wrap;flex-wrap:wrap}.upload__edit--label .text-box--hover{background-color:var(--color-surface-2, #ededed)}.upload__edit--label .text-box--hover .text{color:var(--actions-action-primary-default, var(--color-primary, #1e6bf1))}.upload__edit--label:hover{border:2px solid var(--actions-action-primary-default, var(--color-primary, #1e6bf1));-webkit-box-sizing:border-box;box-sizing:border-box;padding:22px 16px;cursor:pointer;-webkit-text-decoration:underline var(--actions-action-primary-default, var(--color-primary, #1e6bf1));text-decoration:underline var(--actions-action-primary-default, var(--color-primary, #1e6bf1));color:var(--color-brand, #0096fa)}.upload__edit--label:hover .text{color:var(--actions-action-primary-default, var(--color-primary, #1e6bf1))}.upload__edit--hover{background-size:cover;border:1px dashed var(--color-surface-4, #141414);color:var(--actions-action-primary-default, var(--color-primary, #1e6bf1));font-weight:bold;border-radius:8px}.upload__img--invisible{display:none}.list-preview{border-top:1px solid var(--borders-border-actions, var(--color-border-2, rgba(0, 0, 0, 0.16)));border-bottom:1px solid var(--borders-border-actions, var(--color-border-2, rgba(0, 0, 0, 0.16)));max-height:200px;overflow-y:auto}.upload__preview{-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center;width:100%;padding:16px 0}.upload__preview .preview{display:-ms-flexbox;display:flex;padding:0 16px;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center;-ms-flex-direction:row;flex-direction:row;-ms-flex-wrap:nowrap;flex-wrap:nowrap;gap:8px}.upload__preview .preview-text{font-family:\"Nunito Sans\", \"Carbona\", \"Tahoma\", \"Helvetica\", \"Arial\", sans-serif;font-size:0.875rem;font-weight:700;margin:0;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;width:100%;color:var(--contents-content-primary, var(--color-content-default, #282828))}.upload__preview .preview-icon{color:var(--contents-content-primary, var(--color-content-default, #282828))}.upload__preview .preview-icon:hover{cursor:pointer}.preview-length{display:-ms-flexbox;display:flex;-ms-flex-pack:end;justify-content:end;padding-top:16px;text-align:end}.upload__edit input{position:absolute;left:0;top:0;right:0;bottom:0;opacity:0;width:0;height:100%}";
