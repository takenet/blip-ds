...
const ChipClickable = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: {
      ...
      }, onClick: this.handleClick.bind(this), "data-test": this.dataTest, part: "chip" }, this.clickable && !this.disabled && (index.h("div", { class: "chip_focus", onKeyDown: this.handleClickKey.bind(this), tabindex: "0" })), this.clickable && !this.disabled && index.h("div", { class: "chip_darker" }), this.icon && !this.avatar && (index.h("div", { class: "chip_clickable--icon" }, index.h("bds-icon", { size: this.getSizeIconChip(), name: this.icon }))), this.avatar && (index.h("div", { class: "chip_clickable--avatar" }, index.h("bds-avatar", { size: this.getSizeAvatarChip(), thumbnail: this.avatar }))), index.h("div", { class: this.close && (this.icon || this.avatar)
