...
const ChipClickable = class {
    ...
    render() {
        return (index.h(index.Host, { key: '81b8b0eabe8b60422dd6c37db95ff24efd0cce9e' }, index.h("div", { key: '0c5ea22d5ac037ec92bb1425de62d89e33b3af23', class: {
                chip_clickable: true,
            ...
            }, onClick: this.handleClick.bind(this), "data-test": this.dataTest }, this.clickable && !this.disabled && (index.h("div", { key: 'd64148a7990a7122cb83600eeeb0eabe98798597', class: "chip_focus", onKeyDown: this.handleClickKey.bind(this), tabindex: "0" })), this.clickable && !this.disabled && index.h("div", { key: 'f6c388e3b8cd375e90289fe1fd628f292a42999b', class: "chip_darker" }), this.icon && !this.avatar && (index.h("div", { key: '89720d37fb9d2bac99b11267ec0f458a2fe74ea6', class: "chip_clickable--icon" }, index.h("bds-icon", { key: '9ba8e5137ae728faca79e103069499aff6286640', size: this.getSizeIconChip(), name: this.icon }))), this.avatar && (index.h("div", { key: '24c88bd4c3ece279eddd8135591ab7c997aded43', class: "chip_clickable--avatar" }, index.h("bds-avatar", { key: '208b5f035f751f13cc4729587e7fc1b5b4fcc82c', size: this.getSizeAvatarChip(), thumbnail: this.avatar }))), index.h("div", { key: 'ded99799cc37face13162b83114f197b0cdfe9df', class: this.close && (this.icon || this.avatar)
                ? `chip_clickable--container-text--min`
                : !this.close && !this.icon && !this.avatar
                    ? `chip_clickable--container-text--full`
                    : `chip_clickable--container-text--half` }, index.h("bds-typo", { key: '905058defcc0423413fd0d1319323baf8339820f', "no-wrap": "true", class: "chip_clickable--text", variant: "fs-12", bold: "bold" }, index.h("slot", { key: '121970910a177829ddf0d67d5198bdc0d4911384' }))), this.close && (index.h("div", { key: '603693e1efa1e6f8a6ac152c217c5748515d7566', class: "chip_clickable--close", "data-test": this.dtButtonClose, onClick: this.handleCloseChip.bind(this) }, !this.disabled && (index.h("div", { key: 'f6b41aae039740f488c8b9f91eada9441d3e0d5c', class: "close_focus", onKeyDown: this.handleCloseKey.bind(this), tabindex: "0" })), index.h("bds-icon", { key: '5823d24b3ee1939dcb8d0638f74eea7be517674c', size: "x-small", theme: "solid", name: "error" }))))));
    }
...
const Tooltip = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '00b09b6886eb74ac91fbea2c9fbe3d792d5bd6cb', class: "tooltip__wrapper" }, index.h("div", { key: 'e5026004be5450694921a9741f070f620dab6924', onMouseEnter: () => this.setVisibility(true), onMouseLeave: () => this.setVisibility(false), "data-test": this.dataTest }, index.h("slot", { key: 'ea0363fa79c3ab2ee36cc0d981025a9dc51cf403' })), index.h("div", { key: 'cb0da1586a8e66456295a212cfabb1e51831c123', class: {
                tooltip__tip: true,
                [`tooltip__tip--${this.position}`]: true,
                'tooltip__tip--visible': this.isMouseOver,
            }, style: styleTooltip }, index.h("div", { key: '3c5bf7638affb6719452ed26d67675028cb39510', class: { tooltip__tip__text: true } }, index.h("pre", { key: 'd330774b5fd7140bf3f7ccb75dc096f33162d587' }, index.h("bds-typo", { key: 'df2356e9b99a38cb444ed77b283fdedd0c331770', class: "text", "no-wrap": "false", variant: "fs-12" }, this.textVerify))))));
    }
