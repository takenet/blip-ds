...
const BannerLink = class {
    ...
    render() {
        const Element = 'a';
        return (index.h(Element, { key: '5d7ce8c2e9663e11c34610edfb8133e893f407d8', class: { banner__link: true }, onClick: () => this._buttonClickHandler(), "data-test": this.dataTest, tabindex: "0", onKeyDown: this.handleKeyDown.bind(this) }, index.h("slot", { key: 'c3f618d5db27a6aeef57f661b53802ea3af9137d' })));
    }
