...
const InputChips = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ae5fdf3d95807c83b9b5e81eeef4782cac9316af', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '8ca2526c4353082c3d227f01d020c3908d126800', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: '23b349e9cdb6c3035ff7b4d62876beb1b0733515', class: "input__container" }, this.renderLabel(), index.h("div", { key: '132f0e710d9773084cb88cc2f647e958b8320f2f', class: "input__container__wrapper", style: { maxHeight: defaultMaxHeight } }, this.internalChips.length > 0 && this.renderChips(), this.inputAvalible && (index.h("input", { key: 'ef690b5a9367aa773d65e11690a98947d723d9f0', ref: (input) => (this.nativeInput = input), class: "input__container__text", name: this.inputName, maxlength: this.maxlength, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: () => this.handleOnBlur(), onChange: () => this.handleChange, value: this.value, disabled: this.disabled, "data-test": this.dataTest })))), this.counterLength && (index.h("bds-counter-text", { key: '6747088cfec73602069b661d29633398e4eff7f2', length: this.internalChips.length, max: this.maxChipsLength, active: isPressed })), this.success && index.h("bds-icon", { key: '3110be0f222d16ed634bb41dd27ad4cc7b1c984c', class: "icon-success", name: "checkb", theme: "outline", size: "xxx-small" }), index.h("slot", { key: 'b85a812ba1f675c4090f60a1428449190bb8812f', name: "input-right" })), this.renderMessage()));
    }
