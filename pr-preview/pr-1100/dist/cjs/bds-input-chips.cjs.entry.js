...
const InputChips = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '02f79ea658967807a3fa6cb5d8ca13a085683fac', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '649e393605dcb8234feb5d630993d9509a8746fd', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: '64dfdd42e3d0d9f73c18fa34b562f037056ca05d', class: "input__container" }, this.renderLabel(), index.h("div", { key: '89225c3d468be28f514525fbe060f5cc4cb5a025', class: "input__container__wrapper", style: { maxHeight: defaultMaxHeight } }, this.internalChips.length > 0 && this.renderChips(), this.inputAvalible && (index.h("input", { key: 'fd3f935d074cf8dd6610a3c4c999430531b7f290', ref: (input) => (this.nativeInput = input), class: "input__container__text", name: this.inputName, maxlength: this.maxlength, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: () => this.handleOnBlur(), onChange: () => this.handleChange, value: this.value, disabled: this.disabled, "data-test": this.dataTest })))), this.counterLength && (index.h("bds-counter-text", { key: 'ee920b84e605fda1c333ddf1b48372e8fa1791d2', length: this.internalChips.length, max: this.maxChipsLength, active: isPressed })), this.success && index.h("bds-icon", { key: 'e11abf98d6e67930faad94617c822e36f861cbeb', class: "icon-success", name: "checkb", theme: "outline", size: "xxx-small" }), index.h("slot", { key: 'b309274b164b48671b2a2944c506a2747dabd3c7', name: "input-right" })), this.renderMessage()));
    }
