...
const InputChips = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '59cad1eb9ac2f46e8b8d9836c7f13f589841ee8b', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '9ded5251da6bd6f1dfe9fd4115f126d667ff38f8', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: '248f5fdd749259435bee42fd1f9d1cf896f48905', class: "input__container" }, this.renderLabel(), index.h("div", { key: 'b7b389aa6733a9922f8d414d852cbd7495023e7c', class: "input__container__wrapper", style: { maxHeight: defaultMaxHeight } }, this.internalChips.length > 0 && this.renderChips(), this.inputAvalible && (index.h("input", { key: 'b60d1c8a5b74a8b18cd6db6640d4111ecd16074a', ref: (input) => (this.nativeInput = input), class: "input__container__text", name: this.inputName, maxlength: this.maxlength, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: () => this.handleOnBlur(), onChange: () => this.handleChange, value: this.value, disabled: this.disabled, "data-test": this.dataTest })))), this.counterLength && (index.h("bds-counter-text", { key: '4bd71775e14dae9ffc000e2190804c4fe7589f9b', length: this.internalChips.length, max: this.maxChipsLength, active: isPressed })), this.success && index.h("bds-icon", { key: '1d514a39031a29f23a55c1da77a71f33101b5369', class: "icon-success", name: "checkb", theme: "outline", size: "xxx-small" }), index.h("slot", { key: 'ec299d447670bf8054114771b5dbeabf12df4d66', name: "input-right" })), this.renderMessage()));
    }
