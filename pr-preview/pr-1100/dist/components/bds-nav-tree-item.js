...
const NavTreeItem = /*@__PURE__*/ proxyCustomElement(class NavTreeItem extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["bds-nav-tree-item", "bds-icon", "bds-loading-spinner", "bds-typo"];
    components.forEach(tagName => { switch (tagName) {
        case "bds-nav-tree-item":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NavTreeItem);
            }
            break;
        case "bds-icon":
            if (!customElements.get(tagName)) {
...
const BdsNavTreeItem = NavTreeItem;
const defineCustomElement = defineCustomElement$1;

export { BdsNavTreeItem, defineCustomElement };
//# sourceMappingURL=bds-nav-tree-item.js.map
