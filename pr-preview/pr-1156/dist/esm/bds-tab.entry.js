...
const Tab = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'b08806f1115a70b9c3700d7762c979f4857abb25', class: {
                'bds-tab': true,
                ['bds-tab--selected']: this.isActive,
            }, onClick: this.onClick.bind(this) }, h("div", { key: '93a46aa1c5c627c70cd15741e47cfd8389dcb311', class: "bds-tab__text" }, h("bds-typo", { key: 'b6a81e0205e19c592e6d34de3cb167daf88c2824', variant: "fs-16", bold: bold }, this.label))));
    }
};
Tab.style = tabCss;
