import { r as registerInstance, c as createEvent, h } from './index-BALoTlPi.js';
import { T as THIS_DAY, b as dateToDayList, f as fillDayList, h as fillDate, w as weekDays, i as getMonthsSlide, j as getYears, k as getMonths, l as changeMonths, d as defaultStartDate, a as defaultEndDate } from './calendar-DL5vi8uh.js';
...
const BdsdatepickerSingle = class {
    ...
    render() {
        return (h("div", { key: 'f18cdf61f2bf6ac67f1dcc9178762d473aaf86c5', class: { datepicker__calendar: true } }, h("div", { key: 'df465130eec882d099c12729b11d448fc999a3aa', class: { datepicker__calendar__selectDate: true } }, h("bds-icon", { key: 'f729599ddcf8d28e174ca1d59c3d09d4b8ac4f07', class: {
                [`arrow-left`]: true,
                [`arrow-left__disable`]: fillDayList(this.monthsSlide[0].days[this.monthsSlide[0].days.length - 1]) <
                    fillDayList(this.startDate),
                datepicker__calendar__selectDate__icon: true,
            ...
            this.renderSelectData(this.months, this.monthActivated, 'months'),
            this.renderSelectData(this.years, this.yearActivated, 'years'),
        ], h("bds-icon", { key: '6d94301226eb79543f41989ba4339af86b0f4885', class: {
                [`arrow-right`]: true,
                [`arrow-right__disable`]: fillDayList(this.monthsSlide[2].days[0]) > fillDayList(this.endDate),
                datepicker__calendar__selectDate__icon: true,
            }, name: "arrow-right", theme: "outline", size: "small", onClick: () => this.nextMonth(), dataTest: this.dtButtonNext })), h("div", { key: 'a99559213535651ab7cad3c61fd75156c93e7784' }, h("div", { key: '7133be18bbb4dd61c5d70f56c58c81300d32c9f2', class: { datepicker__calendar__week: true } }, this.week.map((item, idx) => (h("bds-typo", { variant: "fs-14", key: idx, class: `datepicker__calendar__week__day` }, item.charAt(0))))), h("div", { key: '6d9debfb7f85ac0d9ee437569cfe422c128c6aab', class: { datepicker__calendar__car: true } }, h("div", { key: 'ec63d5f67951e4a9ce472ee42bf54739d6e2ead8', class: {
                datepicker__calendar__car__slide: true,
                animate__prev: this.animatePrev,
                animate__next: this.animateNext,
            } }, [
