...
export class ChartHeatmap {
    ...
    handleCanvasMouseMove(event) {
        ...
        const { cells } = calculateHeatmapLayout(this.data, config.xKey, config.yKey, config.valueKey, this.actualWidth, this.actualHeight, margin, this.cellPadding);
        if (cells.length === 0)
            return;
        let closestIndex = 0;
    ...
    render() {
        ...
        const margin = this.computeMargin(config);
        const { cells, xLabels, yLabels } = calculateHeatmapLayout(this.data, xKey, yKey, valueKey, this.actualWidth, this.actualHeight, margin, this.cellPadding);
        ...
        return (h(Host, null, h("svg", { width: this.actualWidth, height: this.actualHeight, class: "chart-heatmap", "aria-hidden": "true" }, showHorizontalGrid && (h("g", { class: "chart-heatmap__grid-y", "stroke-dasharray": getStrokeDasharray(gridStrokeStyle) }, yLabels.map((label, idx) => (h("line", { key: `grid-h-${idx}`, x1: margin.left, y1: margin.top + label.y, x2: this.actualWidth - margin.right, y2: margin.top + label.y, stroke: "rgba(0,0,0,0.05)", "stroke-width": "1" }))))), showVerticalGrid && (h("g", { class: "chart-heatmap__grid-x", "stroke-dasharray": getStrokeDasharray(gridStrokeStyle) }, xLabels.map((label, idx) => (h("line", { key: `grid-v-${idx}`, x1: margin.left + label.x, y1: margin.top, x2: margin.left + label.x, y2: this.actualHeight - margin.bottom, stroke: "rgba(0,0,0,0.05)", "stroke-width": "1" }))))), h("g", { transform: `translate(${margin.left}, ${margin.top})` }, h("g", { class: "chart-heatmap__cells" }, cells.map((cell, index) => (h("rect", { key: `cell-${index}`, class: "chart-heatmap__cell", x: cell.x, y: cell.y, width: Math.max(cell.width, 0), height: Math.max(cell.height, 0), rx: cellRadius, fill: color, style: { opacity: String(cell.opacity), pointerEvents: 'none', transition: 'opacity 0.2s ease' } })))), this.hoveredIndex >= 0 && cells[this.hoveredIndex] && (h("rect", { key: "hover-bg", class: "chart-heatmap__hover-bg", x: cells[this.hoveredIndex].x, y: cells[this.hoveredIndex].y, width: Math.max(cells[this.hoveredIndex].width, 0), height: Math.max(cells[this.hoveredIndex].height, 0), rx: cellRadius, fill: "rgba(0,0,0,0.08)", style: { pointerEvents: 'none' } }))), showXLabels && renderXAxisLabels({
            xLabels,
            margin,
    ...
    static get is() { return "bds-chart-heatmap"; }
    ...
    static get properties() {
        return {
            "data": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Array of data objects or JSON string. Each object must have xKey, yKey, and valueKey fields."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "xKey": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Data field used for X-axis (column) categories."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "yKey": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Data field used for Y-axis (row) categories."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "valueKey": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Data field whose numeric value drives cell opacity (min \u2192 0.1, max \u2192 1.0)."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "color": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Base fill color of cells. Can be overridden by <bds-heatmap-cell color=\"...\">."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "cellRadius": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Border-radius of each cell in pixels."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "cellPadding": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Gap between cells in pixels."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
...
//# sourceMappingURL=chart-heatmap.js.map
