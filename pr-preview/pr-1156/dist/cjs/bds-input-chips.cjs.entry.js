...
const InputChips = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '778957d5d444a3bac9132ea75307e796d3ce7d60', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '2043e8529aac2a2c8848af9e32458938da939be5', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: '0238a313c21efbd36b45bef75de6a14bf4575200', class: "input__container" }, this.renderLabel(), index.h("div", { key: 'a12cc02dfb1e2ba82d9b5e47f6da6ffcaddb32d8', class: "input__container__wrapper", style: { maxHeight: defaultMaxHeight } }, this.internalChips.length > 0 && this.renderChips(), this.inputAvalible && (index.h("input", { key: '4fabe7046dcb56e7387c82e594225931891fd5e0', ref: (input) => (this.nativeInput = input), class: "input__container__text", name: this.inputName, maxlength: this.maxlength, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: () => this.handleOnBlur(), onChange: () => this.handleChange, value: this.value, disabled: this.disabled, "data-test": this.dataTest })))), this.counterLength && (index.h("bds-counter-text", { key: '526f0386cc4ca4ff426e3e58717d6bc4afe2e1b5', length: this.internalChips.length, max: this.maxChipsLength, active: isPressed })), this.success && index.h("bds-icon", { key: 'e7b4fe07e1ccd39b3f3dec21cbd06a3fd39ac3ee', class: "icon-success", name: "checkb", theme: "outline", size: "xxx-small" }), index.h("slot", { key: '0d1a1e484ba949678b7b6f352069ece5d4106deb', name: "input-right" })), this.renderMessage()));
    }
