...
const BdsLoading = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c8534abb9bfa1137770744581c156e243251b626' }, index.h("div", { key: '4d7f8297185bdfb78d4bcdf81d33366bcd6aeb45', class: "loading-container", "data-test": this.dataTest }, index.h("div", { key: '982455e87974ec51393dd891ee46aad92d4fda3c', class: { page_loading: true }, innerHTML: this.svgContent }))));
    }
};
