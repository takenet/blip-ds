...
const ExpansionPanelBody = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c6eea3401fed479f4a0a5ec8cb92b4f00538c5d9' }, index.h("div", { key: '4cf516d111d15a018d0cc98943539f100984d562', class: "expansion-content", hidden: this.open }, index.h("div", { key: '7369f2f19487801c6458f7ec472d328adf08eda6', class: "with-line" }, index.h("slot", { key: '2d7e482529bbea2a4c04c7e3f00ce7a9c02ce27f' }), this.text ? (index.h("div", { class: "text" }, index.h("p", null, this.text))) : (index.h("div", { class: "circle" }))))));
    }
};
