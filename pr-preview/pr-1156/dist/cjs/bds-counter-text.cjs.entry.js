...
const CounterText = class {
    ...
    render() {
        ...
        const actualLength = this.getActualLength();
        return (index.h("div", { key: '59797bc59075a09736c23c2d40172b3ef7d01bae', class: {
                'counter-text': true,
                'counter-text--active': this.active,
                [`counter-text--${state}`]: true,
            } }, index.h("bds-typo", { key: 'd5967b03ccc0f3193b36f079dd93d80fc6de93fa', variant: "fs-10" }, actualLength)));
    }
};
