...
const Select = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '5cfb110a28270e1b472e3e21e0e5737a5bc64e95', class: "select" }, index.h("div", { key: '42e307384d781895391a480ecb0622c609cab398', class: { element_input: true }, "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '00325f9508c0b5fd9fa5f46482333b2256fbc4bf', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: '136a01661af8f7ab3703ef61c5877c05418a2a24', class: "input__container" }, this.renderLabel(), index.h("div", { key: 'c574d4fc88abf754386e4984fed4a090c928c387', class: { input__container__wrapper: true } }, index.h("input", { key: 'dc409fb6093d25b617457a6e7f3aa9872189b167', ref: this.refNativeInput, class: { input__container__text: true }, onFocus: this.onFocus, onBlur: this.onBlur, value: this.text, disabled: this.disabled, placeholder: this.placeholder, readonly: true, "data-test": this.dataTest, onKeyDown: this.keyPressWrapper.bind(this) }))), index.h("div", { key: 'c13026b357ad409fdcfa10038ac62ee878149acf', class: "select__icon" }, index.h("bds-icon", { key: '3ae9c9f2deb1044a5abba98389abd240cd832ed3', ref: (el) => this.refIconDrop(el), size: "small", color: "inherit" })), this.success && index.h("bds-icon", { key: '9ade8846e1160cc10999ec60727ee0d35e8ecd8e', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" })), this.renderMessage()), index.h("div", { key: '16898fc59254f8052e6faf19e419284482f7c7e2', ref: (el) => this.refDropdown(el), class: {
