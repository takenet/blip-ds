...
const Input = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'aa036f7f262f6ea982a1f636bc5cb8f71dfa752d', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: 'b443e04d9c9d57b9cd3306b3b06d691f46e8e71f', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("slot", { key: 'd1f5376244b87585dffde533b38d7846e5ab24bc', name: "input-left" }), index.h("div", { key: 'f7f0ac583275f382c4e549972f191be67c2f6d15', class: "input__container" }, this.renderLabel(), index.h("div", { key: 'c296a08aec55c13b1eba460a6d9ba2890b1969c2', class: {
            ...
            } }, index.h("slot", { key: '8133a6b84210d4260045f3536cfad3f7ae1d9443', name: "inside-input-left" }), index.h(Element, { key: 'b73809d92f44bc30c6a3f1af41afdad4ba40b81a', class: {
            ...
            } : {} }))), this.counterLength && (index.h("bds-counter-text", Object.assign({ key: 'dda3ef4a4da2b3a3b477d5bdb0a69e1f6ab798fb', length: this.value.length, max: this.maxlength, active: isPressed }, this.counterLengthRule))), this.success && index.h("bds-icon", { key: '290371f1e22f671fd9c79a11f7963c4238fd2be0', class: "icon-success", name: "check", theme: "outline", size: "small" }), index.h("slot", { key: '1d98b5c5058152617b73bd2b214066197a8e3918', name: "input-right" })), this.renderMessage()));
    }
