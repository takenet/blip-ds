...
const SelectChips = class {
    constructor(hostRef) {
        ...
        this.bdsCancel = index.createEvent(this, "bdsCancel");
        ...
        this.bdsSelectChipsInput = index.createEvent(this, "bdsSelectChipsInput");
    ...
    render() {
        ...
        return (index.h("div", { key: '5c58b8d4b3de512e6699b9305a343339b60d7e99', class: "select", tabindex: "0", onFocus: this.setFocusWrapper, onBlur: this.removeFocusWrapper }, index.h("div", { key: '5b3d2300410ed8c1c6f1cb527b7183eb7b2e6743', class: { element_input: true }, "aria-disabled": this.disabled ? 'true' : null, onClick: this.toggle }, index.h("div", { key: 'c3a93999cf7a4a268bea4871901392cfa2d437d7', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper }, this.renderIcon(), index.h("div", { key: '011e67f7d7ceb4a4156eea7a6e6c5ac4a08a11b2', class: "input__container" }, this.renderLabel(), index.h("div", { key: '202a29b2d8c1d840a05d1302a9876ee060638ed6', class: { input__container__wrapper: true } }, this.internalChips.length > 0 && (index.h("span", { key: '307027f096284a8c0f8ac393b9291077e3abbeb6', style: { height: this.height, maxHeight: this.maxHeight }, class: "inside-input-left" }, this.renderChips())), index.h("input", { key: '933b2dbd88c644d8e3fc236e37a43751e6424b31', ref: (input) => (this.nativeInput = input), class: { input__container__text: true }, name: this.inputName, maxlength: this.maxlength, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: () => this.handleOnBlur(), onChange: () => this.handleChange, value: this.value, disabled: this.disabled, "data-test": this.dataTest, onKeyDown: this.keyPressWrapper }))), index.h("div", { key: '066f6d3e73ec2662bc73391c03d81ba4846f6760', class: "select__icon" }, index.h("bds-icon", { key: '981c3d91befbc4787744597886353ed3b916fec7', ref: (el) => this.refIconDrop(el), size: "small", color: "inherit" })), this.success && index.h("bds-icon", { key: '66696e221f43a19c476dde86d535e8a9dc530b86', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" })), this.renderMessage()), index.h("div", { key: 'b076c567785007bfa2baad3bbcec4522e9190e5a', ref: (el) => this.refDropdown(el), class: {
                select__options: true,
                'select__options--open': this.isOpen,
            } }, internalOptions.map((option) => (index.h("bds-select-option", { key: this.generateKey(option.value), onOptionSelected: this.handler, value: option.value, status: option.status }, option.label))), index.h("slot", { key: '31cc5e3b8c964fab28520364daa43be3f8ba5f95' }), this.canAddNew === true && this.enableCreateOption() && (index.h("bds-select-option", { key: 'd96c1e93dfbb561d23ba788a5ceef78d880c8869', id: "option-add", value: "add", onClick: () => this.handlerNewOption(this.nativeInput.value) }, this.newPrefix, this.nativeInput.value)), !this.canAddNew && this.enableCreateOption() && (index.h("bds-select-option", { key: '41f5c7161042eadb832b014602b8dca29acecc47', id: "no-option", value: "add" }, this.notFoundMessage)))));
    }
...
//# sourceMappingURL=bds-select-chips.entry.cjs.js.map

//# sourceMappingURL=bds-select-chips.cjs.entry.js.map