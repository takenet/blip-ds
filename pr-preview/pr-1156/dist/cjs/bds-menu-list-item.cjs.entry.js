...
const MenuListItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c489ce1407d5e103d342f9183ce0bd5b37748dea', role: "button" }, index.h("div", { key: 'aed3c0283ffbd53683bc4deccc4a4a3d85dccf06', class: "menu-list-item" }, index.h("bds-icon", { key: 'd129de43630f4b6705d1517b8f4db32d6f72a290', color: color, name: this.icon }), index.h("bds-typo", { key: 'c6d61c329c69ae67ec59ada75135d55f5110468f', class: "menu-list-item__text", variant: "fs-10" }, index.h("slot", { key: '0680cb8ee9ee5189cc09e298c36bcceecab005ba' })))));
    }
};
