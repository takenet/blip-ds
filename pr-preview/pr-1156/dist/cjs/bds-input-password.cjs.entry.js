...
const InputPassword = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '357b2964522f9f4b6d5fbf56c61db063d6a6102f', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '6c3f7f1621b3edc87c1589a2f1a7ed18e479c29a', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: '8337fd2299723cb01819fe7b2a06742207c23b4a', class: "input__container" }, this.renderLabel(), index.h("div", { key: 'eb2cfe50267a6180db60ba8ffdfac72db15ddfee', class: { input__container__wrapper: true } }, index.h("input", { key: '67694edfbf811f991e600be5f47404b63fc7fd52', ref: this.refNativeInput, class: { input__container__text: true }, type: type, name: this.inputName, min: this.min, max: this.max, minLength: this.minlength, maxLength: this.maxlength, readOnly: this.readonly, autocomplete: autocomplete, autocapitalize: this.autoCapitalize, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: this.onBlur, onSubmit: this.onSubmit, value: this.value, disabled: this.disabled, "data-test": this.dataTest }))), index.h("div", { key: '53c583a3408e86c1d7bca32bb37f14a6f078c7e6', class: "input__password--icon", onClick: this.toggleEyePassword, onKeyDown: this.handleKeyDown.bind(this), tabindex: "0" }, index.h("bds-icon", { key: '7448b3b8413e9745738caf1dfe9460def0e4535b', size: "small", name: iconPassword, color: "inherit" })), this.success && index.h("bds-icon", { key: 'f2fef586b74e59f7722a810caa5c7603a1fb66d3', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" })), this.renderMessage()));
    }
