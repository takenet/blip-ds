...
const Checkbox = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '9a2098ff461b358fd909876efdf31f2de3983611', class: {
                checkbox: true,
                [styleState]: true,
            } }, index.h("input", { key: '46a9775a2f2164662034065de899a3bddaa4ecfe', type: "checkbox", ref: this.refNativeInput, id: this.checkBoxId, name: this.name, onClick: (ev) => this.onClick(ev), checked: this.checked, disabled: this.disabled, "data-test": this.dataTest }), index.h("label", { key: 'f45bcfdfd3e1272ea78e9bb461b4133b0602762c', class: "checkbox__label", htmlFor: this.checkBoxId }, index.h("div", { key: '7e3875c7a6e9092363be1d28170fb753d19e4eb7', class: "checkbox__icon", tabindex: "0", onKeyDown: this.handleKeyDown.bind(this) }, index.h("bds-icon", { key: 'fc8f8ba3bc7fde7bed9dff910afddfc2fc6aba3e', class: "checkbox__icon__svg", size: "x-small", name: this.getIconName(), color: "inherit" })), this.label && (index.h("bds-typo", { key: '38ae7f8fb6460f329a7811d71f6cf3d722471c3e', class: "checkbox__text", variant: "fs-14", tag: "span" }, this.label)))));
    }
};
