...
const BdsdatepickerPeriod = class {
    constructor(hostRef) {
        ...
        this.bdsClickDayButton = index.createEvent(this, "bdsClickDayButton");
    ...
    render() {
        ...
        return (index.h("div", { key: '2814a08e8d101d06cd7291bb9d97f36a0cde7112', class: { datepicker__calendar: true, [`period`]: true } }, index.h("div", { key: 'a09d591a0f31b59fa96ec35b320a4fb6b77b5d8b', class: { datepicker__calendar__selectDate: true } }, index.h("bds-icon", { key: 'c8d6db21cb737f6e2320dfaa8fc391e348062e7f', class: {
                [`arrow-left`]: true,
        ...
        ], index.h("bds-typo", { key: 'ac9f3b154f1a56b14bc9ab3c9ff035db65d1beb2', class: "datepicker__calendar__selectDate__futureMonth", variant: "fs-14" }, `${futureMonth[0].label}, ${futureYear}`), index.h("bds-icon", { key: '502e5af654e30ede0ede4a18dd4088cb8bbd3fc4', class: {
                [`arrow-right`]: true,
                [`arrow-right__disable`]: calendar.fillDayList(this.monthsSlide[2].days[0]) > calendar.fillDayList(this.endDate),
                datepicker__calendar__selectDate__icon: true,
            }, name: "arrow-right", theme: "outline", size: "small", onClick: () => this.nextMonth(), dataTest: this.dtButtonNext })), index.h("div", { key: '16464131df0a28e37cc7ad0f8a2b7c5450b0906c' }, index.h("div", { key: '62ffe55b4b41ba6b5825ce8ded7d562f1c0bc28a', class: { datepicker__calendar__week: true } }, index.h("div", { key: '4d326dc43a21601b3990d97a2c8ebe823fddf2d6', class: { datepicker__calendar__week__present: true } }, this.week.map((item, idx) => (index.h("bds-typo", { variant: "fs-14", key: idx, class: `datepicker__calendar__week__day` }, item.charAt(0))))), index.h("div", { key: '7da120c1b69f1172409b93c6cd2f9171d6c9877c', class: { datepicker__calendar__week__future: true } }, this.week.map((item, idx) => (index.h("bds-typo", { variant: "fs-14", key: idx, class: `datepicker__calendar__week__day` }, item.charAt(0)))))), index.h("div", { key: 'a5b4558085b2c53eb825607b32bf11ae59d9095b', class: { datepicker__calendar__car: true, datepicker__calendar__car__period: true } }, index.h("div", { key: '433a6a3c0cc0a4cfabbddcb4bb0a620fd2eb8cdc', class: {
...
const BdsdatepickerSingle = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.bdsDateSelected = index.createEvent(this, "bdsDateSelected");
    ...
    renderSelectData(data, selected, ref) {
        ...
        return (index.h("div", { class: {
                ...
                datepicker__calendar__selectDate__select__input__disable: data.length <= 1,
                [`input--pressed`]: openSelect,
            }, "data-test": ref == 'months' ? this.dtSelectMonth : this.dtSelectYear }, index.h("bds-typo", { variant: "fs-14" }, (_a = labelSelect[0]) === null || _a === void 0 ? void 0 : _a.label), index.h("div", { class: "icon-arrow" }, index.h("bds-icon", { size: "small", name: iconArrow, color: "inherit" }))), index.h("div", { class: {
                datepicker__calendar__selectDate__select__options: true,
                'datepicker__calendar__selectDate__select__options--open': openSelect,
            } }, data.map((option) => (index.h("bds-select-option", { value: option.value, key: option.value, onOptionSelected: (event) => this.handler(event, ref), selected: option.value == selected, onClick: () => this.openDateSelect(false, ref) }, option.label))))));
    }
    ...
    render() {
        return (index.h("div", { key: 'f18cdf61f2bf6ac67f1dcc9178762d473aaf86c5', class: { datepicker__calendar: true } }, index.h("div", { key: 'df465130eec882d099c12729b11d448fc999a3aa', class: { datepicker__calendar__selectDate: true } }, index.h("bds-icon", { key: 'f729599ddcf8d28e174ca1d59c3d09d4b8ac4f07', class: {
                [`arrow-left`]: true,
                [`arrow-left__disable`]: calendar.fillDayList(this.monthsSlide[0].days[this.monthsSlide[0].days.length - 1]) <
                    calendar.fillDayList(this.startDate),
                datepicker__calendar__selectDate__icon: true,
            ...
            this.renderSelectData(this.months, this.monthActivated, 'months'),
            this.renderSelectData(this.years, this.yearActivated, 'years'),
        ], index.h("bds-icon", { key: '6d94301226eb79543f41989ba4339af86b0f4885', class: {
                [`arrow-right`]: true,
                [`arrow-right__disable`]: calendar.fillDayList(this.monthsSlide[2].days[0]) > calendar.fillDayList(this.endDate),
                datepicker__calendar__selectDate__icon: true,
            }, name: "arrow-right", theme: "outline", size: "small", onClick: () => this.nextMonth(), dataTest: this.dtButtonNext })), index.h("div", { key: 'a99559213535651ab7cad3c61fd75156c93e7784' }, index.h("div", { key: '7133be18bbb4dd61c5d70f56c58c81300d32c9f2', class: { datepicker__calendar__week: true } }, this.week.map((item, idx) => (index.h("bds-typo", { variant: "fs-14", key: idx, class: `datepicker__calendar__week__day` }, item.charAt(0))))), index.h("div", { key: '6d9debfb7f85ac0d9ee437569cfe422c128c6aab', class: { datepicker__calendar__car: true } }, index.h("div", { key: 'ec63d5f67951e4a9ce472ee42bf54739d6e2ead8', class: {
                datepicker__calendar__car__slide: true,
                animate__prev: this.animatePrev,
                animate__next: this.animateNext,
            } }, [
...
//# sourceMappingURL=bds-datepicker-period.bds-datepicker-single.entry.cjs.js.map

//# sourceMappingURL=bds-datepicker-period_2.cjs.entry.js.map