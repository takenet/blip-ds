...
const Slider = class {
    ...
    render() {
        return (index.h(index.Host, { key: '581564601404e1f2586730fc5dd598f45b82e3a2' }, index.h("input", { key: 'a9949113fed2652a6be8c7dad41a9c5dbdebe711', ref: this.refInputSlide, type: "range", class: {
                input_slide: true,
            }, value: this.value, onInput: this.onInputSlide, onMouseEnter: this.onInputMouseEnter, onMouseLeave: this.onInputMouseLeave, "data-test": this.dataTest }), index.h("div", { key: '3de724dafdc5e81f7ce0010a33d8b7c624cda8a6', class: "track-bg" }, index.h("div", { key: 'f05a35f9be9ad2d633688947cc31574891493790', class: { [`progress-bar`]: true, [`progress-bar-liner`]: this.type !== 'no-linear' }, ref: this.refProgressBar }, index.h("bds-tooltip", { key: 'ae2b2ed2f57e81c8ca736f53a0b51d8dc430d0c1', ref: this.refBdsTooltip, class: { [`progress-bar-tooltip`]: true }, position: "top-center", "tooltip-text": this.inputValue }, index.h("div", { key: 'f5ca061d25d63888e54b107bb295c522dc2b2646', class: { [`progress-bar-thumb`]: true } }))), this.markers &&
