...
const Tabs = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e0556b357f933e6331a521a46c9df76270c0e7bc', class: {
                'bds-tabs': true,
                [`bds-tabs--${this.align}`]: true,
            } }, index.h("div", { key: '2c7e6c676e42a695b1bbc1726fbb9c2ff9d45dc4', class: "bds-tabs__header-button-container" }, index.h("bds-button-icon", { key: '540a0e8223748cc49118324eb1729c8b84cfe304', class: "bds-tabs__header-button", icon: "arrow-left", size: "short", id: "bds-tabs-button-left", onClick: () => this.handleScrollButtonClick("left" /* ScrollDirection.LEFT */), variant: "secondary" })), index.h("div", { key: 'a35715c5a557c129cd8a8e2d63383e5089f17926', class: "bds-tabs__header" }, index.h("slot", { key: '2c082d2001ac1236388aa0a70befcd549c607fe0' })), index.h("div", { key: '2ae75f4e3cd2e17418cbcbce5b35bf15988cdb14', class: "bds-tabs__header-button-container" }, index.h("bds-button-icon", { key: '025921dd1fba3a933fef2d2687e51b941d791462', class: "bds-tabs__header-button", icon: "arrow-right", size: "short", id: "bds-tabs-button-right", onClick: () => this.handleScrollButtonClick("right" /* ScrollDirection.RIGHT */), variant: "secondary" }))));
    }
