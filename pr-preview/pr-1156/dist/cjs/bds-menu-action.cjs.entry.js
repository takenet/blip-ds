...
const BdsMenuAction = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'bf1a3b8ee72da71a706c7cd2869befd9b9e569b3', class: {
                menuaction: true,
                [`position-${this.positionSubMenu}`]: true,
            }, onMouseOver: openSubmenu, onMouseOut: closeSubmenu }, index.h("button", { key: '4a997c05d96720a7e702d43c10664ce3dd7c2cd4', class: {
            ...
            } }, this.iconLeft && index.h("bds-icon", { key: 'f6e138c229f1b08c9fad82b869d4b1291398cd8f', class: "icon-item", name: this.iconLeft, theme: "outline", size: "small" }), index.h("div", { key: '2a3ff97e236103905a6f4ce38ad1db04a4e6aaa9', class: "content-item" }, this.buttonText && (index.h("bds-typo", { key: 'ffb2d7cbf8739f091cbb483f49bc0cccc2c1da79', class: "title-item", variant: "fs-16", tag: "span" }, this.buttonText)), this.subtitle && (index.h("bds-typo", { key: '52841880aa5ce2f4d7ab4b2e526c5aa6fce7ef20', class: "subtitle-item", variant: "fs-10", tag: "span" }, this.subtitle)), this.description && (index.h("bds-typo", { key: 'bda0651947e8f1100246dc3568f7679e33a64ed4', class: "description-item", variant: "fs-10", tag: "span" }, this.description))), this.subMenu && (index.h("bds-icon", { key: '056d2b944997c0c1a650c9effab4a4510bf85177', class: { arrow: true }, name: `arrow-${this.positionSubMenu}`, theme: "outline", size: "small" }))), this.subMenu && (index.h("div", { key: 'c6e0c2e4144123c6a23f1d668718bf5baa965c68', class: {
                menuaction__submenu: true,
                menuaction__submenu__open: this.delaySubMenu,
            }, style: zIndexSubmenu }, index.h("slot", { key: '35f9f133f4c7602d4d3a0213a55f547f5f8121da' })))));
    }
