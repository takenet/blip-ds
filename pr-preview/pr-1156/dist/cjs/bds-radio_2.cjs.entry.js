...
const Radio = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ab593b06f2c33626e45af45cc1875755a6e57054' }, index.h("label", { key: 'c334e8cb1fbded98f577d8dbd8cc062de7455fc7', class: "radio", htmlFor: this.radioId }, index.h("input", { key: 'dde5128c038895020dd366a5ab4d75d85bd3817d', class: "radio__input", type: "radio", ref: this.refNativeInput, id: this.radioId, onClick: this.onClick, disabled: this.disabled, checked: this.checked, value: this.value, name: this.name, "data-test": this.dataTest }), index.h("div", { key: '0161317aa2e1e1aaeb101ed51ed8a15c1714f1db', class: "radio__circle" }, !this.disabled ? index.h("div", { class: "focus", tabindex: "0", onKeyDown: this.handleClickKey.bind(this) }) : '', !this.disabled ? index.h("div", { class: "hover" }) : '', index.h("div", { key: '5fee0498d5c0d0286b84fe1390e74ec1e93f9f87', class: "radio__circle__pointer" })), this.label && (index.h("bds-typo", { key: 'abd35a7ab5452499b24c3a0104407a74c75c6f0c', class: "radio__text", variant: "fs-14", bold: this.checked ? 'bold' : 'regular', tag: "span" }, this.label)), index.h("slot", { key: 'e8b22a39e2a4e76170ee9453a0863114855ca953' }))));
    }
