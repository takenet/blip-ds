...
const ChartPie = class {
    ...
    computeLayout() {
        ...
        return chartMath.calculatePieLayout(this.data, this.labelKey, this.valueKey, this.actualWidth, this.actualHeight, innerRadius, chartMath.DEFAULT_LEGEND_PALETTE);
    }
    emitLeave() {
        this.hoveredIndex = -1;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '84ee50fe7d0e7cf70897844cfc27fc66b64bbf86' }, index.h("svg", { key: '431c415cdb7c5e758c85b04765b50f9504755470', width: this.actualWidth, height: this.actualHeight, class: "chart-pie", "aria-hidden": "true", onMouseLeave: () => this.emitLeave() }, index.h("g", { key: '05ecbe88adaf0d405436c2ce0a62f7c86dd12d7e', transform: `translate(${centerX}, ${centerY})` }, slices.map((slice, index$1) => {
            const isHovered = this.hoveredIndex === index$1;
            const isFaded = this.activeLegendItem !== null
                ? this.activeLegendItem !== slice.label
                : (this.hoveredIndex >= 0 && !isHovered);
            const d = chartMath.generateDonutPath(slice.startAngle, slice.endAngle, outerRadius, innerRadius, padAngle);
            if (!d)
                return null;
            const classes = [
                'chart-pie__slice',
            ...
            return (index.h("path", { key: `slice-${index$1}`, class: classes, d: d, fill: slice.color, onMouseEnter: (e) => { this.hoveredIndex = index$1; this.showTooltip(index$1, e); }, onMouseMove: (e) => this.showTooltip(index$1, e), onMouseLeave: () => this.emitLeave() }));
        }))), index.h("slot", { key: 'fe3eb0f7dfa4d8ba875831f2f00fff21902c1d20' })));
    }
    get host() { return index.getElement(this); }
};
ChartPie.style = chartPieCss;

exports.bds_chart_pie = ChartPie;
//# sourceMappingURL=bds-chart-pie.entry.cjs.js.map

//# sourceMappingURL=bds-chart-pie.cjs.entry.js.map