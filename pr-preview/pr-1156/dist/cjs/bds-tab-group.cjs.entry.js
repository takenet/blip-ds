...
const BdsTabGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'fc318f0e14cfab95d3465c0204128914a92d239e' }, index.h("div", { key: '3a53651a227c674e06029b456aeec1fc3bdfa880', class: { tab_group: true } }, this.isSlideTabs && this.alignTab != 'left' && (index.h("bds-button-icon", { key: 'd5fafbf003cf6f1ccdaafb3fa01ab2f3718a1fcd', class: "tab_group__slide-button", icon: "arrow-left", size: "short", id: "bds-tabs-button-left", onClick: () => this.prevSlide(), dataTest: this.dtButtonPrev, variant: "secondary" })), index.h("div", { key: '209f8be2c33bb1df7df5cd7b374194e9ffd4de79', class: { tab_group__header: true, tab_group__slide: this.isSlideTabs }, ref: this.refHeaderElement, style: headerStyle }, index.h("div", { key: '55d1f991297ef2e2b95d23cdfabb67070e297eae', class: {
            ...
            this.internalItens.map((item, index$1) => {
                ...
                return (index.h("div", { class: {
                    ...
                    ? this.renderBadge(item.badgeShape, item.badgeColor, item.badgeIcon, item.badgeAnimation, item.badgeNumber)
                    : ''));
            }))), this.isSlideTabs && this.alignTab != 'right' && (index.h("bds-button-icon", { key: '495b4351ad8960a6f4d07eabd28677630a42c20b', class: "tab_group__slide-button", icon: "arrow-right", size: "short", id: "bds-tabs-button-right", onClick: () => this.nextSlide(), dataTest: this.dtButtonNext, variant: "secondary" })), index.h("div", { key: '3b00222e8221174a746dd4714cb1bbde51d8e5eb', class: { tab_group__content: true, tab_group__scrolled: this.contentScrollable }, style: contentStyle }, index.h("slot", { key: '5fba45c30bdb3d23070baaf3003c3785c7e42309' })))));
    }
