...
const Paper = /*@__PURE__*/ proxyCustomElement(class Paper extends H {
    ...
    render() {
        return (h(Host, { key: '4ae0eb3b6408c8ec4912c90aafd348effed26288', class: {
                [`paper__elevation--${this.elevation}`]: this.hasBorder,
                border: this.border,
                [`bg-${this.bgColor}`]: true,
                [`border-${this.borderColor}`]: true,
            }, style: { height: `${this.height}`, width: `${this.width}` } }, h("div", { key: '22f58b3a1f95c547310249a530ba7d5151c237fe', class: "paper__display", "data-test": this.dataTest }, h("slot", { key: '99fa3cf0c5b57ee2ec709e3d205ec3a4e37aff82' }))));
    }
...
//# sourceMappingURL=p-BsYpgarQ.js.map
