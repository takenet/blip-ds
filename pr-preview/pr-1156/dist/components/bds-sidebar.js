...
import { d as defineCustomElement$3 } from './p-DPB2Wf3S.js';
...
const Sidebar = /*@__PURE__*/ proxyCustomElement(class Sidebar extends H {
    ...
    static get style() { return sidebarCss; }
        ...
        "isOpen": [1540, "is-open"],
        "sidebarPosition": [1, "sidebar-position"],
        "type": [1],
        "margin": [4],
        "width": [2],
...
function defineCustomElement$1() {
    ...
    const components = ["bds-sidebar", "bds-button-icon", "bds-icon"];
...
const BdsSidebar = Sidebar;
const defineCustomElement = defineCustomElement$1;

export { BdsSidebar, defineCustomElement };
//# sourceMappingURL=bds-sidebar.js.map
