...
import { h as defaultStartDate, i as defaultEndDate, t as typeDateToStringDate, d as dateToDayList, m as messageTranslate, f as fillDayList, j as dateToInputDate, k as dateToTypeDate, l as termTranslate } from './p-CuPv4dbX.js';
import { d as dateValidation } from './p-BXYXNVip.js';
import { g as getScrollParent, p as positionAbsoluteElement } from './p-BNEKIkjk.js';
import { d as defineCustomElement$e } from './p-CcKVOyOW.js';
import { d as defineCustomElement$d } from './p-Sv1hHgcW.js';
import { d as defineCustomElement$c } from './p-CMXYUjHm.js';
import { d as defineCustomElement$b } from './p-DP_cYeKn.js';
import { d as defineCustomElement$a } from './p-WO4jK2LJ.js';
import { d as defineCustomElement$9 } from './p-D-_76oe5.js';
import { d as defineCustomElement$8 } from './p-CdNy8t88.js';
import { d as defineCustomElement$7 } from './p-Cjs3cp-L.js';
import { d as defineCustomElement$6 } from './p-DmvHH3kg.js';
import { d as defineCustomElement$5 } from './p-DS5LPcQt.js';
...
const DatePicker = /*@__PURE__*/ proxyCustomElement(class DatePicker extends H {
    constructor() {
        ...
        this.concludeDatepicker = createEvent(this, "concludeDatepicker");
        this.emptyConcludeDatepicker = createEvent(this, "emptyConcludeDatepicker");
        this.open = false;
    ...
    render() {
        return (h(Host, { key: '36bbc9c4e45662cd85aa8be8369cf782a2547e30', class: { datepicker: true } }, this.typeOfDate == 'single' ? (h("div", { class: {
    ...
    static get style() { return datepickerCss; }
        ...
        "typeOfDate": [1, "type-of-date"],
        "startDateLimit": [1537, "start-date-limit"],
        "endDateLimit": [1537, "end-date-limit"],
        "label": [1],
        "message": [1],
        "variantBanner": [1537, "variant-banner"],
        "language": [1],
        "disabled": [1540],
        "valueDateSelected": [1537, "value-date-selected"],
        "valueEndDateSelected": [1537, "value-end-date-selected"],
        "positionOptions": [1, "position-options"],
        "dtInputStart": [1, "dt-input-start"],
        "dtInputEnd": [1, "dt-input-end"],
        ...
        "dtButtonClear": [1, "dt-button-clear"],
...
function defineCustomElement$1() {
    ...
    const components = ["bds-datepicker", "bds-banner", "bds-button", "bds-button-icon", "bds-checkbox", "bds-counter-text", "bds-datepicker-period", "bds-datepicker-single", "bds-grid", "bds-icon", "bds-input", "bds-loading-spinner", "bds-select-option", "bds-typo"];
...
const BdsDatepicker = DatePicker;
const defineCustomElement = defineCustomElement$1;

export { BdsDatepicker, defineCustomElement };
//# sourceMappingURL=bds-datepicker.js.map
