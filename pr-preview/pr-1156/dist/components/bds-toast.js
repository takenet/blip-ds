...
import { d as defineCustomElement$7 } from './p-Sv1hHgcW.js';
import { d as defineCustomElement$6 } from './p-CMXYUjHm.js';
import { d as defineCustomElement$5 } from './p-DmvHH3kg.js';
import { d as defineCustomElement$4 } from './p-DOQirQsC.js';
import { d as defineCustomElement$3 } from './p-CpdymncC.js';
...
const BdsToast$1 = /*@__PURE__*/ proxyCustomElement(class BdsToast extends H {
    ...
    render() {
        return (h("div", { key: '91fee53ed3cadf6192554dc28d206450e8b74556', class: {
                toast: true,
                [`toast--${this.variant}`]: true,
                [`toast--action--${this.actionType}`]: true,
                [`show show--${this.position}`]: this.show,
                hide: this.hide,
            } }, this.variant === 'notification' && (h("bds-icon", { key: '5dc38fbed650afcd5deefb5e203980a779804c91', class: "toast__ballon", theme: "solid", name: "blip-chat", size: "brand" })), this.icon && h("bds-icon", { key: 'fdaf1a8f55e358b36fc82c1aeb3e77e09e72fec4', class: "toast__icon", theme: "outline", size: "medium", name: this.icon }), h("div", { key: 'cac53eacd4c1b08d8c3a48ac6b51861d9c8065d3', class: "toast__content" }, this.toastTitle && (h("bds-typo", { key: '1c27926bb55fb2fa2504c1110e5875d4a4f22cf0', variant: "fs-14", bold: "bold" }, this.toastTitle)), this.toastText && h("bds-typo", { key: '949b2d3b2d9381e10ad46fb10fb4a1b4a0e72b9b', variant: "fs-14", innerHTML: this.toastText })), h("div", { key: '73fca01b17a7d20de3aeed3403a1b6d0b6fac744', class: {
                toast__action: true,
