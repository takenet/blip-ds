...
import { T as THIS_DAY, d as dateToDayList, f as fillDayList, a as fillDate, w as weekDays, g as getMonthsSlide, b as getYears, c as getMonths, i as defaultEndDate, h as defaultStartDate, e as changeMonths } from './p-CuPv4dbX.js';
import { d as defineCustomElement$4 } from './p-DerbyKiF.js';
import { d as defineCustomElement$3 } from './p-CxIPAixx.js';
import { d as defineCustomElement$2 } from './p-Dxlzw-8f.js';
...
const BdsdatepickerSingle = /*@__PURE__*/ proxyCustomElement(class BdsdatepickerSingle extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
}, [1, "bds-datepicker-single", {
        "endDate": [16, "end-date"],
        "startDate": [16, "start-date"],
        "dateSelect": [1040, "date-select"],
        "language": [1],
...
function defineCustomElement() {
    ...
    const components = ["bds-datepicker-single", "bds-checkbox", "bds-icon", "bds-select-option", "bds-typo"];
    components.forEach(tagName => { switch (tagName) {
        case "bds-datepicker-single":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BdsdatepickerSingle);
            }
            break;
        case "bds-checkbox":
            if (!customElements.get(tagName)) {
...
export { BdsdatepickerSingle as B, defineCustomElement as d };
//# sourceMappingURL=p-B6EQ7tzH.js.map
