...
import { d as defineCustomElement$5 } from './p-CcKVOyOW.js';
import { d as defineCustomElement$4 } from './p-CMXYUjHm.js';
...
const BdsUpload$1 = /*@__PURE__*/ proxyCustomElement(class BdsUpload extends H {
    ...
    render() {
        return (h("div", { key: 'd4a7fb18d02aed5c60b270cd99bad3d9d06af46a', class: "upload" }, h("div", { key: 'bae675fa6ad733e8ea55f3c684ae21d81c3f26d0', class: "upload-header" }, h("bds-icon", { key: '7514ab9bb7cc484174827c6feb2b68396f1de547', class: "upload-header_icon", size: "xxx-large", name: "upload" }), h("div", { key: '17de104145b273a43873f829774f7ca3dcd13706', class: "upload-header_text" }, h("bds-typo", { key: '53194dfe0e46b6a3c8eb34f4bc33e3cdccb46d94', variant: "fs-16", bold: "bold", "aria-label": this.titleName }, this.titleName), h("bds-typo", { key: '6b2d83914e950c737497d93060f8566184815d0f', variant: "fs-14", bold: "regular", "aria-label": this.subtitle }, this.subtitle))), this.error ? (h("bds-banner", { context: "inside", variant: "error", "aria-label": this.error }, this.error)) : (''), this.haveFiles && this.showListPreview ? (h("div", null, h("div", { class: "list-preview" }, this.files.map((names, index) => (h("div", { class: "upload__preview", key: index, id: "drop-area" }, h("div", { class: "preview", id: "preview" }, h("bds-icon", { size: "x-small", name: "attach" }), h("p", { class: "preview-text", id: "preview-text", "aria-label": names.name }, names.name), h("bds-button-icon", { class: "preview-icon", size: "short", icon: "trash", variant: "secondary", onClick: () => this.deleteFile(index), "aria-label": `delete ${names.name}`, "data-test": `${this.dtButtonDelete}-${index}` })))))), this.multiple ? (h("bds-typo", { variant: "fs-14", italic: true, class: "preview-length", "aria-label": termTranslate(this.language, 'uploaded') }, this.files.length > 1 ? `${this.files.length} ${termTranslate(this.language, 'uploaded')}` : '')) : (''))) : (''), h("div", { key: '657d161c46333aebfadebd2afb66e875c400b3fb', class: { upload__edit: true } }, h("label", { key: '8c8a1bb19a72122fc37e06d4c9ecbeb6e7da5aa7', class: { 'upload__edit--label': true, 'upload__edit--hover': this.hover }, id: "file-label", htmlFor: "file", "data-test": this.dtLabelAddFile, tabindex: "0", onKeyDown: this.handleKeyDown.bind(this) }, h("div", { key: '78037f686c70f906ad968dc557fe140b6bc420d8', class: { 'text-box': true, 'text-box--hover': this.hover }, id: "file-text_box" }, this.hover ? (h("bds-typo", { class: "text", variant: "fs-14", bold: "regular", "aria-label": termTranslate(this.language, 'dropHere') }, termTranslate(this.language, 'dropHere'))) : (h("bds-typo", { class: "text", variant: "fs-14", bold: "regular", "aria-label": termTranslate(this.language, 'dropOrClick') }, termTranslate(this.language, 'dropOrClick')))), h("img", { key: '2a181a9ed44a51e474a2f5def4efacd8c6d3c9e3', class: { 'upload__img--invisible': true, 'upload__img--visible': this.hover }, src: patternSvg })), h("input", { key: '6bea8ce7f7cd69f83dc009548a3590c3ea0c6fc4', ref: this.refInputElement, type: "file", name: "files[]", id: "file", class: "upload__input", multiple: this.multiple, accept: this.internalAccepts.length > 0 ? this.internalAccepts.toString() : this.accept, onChange: ($event) => this.onUploadClick($event.target.files), "data-test": this.dtInputFiles }))));
    }
