...
import { d as defineCustomElement$5 } from './p-DHb8pHmq.js';
import { d as defineCustomElement$4 } from './p-DPB2Wf3S.js';
...
const BdsUpload$1 = /*@__PURE__*/ proxyCustomElement(class BdsUpload extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        return (h("div", { key: '7a8f13d821c240d291c5d9a3b07580e8e667033f', class: "upload" }, h("div", { key: '37219f94db94ed2aedb585702ad697f8806b8185', class: "upload-header" }, h("bds-icon", { key: '92bbc81ae3d7d891553b8df6272274148477034a', class: "upload-header_icon", size: "xxx-large", name: "upload" }), h("div", { key: '54690a7fb9dd823d4fb0b59e9ede0f327fd30de3', class: "upload-header_text" }, h("bds-typo", { key: 'eccf5710836bebd06331967b45c80c08eb417cce', variant: "fs-16", bold: "bold", "aria-label": this.titleName }, this.titleName), h("bds-typo", { key: '6f91d6e084ea60848a604dabb5486776ed86a1fd', variant: "fs-14", bold: "regular", "aria-label": this.subtitle }, this.subtitle))), this.error ? (h("bds-banner", { context: "inside", variant: "error", "aria-label": this.error }, this.error)) : (''), this.haveFiles && this.showListPreview ? (h("div", null, h("div", { class: "list-preview" }, this.files.map((names, index) => (h("div", { class: "upload__preview", key: index, id: "drop-area" }, h("div", { class: "preview", id: "preview" }, h("bds-icon", { size: "x-small", name: "attach" }), h("p", { class: "preview-text", id: "preview-text", "aria-label": names.name }, names.name), h("bds-button-icon", { class: "preview-icon", size: "short", icon: "trash", variant: "secondary", onClick: () => this.deleteFile(index), "aria-label": `delete ${names.name}`, "data-test": `${this.dtButtonDelete}-${index}` })))))), this.multiple ? (h("bds-typo", { variant: "fs-14", italic: true, class: "preview-length", "aria-label": termTranslate(this.language, 'uploaded') }, this.files.length > 1 ? `${this.files.length} ${termTranslate(this.language, 'uploaded')}` : '')) : (''))) : (''), h("div", { key: '47bb5a0046a9d727eca07aa8525c7b01791287a9', class: { upload__edit: true } }, h("label", { key: 'dca75bc503ed7c088b29769ada20f70279fe4edb', class: { 'upload__edit--label': true, 'upload__edit--hover': this.hover }, id: "file-label", htmlFor: "file", "data-test": this.dtLabelAddFile, tabindex: "0", onKeyDown: this.handleKeyDown.bind(this) }, h("div", { key: 'd397fb98b63c135c65e12c25e9adbce6e4f9ed84', class: { 'text-box': true, 'text-box--hover': this.hover }, id: "file-text_box" }, this.hover ? (h("bds-typo", { class: "text", variant: "fs-14", bold: "regular", "aria-label": termTranslate(this.language, 'dropHere') }, termTranslate(this.language, 'dropHere'))) : (h("bds-typo", { class: "text", variant: "fs-14", bold: "regular", "aria-label": termTranslate(this.language, 'dropOrClick') }, termTranslate(this.language, 'dropOrClick')))), h("img", { key: 'a23c2015a46253bf96393358ba4fbeade3336230', class: { 'upload__img--invisible': true, 'upload__img--visible': this.hover }, src: patternSvg })), h("input", { key: 'd2c52236ccc6f3cd96d533be1bc63748f49afc89', ref: this.refInputElement, type: "file", name: "files[]", id: "file", class: "upload__input", multiple: this.multiple, accept: this.internalAccepts.length > 0 ? this.internalAccepts.toString() : this.accept, onChange: ($event) => this.onUploadClick($event.target.files), "data-test": this.dtInputFiles }))));
    }
    get dropArea() { return this; }
    static get watchers() { return {
        "dataAccept": ["dataAcceptChanged"],
        "files": ["filesChanged"],
        "formatError": ["formatErrorChanged"]
    }; }
    static get style() { return bdsUploadCss; }
}, [1, "bds-upload", {
        "language": [1],
        "titleName": [1, "title-name"],
        "subtitle": [1],
        "error": [1537],
        "multiple": [4],
        "accept": [1],
        "dataAccept": [1, "data-accept"],
        "dtInputFiles": [1, "dt-input-files"],
        "dtLabelAddFile": [1, "dt-label-add-file"],
        "dtButtonDelete": [1, "dt-button-delete"],
        "showListPreview": [4, "show-list-preview"],
        "files": [32],
        "haveFiles": [32],
        "hover": [32],
        "background": [32],
...
function defineCustomElement$1() {
    ...
    const components = ["bds-upload", "bds-banner", "bds-button-icon", "bds-icon", "bds-typo"];
    components.forEach(tagName => { switch (tagName) {
        case "bds-upload":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BdsUpload$1);
            }
            break;
        case "bds-banner":
            if (!customElements.get(tagName)) {
...
const BdsUpload = BdsUpload$1;
const defineCustomElement = defineCustomElement$1;

export { BdsUpload, defineCustomElement };
