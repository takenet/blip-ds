...
import { g as calculatePieLayout, h as generateDonutPath, D as DEFAULT_LEGEND_PALETTE } from './p-CLjGJy6L.js';
...
const ChartPie = /*@__PURE__*/ proxyCustomElement(class ChartPie extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return chartPieCss; }
}, [1, "bds-chart-pie", {
        "data": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["bds-chart-pie"];
    components.forEach(tagName => { switch (tagName) {
        case "bds-chart-pie":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ChartPie);
            }
            break;
    } });
}

const BdsChartPie = ChartPie;
const defineCustomElement = defineCustomElement$1;

export { BdsChartPie, defineCustomElement };
//# sourceMappingURL=bds-chart-pie.js.map
