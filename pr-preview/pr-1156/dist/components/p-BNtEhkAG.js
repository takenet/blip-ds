...
import { d as defineCustomElement$3 } from './p-Cjs3cp-L.js';
import { d as defineCustomElement$2 } from './p-B5d-tOQT.js';
import { d as defineCustomElement$1 } from './p-B0VeGRwM.js';
...
const Image = /*@__PURE__*/ proxyCustomElement(class Image extends H {
    ...
    render() {
        ...
        return (h(Host, { key: 'b7798d3abcb3fe0da3938b890b1abc6479aeccb0', class: { empty_img: !this.imageLoaded } }, this.imageLoaded ? (h("img", { src: this.currentSrc, alt: this.alt, style: {
...
//# sourceMappingURL=p-BNtEhkAG.js.map
