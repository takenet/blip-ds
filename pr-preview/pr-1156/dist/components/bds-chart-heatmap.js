...
import { a as calculateHeatmapLayout } from './p-CLjGJy6L.js';
import { T as TICK_LENGTH, r as renderXAxisLabels, a as renderYAxisLabels } from './p-D5sZS1Wr.js';
...
const ChartHeatmap = /*@__PURE__*/ proxyCustomElement(class ChartHeatmap extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return chartHeatmapCss; }
}, [1, "bds-chart-heatmap", {
        "data": [1],
        "xKey": [1, "x-key"],
        "yKey": [1, "y-key"],
...
function defineCustomElement$1() {
    ...
    const components = ["bds-chart-heatmap"];
    components.forEach(tagName => { switch (tagName) {
        case "bds-chart-heatmap":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ChartHeatmap);
            }
            break;
    } });
}

const BdsChartHeatmap = ChartHeatmap;
const defineCustomElement = defineCustomElement$1;

export { BdsChartHeatmap, defineCustomElement };
//# sourceMappingURL=bds-chart-heatmap.js.map
