...
const BdsloadingBar = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: { loading_bar: true, [`size_${this.size}`]: true }, "data-test": this.dataTest }, index.h("div", { class: { bar_behind: true } }, index.h("div", { class: { loading: true }, style: styles }, index.h("div", { class: "loader" }))))));
  }
};
