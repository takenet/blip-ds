  ...
  static get properties() {
    return {
      ...
      "resizable": {
        ...
        "docs": {
          "tags": [],
          "text": "Define se a \u00E1rea de texto pode ser redimensionada manualmente (apenas para `textarea`)."
        },
        "attribute": "resizable",
        "reflect": false,
        "defaultValue": "false"
      ...
      "autoGrow": {
        ...
        "docs": {
          "tags": [],
          "text": "Define se a altura da \u00E1rea de texto deve crescer automaticamente conforme o conte\u00FAdo (apenas para `textarea`)."
        },
        "attribute": "auto-grow",
        "reflect": false,
        "defaultValue": "false"
      ...
      "maxHeight": {
        ...
        "docs": {
          "tags": [],
          "text": "Define a altura m\u00E1xima da \u00E1rea de texto (apenas para `textarea`). Ex: '300px', '10em'."
        },
