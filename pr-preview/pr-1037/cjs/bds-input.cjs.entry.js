...
const Input = class {
  constructor(hostRef) {
    ...
    this.adjustTextareaHeight = (textarea) => {
      if (!this.autoGrow || !this.isTextarea)
        return;
