...
const Input = class {
   ...
   */
  emailValidation() {
    if (this.nativeInput.value && validations.emailValidation(this.nativeInput.value)) {
   ...
   */
  numberValidation() {
    if (this.nativeInput.value && validations.numberValidation(this.nativeInput.value)) {
