...
const Chip = class {
  constructor(hostRef) {
    ...
    this.bdsDelete = createEvent(this, "bdsDelete", 7);
    this.icon = undefined;
    this.size = 'standard';
  ...
  render() {
    return (h(Host, { class: {
        ...
        ...this.getStateClass(),
        ...this.getSizeClass(),
      } }, this.icon && (h("div", { class: "chip__icon" }, h("bds-icon", { size: "x-small", name: this.icon }))), h("slot", null), this.deletable && (h("div", { class: "chip__delete", onClick: this.handleClickDelete.bind(this) }, h("bds-icon", { size: "x-small", theme: "solid", name: "error" })))));
  }
  get element() { return getElement(this); }
};
Chip.style = chipCss;

export { Chip as bds_chip };
