...
const InputPhoneNumber = class {
  ...
  static get watchers() { return {
    ...
    "initialCountryFlag": ["initialCountryFlagChanged"],
    "initialIsoCode": ["initialIsoCodeChanged"],
