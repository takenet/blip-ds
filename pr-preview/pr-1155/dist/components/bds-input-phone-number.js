...
import { d as defineCustomElement$5 } from './p-DHb-AwhE.js';
import { d as defineCustomElement$4 } from './p-DyA5lKp_.js';
...
const InputPhoneNumber = /*@__PURE__*/ proxyCustomElement(class InputPhoneNumber extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
        this.bdsPhoneNumberChange = createEvent(this, "bdsPhoneNumberChange");
    ...
    static get style() { return inputPhoneNumberCss; }
}, [1, "bds-input-phone-number", {
        "options": [16],
        "text": [1],
        "value": [1025],
        "danger": [1540],
...
function defineCustomElement$1() {
    ...
    const components = ["bds-input-phone-number", "bds-checkbox", "bds-icon", "bds-select-option", "bds-typo"];
    components.forEach(tagName => { switch (tagName) {
        case "bds-input-phone-number":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, InputPhoneNumber);
            }
            break;
        case "bds-checkbox":
            if (!customElements.get(tagName)) {
...
const BdsInputPhoneNumber = InputPhoneNumber;
const defineCustomElement = defineCustomElement$1;

export { BdsInputPhoneNumber, defineCustomElement };
//# sourceMappingURL=bds-input-phone-number.js.map
