...
const Slider = /*@__PURE__*/ proxyCustomElement(class Slider extends H {
    ...
    render() {
        return (h(Host, { key: 'c47534e0d10a7ab475f2fdfafada6f96ce16b4f7' }, h("input", { key: '91a433c70e4de5c41a71d21e0c863e9d9c06bebd', ref: this.refInputSlide, type: "range", class: {
                input_slide: true,
            }, value: this.value, onInput: this.onInputSlide, onMouseEnter: this.onInputMouseEnter, onMouseLeave: this.onInputMouseLeave, "data-test": this.dataTest }), h("div", { key: '372941c2e92712f6832bfa21359bbcee1c7c7077', class: "track-bg" }, h("div", { key: '6e78b399dca8c53f11c64a4129aeb40edfea0cd9', class: { [`progress-bar`]: true, [`progress-bar-liner`]: this.type !== 'no-linear' }, ref: this.refProgressBar }, h("bds-tooltip", { key: 'f1fbd8133851a19415ded65621bf0c91a7a09618', ref: this.refBdsTooltip, class: { [`progress-bar-tooltip`]: true }, position: "top-center", "tooltip-text": this.inputValue }, h("div", { key: 'ed7928a9cd0f760f22b13fb866bb200e229a83bd', class: { [`progress-bar-thumb`]: true } }))), this.markers &&
