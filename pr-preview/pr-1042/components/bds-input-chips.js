...
const InputChips = /*@__PURE__*/ proxyCustomElement(class InputChips extends H {
    ...
    render() {
        ...
        return (h(Host, { key: '2c7abaf7d73fbf5ba07537a862a7cc85ba120078', "aria-disabled": this.disabled ? 'true' : null }, h("div", { key: 'e97d2fe04c5f9b30553d5f798d957d1709a7b427', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), h("div", { key: '02a3495f80097bdf596cd5b9022fee9cffa89797', class: "input__container" }, this.renderLabel(), h("div", { key: 'f650d80fba76391ad4505be28d92973b1eca8bfe', class: "input__container__wrapper", style: { maxHeight: defaultMaxHeight } }, this.internalChips.length > 0 && this.renderChips(), this.inputAvalible && (h("input", { key: 'a4ac1da84aaf87aec3c740de8f2f53b7237044e2', ref: (input) => (this.nativeInput = input), class: "input__container__text", name: this.inputName, maxlength: this.maxlength, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: () => this.handleOnBlur(), onChange: () => this.handleChange, value: this.value, disabled: this.disabled, "data-test": this.dataTest })))), this.counterLength && (h("bds-counter-text", { key: 'a9ec6b198fa9b80de53a4b0e85ceb01315cca896', length: this.internalChips.length, max: this.maxChipsLength, active: isPressed })), this.success && h("bds-icon", { key: 'd92fe2f0c0ed4c647fae9f8ebc350b8aa1b98a48', class: "icon-success", name: "checkb", theme: "outline", size: "xxx-small" }), h("slot", { key: 'c051c83346b7893b2e8187e4dbc294daabc9a1b2', name: "input-right" })), this.renderMessage()));
    }
