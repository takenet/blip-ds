...
const Button = class {
    ...
    render() {
        return (h(Host, { key: 'e9b4730d290ad95c63c29fff94c4abc8d66c5a85', class: { host: true, block: this.block, group: this.group } }, h("div", { key: '6e739d614a4fc948abfb538186c9fdf7629f0f74', tabindex: "0", onKeyDown: (ev) => this.handleClick(ev), class: "focus" }), h("button", { key: '32fcfa2824f056e2264477b7c50ef6cd965b98e2', onClick: (ev) => this.handleClick(ev), disabled: this.disabled, tabindex: "-1", "aria-disabled": this.disabled ? 'true' : 'false', "aria-live": "assertive", type: this.type, class: {
                button: true,
            ...
            }, part: "button", "data-test": this.dataTest }, this.bdsLoading ? this.renderLoadingSpinner() : '', this.iconLeft || this.icon ? (h("bds-icon", { class: { icon_buttom: true, hide: this.bdsLoading }, name: this.icon ? this.icon : this.iconLeft, theme: this.iconTheme, type: this.typeIcon, color: "inherit", size: 'medium' })) : (''), h("bds-typo", { key: '189c95fa690eb50b419f582d861e92fc838f3054', class: { typo_buttom: true, button__content: true, hide: this.bdsLoading }, variant: "fs-14", lineHeight: "simple", bold: "bold" }, h("slot", { key: '5f09722a895c50a984b31cd7f952faec49e1621d' })), this.iconRight || this.arrow ? (h("bds-icon", { class: { icon_buttom: true, hide: this.bdsLoading }, name: this.arrow ? 'arrow-right' : this.iconRight, color: "inherit", theme: this.iconTheme, type: this.typeIcon })) : (''))));
    }
...
//# sourceMappingURL=bds-button.entry.js.map
