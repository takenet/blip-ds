...
const Input = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b4d1fee2987836035820e6d8403d9a9821042305', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '776d31af06d3628c30666c87038a5c22c8a4f789', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("slot", { key: '4b15c0a203aff95741236294bebf6bb83d51359e', name: "input-left" }), index.h("div", { key: '1b00b4bf38799a0297859f49c738de23611ac159', class: "input__container" }, this.renderLabel(), index.h("div", { key: 'b9cb4b621f663815e034932e11f5ec620c6e014a', class: { input__container__wrapper: !this.chips, input__container__wrapper__chips: this.chips } }, index.h("slot", { key: '1585fcf339ca992766ae705e4c2b5455a6a6d4b0', name: "inside-input-left" }), index.h(Element, { key: 'a66e09fbbeb90287f84fc62d1dbcf0d6e40cbc03', class: { input__container__text: true, input__container__text__chips: this.chips }, ref: (input) => (this.nativeInput = input), rows: this.rows, cols: this.cols, autocapitalize: this.autoCapitalize, autocomplete: this.autoComplete, disabled: this.disabled, min: this.min, max: this.max, minLength: this.minlength, maxLength: this.maxlength, name: this.inputName, onBlur: this.onBlur, onFocus: this.onFocus, onInput: this.onInput, placeholder: this.placeholder, readOnly: this.readonly, type: this.type, value: this.encodeValue(this.value), pattern: this.pattern, required: this.required, part: "input", "data-test": this.dataTest }))), this.counterLength && (index.h("bds-counter-text", Object.assign({ key: '2ae6766b6751a6b6b10d73f4bee841dabd894a0a', length: this.value.length, max: this.maxlength, active: isPressed }, this.counterLengthRule))), this.success && index.h("bds-icon", { key: '3026ab9be7fe408e2ba51637514ff332d939600d', class: "icon-success", name: "check", theme: "outline", size: "small" }), index.h("slot", { key: '4eb783d9f97093eedbb6b4fd953fca324161b88a', name: "input-right" })), this.renderMessage()));
    }
