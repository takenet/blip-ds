...
const Input = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c3a178ee9ff4256acfea88750b3019d4455fb285', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '68cb9086ca4eab5f815e9344fb1c960b885b9b4a', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("slot", { key: '091119e437054139c3489f8f16533e78d13053b8', name: "input-left" }), index.h("div", { key: 'f177077d21248d0a6449e1dafca92650c9ffb1c4', class: "input__container" }, this.renderLabel(), index.h("div", { key: '1b3ba8e6cd72a21d1672cfdc02836872b81d2600', class: { input__container__wrapper: !this.chips, input__container__wrapper__chips: this.chips } }, index.h("slot", { key: 'ad157a6a2887508ddf2004af14918dcd24099d59', name: "inside-input-left" }), index.h(Element, { key: '99a92eafba694cd7cb270b86077068d4f76d7dea', class: { input__container__text: true, input__container__text__chips: this.chips }, ref: (input) => (this.nativeInput = input), rows: this.rows, cols: this.cols, autocapitalize: this.autoCapitalize, autocomplete: this.autoComplete, disabled: this.disabled, min: this.min, max: this.max, minLength: this.minlength, maxLength: this.maxlength, name: this.inputName, onBlur: this.onBlur, onFocus: this.onFocus, onInput: this.onInput, placeholder: this.placeholder, readOnly: this.readonly, type: this.type, value: this.encodeValue(this.value), pattern: this.pattern, required: this.required, part: "input", "data-test": this.dataTest }))), this.counterLength && (index.h("bds-counter-text", { key: '8fcd150fb13589fcb3d6b8c97027ca46296558d8', length: this.value.length, max: this.maxlength, active: isPressed, ...this.counterLengthRule })), this.success && index.h("bds-icon", { key: '61e1aa0b7cce19c664e77b64c1748c7e1833deeb', class: "icon-success", name: "check", theme: "outline", size: "small" }), index.h("slot", { key: '894b91c87ba90339365f0046f2abf2178336d590', name: "input-right" })), this.renderMessage()));
    }
