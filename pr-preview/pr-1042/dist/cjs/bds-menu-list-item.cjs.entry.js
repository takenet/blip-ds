...
const MenuListItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '89bd5652a5ea86493c63676b77b40b4472edf8b5', role: "button" }, index.h("div", { key: 'cb391b403ffefceb5d20f6abb213c637bfe5ac83', class: "menu-list-item" }, index.h("bds-icon", { key: 'd1ff9e0a0f7ee5f5e5c0845f54296038d1fbc30c', color: color, name: this.icon }), index.h("bds-typo", { key: 'd46a804c62862cba2cb0fa498c581d3fa62a069d', class: "menu-list-item__text", variant: "fs-10" }, index.h("slot", { key: 'd0d75141341779cabe9eb56f57a66382f69a689d' })))));
    }
};
