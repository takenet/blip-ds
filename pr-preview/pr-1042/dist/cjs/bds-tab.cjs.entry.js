...
const Tab = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f6803a9fb97f32f6da9fc41625471289d7a18c7a', class: {
                'bds-tab': true,
                ['bds-tab--selected']: this.isActive,
            }, onClick: this.onClick.bind(this) }, index.h("div", { key: '4436e3e8886b9f048c3d24eee2f63c50fed99a37', class: "bds-tab__text" }, index.h("bds-typo", { key: 'ac22ced9b0dfd0299ec75d09403e8b19b054dd7a', variant: "fs-16", bold: bold }, this.label))));
    }
};
Tab.style = tabCss;
