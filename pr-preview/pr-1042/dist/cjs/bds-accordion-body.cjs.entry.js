...
const AccordionBody = class {
    ...
    render() {
        return (index.h("div", { key: '5976bbf52d123b3534d352a00dabe2df406dad25', class: {
                accordion_body: true,
                accordion_body_divisor: this.hasDivisor,
                accordion_body_isOpen: this.isOpenAftAnimation,
            }, style: { height: `${this.heightContainer}px` }, "data-test": this.dataTest }, index.h("div", { key: 'c1038dc51ecd25fbfd5a18b11c52fb901b504f56', class: "container", ref: (el) => this.refContainer(el) }, index.h("slot", { key: 'ba113dcabd2c5ed50dd672284a61702b1741f877' }))));
    }
...
//# sourceMappingURL=bds-accordion-body.entry.cjs.js.map

//# sourceMappingURL=bds-accordion-body.cjs.entry.js.map