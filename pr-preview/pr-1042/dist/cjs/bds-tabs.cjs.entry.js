...
const Tabs = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd72b623b0f4f74cd8c732dc180945ae9720982b3', class: {
                'bds-tabs': true,
                [`bds-tabs--${this.align}`]: true,
            } }, index.h("div", { key: 'a10e1ab6e8050536d5a63de478e1734600524200', class: "bds-tabs__header-button-container" }, index.h("bds-button-icon", { key: 'df38ce90080f6a6d4efcea5f5544c31ac9c789af', class: "bds-tabs__header-button", icon: "arrow-left", size: "short", id: "bds-tabs-button-left", onClick: () => this.handleScrollButtonClick("left" /* ScrollDirection.LEFT */), variant: "secondary" })), index.h("div", { key: '396ab75ed389a54d52a6b86cae3bbc6037f4c738', class: "bds-tabs__header" }, index.h("slot", { key: 'fe01e9b24ecb35ee2400e4d490b268c2258da2b8' })), index.h("div", { key: '6a88ef7447c43e90d6f5342958a5d42c394e7590', class: "bds-tabs__header-button-container" }, index.h("bds-button-icon", { key: 'aa686b62cf5a15c9293b45c3c051690431670ad8', class: "bds-tabs__header-button", icon: "arrow-right", size: "short", id: "bds-tabs-button-right", onClick: () => this.handleScrollButtonClick("right" /* ScrollDirection.RIGHT */), variant: "secondary" }))));
    }
