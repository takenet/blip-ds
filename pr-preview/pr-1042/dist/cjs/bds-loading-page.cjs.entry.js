...
const BdsLoading = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ff20c5c8734d3548080aa6bb40f0686b9a94aea1' }, index.h("div", { key: '0eea0358eeb7d460f4aa6acc4107f634118eb1ab', class: "loading-container", "data-test": this.dataTest }, index.h("div", { key: '53c17e4b9a39360af5dde5d71284bd6a4a01318f', class: { page_loading: true }, innerHTML: this.svgContent }))));
    }
};
