...
const ChipClickable = class {
    ...
    render() {
        return (index.h(index.Host, { key: '701930b3271cd381aee70709c6f3992ed98e6f0d' }, index.h("div", { key: 'c0bf981012d37bef741293a72811fee28ae55657', class: {
                chip_clickable: true,
            ...
            }, onClick: this.handleClick.bind(this), "data-test": this.dataTest }, this.clickable && !this.disabled && (index.h("div", { key: 'a80c97c41fe2f042b17bfbef4f905c968991532b', class: "chip_focus", onKeyDown: this.handleClickKey.bind(this), tabindex: "0" })), this.clickable && !this.disabled && index.h("div", { key: 'f9bd96ff044af8e25ba8e564f6bcb86709079735', class: "chip_darker" }), this.icon && !this.avatar && (index.h("div", { key: '056c7ef70c4811b59a3404191d179aad68c2fcdd', class: "chip_clickable--icon" }, index.h("bds-icon", { key: '7c11d82f56fa7426ee6b09c46c9ecde97038561c', size: this.getSizeIconChip(), name: this.icon }))), this.avatar && (index.h("div", { key: 'e5dbf9e23452f19f430883caa21db0dc0919a632', class: "chip_clickable--avatar" }, index.h("bds-avatar", { key: '6caa3097f9427b899e5c8c9a8b500f10039f5172', size: this.getSizeAvatarChip(), thumbnail: this.avatar }))), index.h("div", { key: 'db9ccaaa668cd48cee88b0ab482aa0c56fdef6dc', class: this.close && (this.icon || this.avatar)
                ? `chip_clickable--container-text--min`
                : !this.close && !this.icon && !this.avatar
                    ? `chip_clickable--container-text--full`
                    : `chip_clickable--container-text--half` }, index.h("bds-typo", { key: '6c7e0888d9a1dcaec0ac6c362747f73820c8776a', "no-wrap": "true", class: "chip_clickable--text", variant: "fs-12", bold: "bold" }, index.h("slot", { key: '86c4b319a3bc1be4f215769deffd5da6131e1a38' }))), this.close && (index.h("div", { key: '546aa9f33a01e1c01be3221c09854d587e8d2f0d', class: "chip_clickable--close", "data-test": this.dtButtonClose, onClick: this.handleCloseChip.bind(this) }, !this.disabled && (index.h("div", { key: '42b605c6ef58d026b236f3e59abbe9d0de5eb629', class: "close_focus", onKeyDown: this.handleCloseKey.bind(this), tabindex: "0" })), index.h("bds-icon", { key: '20ca03f78f4baea77931d48e9aa5af9abd64119f', size: "x-small", theme: "solid", name: "error" }))))));
    }
