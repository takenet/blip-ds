...
const ChipClickable = class {
    constructor(hostRef) {
        ...
        this.chipClickableClose = index.createEvent(this, "chipClickableClose");
        this.chipClickableClick = index.createEvent(this, "chipClickableClick");
        this.visible = true;
        /**
    ...
    render() {
        return (index.h(index.Host, { key: 'a484e58dc90b62b8ad74a11705d0efd8382185e3' }, index.h("div", { key: '3d0a2c590ffe9ae89941c5bd2e73e2b407b1add3', class: {
                chip_clickable: true,
            ...
            }, onClick: this.handleClick.bind(this), "data-test": this.dataTest }, this.clickable && !this.disabled && (index.h("div", { key: '6c6e89984c427d3e20aaca4d0339992818e0e4dd', class: "chip_focus", onKeyDown: this.handleClickKey.bind(this), tabindex: "0" })), this.clickable && !this.disabled && index.h("div", { key: '002103387277cde8a86afce59ae22a6eabd55bf6', class: "chip_darker" }), this.icon && !this.avatar && (index.h("div", { key: '3d407de38a7e442356d24a954e7a041bf5d3518a', class: "chip_clickable--icon" }, index.h("bds-icon", { key: 'decf9fe0ab44c101f366070fb71347d83b62f6ec', size: this.getSizeIconChip(), name: this.icon }))), this.avatar && (index.h("div", { key: '38ead54424b4435cd6da1c0794a3b1987179f692', class: "chip_clickable--avatar" }, index.h("bds-avatar", { key: 'daca44da604029e5e93078f062efa9419e637552', size: this.getSizeAvatarChip(), thumbnail: this.avatar }))), index.h("div", { key: '2c22c9824b2adc7f54049dc5149f0a700306498b', class: this.close && (this.icon || this.avatar)
                ? `chip_clickable--container-text--min`
                : !this.close && !this.icon && !this.avatar
                    ? `chip_clickable--container-text--full`
                    : `chip_clickable--container-text--half` }, index.h("bds-typo", { key: '6beed0256b3985cb870d1545af3c634755fd3f8b', "no-wrap": "true", class: "chip_clickable--text", variant: "fs-12", bold: "bold" }, index.h("slot", { key: '0138704cd285cf018738f81cb0f4aadaf0ce2f50' }))), this.close && (index.h("div", { key: '0343f5ce17252337c094a668faa79a743c1da788', class: "chip_clickable--close", "data-test": this.dtButtonClose, onClick: this.handleCloseChip.bind(this) }, !this.disabled && (index.h("div", { key: '8825c413ad7a45f563a938aa786e227d4e94da13', class: "close_focus", onKeyDown: this.handleCloseKey.bind(this), tabindex: "0" })), index.h("bds-icon", { key: '764137a65a22077d31b6e9d3da826c2e88a1483b', size: "x-small", theme: "solid", name: "error" }))))));
    }
...
const Tooltip = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '6da2ea779f9807677a19729e15ccd61aca97b0ca', class: "tooltip__wrapper" }, index.h("div", { key: 'c37849f8004ccf25a43af153e2f5a7261fb138ef', onMouseEnter: () => this.setVisibility(true), onMouseLeave: () => this.setVisibility(false), "data-test": this.dataTest }, index.h("slot", { key: '653e81c1c01d88500dc16a82396bba779e8b9273' })), index.h("div", { key: '4a4a53fabfdcb86e3ee0071da326b467010fb6d6', class: {
                tooltip__tip: true,
                [`tooltip__tip--${this.position}`]: true,
                'tooltip__tip--visible': this.isMouseOver,
            }, style: styleTooltip }, index.h("div", { key: '6b2efdb0caa33e685195c0f6180c6dbc707e5571', class: { tooltip__tip__text: true } }, index.h("pre", { key: '6de01456532d086f8558bcaa0a9546081778b7d4' }, index.h("bds-typo", { key: '93c3a9e4c145c1daf59514eb50229f0571377df4', class: "text", "no-wrap": "false", variant: "fs-12" }, this.textVerify))))));
    }
...
//# sourceMappingURL=bds-chip-clickable.bds-tooltip.entry.cjs.js.map

//# sourceMappingURL=bds-chip-clickable_2.cjs.entry.js.map