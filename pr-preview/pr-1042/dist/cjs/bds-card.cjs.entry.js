...
const Card = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f465d0420f15a085a245b489897e4975add95b44', style: styleHost }, index.h("bds-paper", { key: '26494b3cdfe65e0657e896384b3198b542a9bd7d', border: this.clickable ? false : true, elevation: this.elevation, class: {
                card: true,
            ...
            }, height: this.height, width: this.width, bgColor: this.bgColor, "data-test": this.dataTest, "border-color": this.borderColor ? this.borderColor : 'border-1' }, index.h("div", { key: '4f9525f826db934fa3c14183691d2bf4979daa27', tabindex: "0", class: "focus", onKeyDown: this.handleKeyDown.bind(this) }), index.h("bds-grid", { key: 'c9a68827896f0b658436894c6d6746d8d9e6ff43', xxs: "12", direction: "column", gap: "2", padding: "2" }, index.h("slot", { key: 'bfbd3a500cd940636d267ce3ac798ee15bd0264a' })))));
    }
