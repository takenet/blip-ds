...
const NavTreeItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '132f1aef904238c9b1f06c6e3aca642352e624dc' }, index.h("div", { key: '4bb75979a31792d0f0dd0410fdfff246138dc0f6', tabindex: "0", onKeyDown: this.handleKeyDown.bind(this), class: "focus" }, index.h("div", { key: '65d30eaa7a06897792095e7ae07fb581a5c344df', class: {
                nav_tree_item: true,
            ...
            }, size: "medium", name: this.icon, color: "inherit", theme: "outline" })) : (''), index.h("div", { key: 'dde25a462dd853123f9887fb0c5b894a4c78d195', class: "nav_tree_item_content" }, this.text && (index.h("bds-typo", { key: '8b005de6c39ed9307eb37aef926d153ebfb8131e', class: { ['title-item']: true, [`title-item--loading`]: this.loading }, variant: "fs-14", tag: "span", "line-height": "small", bold: this.isOpen ? 'bold' : 'semi-bold' }, this.text)), this.secondaryText && (index.h("bds-typo", { key: '8d3ffaa925e509aad1b34d120c3eab83e27b8c05', class: { ['subtitle-item']: true, [`subtitle-item--loading`]: this.loading }, variant: "fs-12", "line-height": "small", tag: "span", margin: false }, this.secondaryText))), index.h("div", { key: '0ade154ce111fbb6cf8bae7963ab39c6577f1e58', class: "nav_tree_item_slot" }, index.h("slot", { key: '77b7c0dd3867fa0625ade6b94886d8635cb9e9d0', name: "header-content" })), this.navTreeChild && (index.h("bds-icon", { key: 'ff516a57eca474bfc55474165bddab1a982146f4', class: {
                [`nav_main_arrow`]: true,
                [`nav_main_arrow_active`]: this.isOpen,
                [`nav_main_arrow--loading`]: this.loading,
            }, name: "arrow-down" })))), this.navTreeChild && (index.h("div", { key: 'fb148be91f18db7517aaeb4058ea2fd74f79f3fe', class: {
                accordion: true,
                accordion_open: this.isOpen,
            } }, index.h("div", { key: '5eb2a7ad53d70954a8a0df66fd400c1f814339bb', class: "container" }, index.h("slot", { key: 'dd1b62b23e6bb68f8844294eb21f5ae23f594cbb' }))))));
    }
