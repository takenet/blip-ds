...
const NavTreeItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a3422e7629ea37ebfe00471483c1a59af062ef30' }, index.h("div", { key: '721bbf812db14c85f953b626399b78a980f73351', tabindex: "0", onKeyDown: this.handleKeyDown.bind(this), class: "focus" }, index.h("div", { key: 'da1830422efaf5d4002fd4363abd699ac3f1360e', class: {
                nav_tree_item: true,
            ...
            }, size: "medium", name: this.icon, color: "inherit", theme: "outline" })) : (''), index.h("div", { key: '30e7cd546407058418409e15aff6e02501db98e7', class: "nav_tree_item_content" }, this.text && (index.h("bds-typo", { key: '0f5d3381d15afba2a7c7b24ab1b4487387a01b0e', class: { ['title-item']: true, [`title-item--loading`]: this.loading }, variant: "fs-14", tag: "span", "line-height": "small", bold: this.isOpen ? 'bold' : 'semi-bold' }, this.text)), this.secondaryText && (index.h("bds-typo", { key: 'e4ab837492e60d122db330d9aa467ac3b11c8e4a', class: { ['subtitle-item']: true, [`subtitle-item--loading`]: this.loading }, variant: "fs-12", "line-height": "small", tag: "span", margin: false }, this.secondaryText))), index.h("div", { key: 'bbccc7a7db0939cd156aaf9d1cf7787ebfc2d821', class: "nav_tree_item_slot" }, index.h("slot", { key: '873e50660a2f6f64449dcdc14e74195809ca6277', name: "header-content" })), this.navTreeChild && (index.h("bds-icon", { key: 'e6d49843188ccfe13cc03ec605414b64dd3721ec', class: {
                [`nav_main_arrow`]: true,
                [`nav_main_arrow_active`]: this.isOpen,
                [`nav_main_arrow--loading`]: this.loading,
            }, name: "arrow-down" })))), this.navTreeChild && (index.h("div", { key: '391abd866e68a3fee52012a7c09be72e4a08b7e1', class: {
                accordion: true,
                accordion_open: this.isOpen,
            } }, index.h("div", { key: '322196398fdc34c1f1d4abf91283b9235eb16516', class: "container" }, index.h("slot", { key: 'c8b4ba0887ffb78407e9cebcc9de02ba44a26c91' }))))));
    }
