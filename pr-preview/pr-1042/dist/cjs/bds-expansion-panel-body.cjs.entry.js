...
const ExpansionPanelBody = class {
    ...
    render() {
        return (index.h(index.Host, { key: '60bf4fb3d6bc5d6a483b723aa424a0504990b9b3' }, index.h("div", { key: '0c4d81efe8ca2af62c969b60626a3cfed4e5a0dd', class: "expansion-content", hidden: this.open }, index.h("div", { key: 'c78e5d70669201e94a4361e774865a3c0d079da1', class: "with-line" }, index.h("slot", { key: 'd718d1570b459ba4dec3fc6cda9c44d1f7918e9b' }), this.text ? (index.h("div", { class: "text" }, index.h("p", null, this.text))) : (index.h("div", { class: "circle" }))))));
    }
};
