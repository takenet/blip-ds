...
const Slider = class {
    ...
    render() {
        return (index.h(index.Host, { key: '467db17ea6e61e49e86f6e94aa0f3ce5a11ece9f' }, index.h("input", { key: '3b01de378c35eb6263d4312246e0382e7cbdd447', ref: this.refInputSlide, type: "range", class: {
                input_slide: true,
            }, value: this.value, onInput: this.onInputSlide, onMouseEnter: this.onInputMouseEnter, onMouseLeave: this.onInputMouseLeave, "data-test": this.dataTest }), index.h("div", { key: 'a5078b512172b0b8af4b602fb014054d262d5d6d', class: "track-bg" }, index.h("div", { key: 'f2f4d797e7c9c1357eaae77e156575efc5287252', class: { [`progress-bar`]: true, [`progress-bar-liner`]: this.type !== 'no-linear' }, ref: this.refProgressBar }, index.h("bds-tooltip", { key: 'c254c55df8b7dbd9ca30a87567eabddd74387993', ref: this.refBdsTooltip, class: { [`progress-bar-tooltip`]: true }, position: "top-center", "tooltip-text": this.inputValue }, index.h("div", { key: 'ba9a411602639c482c761eab0d9977ffe3b2fcd4', class: { [`progress-bar-thumb`]: true } }))), this.markers &&
