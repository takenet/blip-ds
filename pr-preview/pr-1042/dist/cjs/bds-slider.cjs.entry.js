...
const Slider = class {
    ...
    render() {
        return (index.h(index.Host, { key: '098a2677037063a6c91b0749bb14b021a9f0e5f7' }, index.h("input", { key: '62f32c2843f262da19b50c248ee4ca2e3f237622', ref: this.refInputSlide, type: "range", class: {
                input_slide: true,
            }, value: this.value, onInput: this.onInputSlide, onMouseEnter: this.onInputMouseEnter, onMouseLeave: this.onInputMouseLeave, "data-test": this.dataTest }), index.h("div", { key: '1308e5d723d061552f7213d7434fd052ab515288', class: "track-bg" }, index.h("div", { key: '7aef7d6ccd4c67562ded34229623d1d4d8f57d97', class: { [`progress-bar`]: true, [`progress-bar-liner`]: this.type !== 'no-linear' }, ref: this.refProgressBar }, index.h("bds-tooltip", { key: 'e6d1ce423673385318af723623d3ade7c020cd7f', ref: this.refBdsTooltip, class: { [`progress-bar-tooltip`]: true }, position: "top-center", "tooltip-text": this.inputValue }, index.h("div", { key: '35771dc12b68716e291982720c9ebc255c5dfd81', class: { [`progress-bar-thumb`]: true } }))), this.markers &&
