...
const Radio = class {
    constructor(hostRef) {
        ...
        this.bdsClickChange = index.createEvent(this, "bdsClickChange");
        /**
    ...
    render() {
        return (index.h(index.Host, { key: '37b3f36bb81b57708b91406c5c8a844f6d4c8ba4' }, index.h("label", { key: 'ae3905590ac776f361a417b109a231dc5d79b4e8', class: "radio", htmlFor: this.radioId }, index.h("input", { key: '303991b490baf075e0c04e9fcfc0cdf9a400daed', class: "radio__input", type: "radio", ref: this.refNativeInput, id: this.radioId, onClick: this.onClick, disabled: this.disabled, checked: this.checked, value: this.value, name: this.name, "data-test": this.dataTest }), index.h("div", { key: 'd53ec5d624c13c564ed56319798711f2a70bc1c4', class: "radio__circle" }, !this.disabled ? index.h("div", { class: "focus", tabindex: "0", onKeyDown: this.handleClickKey.bind(this) }) : '', !this.disabled ? index.h("div", { class: "hover" }) : '', index.h("div", { key: 'c31679c6eec396ff2ea6c02c722b0b7927caf678', class: "radio__circle__pointer" })), this.label && (index.h("bds-typo", { key: '42ac37f3e3c98a2c65658eef0edc8161105b1e41', class: "radio__text", variant: "fs-14", bold: this.checked ? 'bold' : 'regular', tag: "span" }, this.label)), index.h("slot", { key: '577f05d7d5ee93dce3615c67a2ea7fd0fb593725' }))));
    }
...
const Switch = class {
    ...
    render() {
        ...
        return (index.h("label", { key: '436ed33ad83041289505840a79399cd2b5ec181d', class: { [sizeClass]: true } }, index.h("div", { key: '5cb1149c85d4d036a663d2a3181039c6f9322106', tabindex: "0", onKeyDown: (ev) => this.handleClick(ev), class: "focus" }), index.h("input", { key: 'be37c22d7651839251448700f14621b62a1fd120', type: "checkbox", ref: this.refNativeInput, id: this.switchId, name: this.name, onClick: this.onClick, checked: this.checked, disabled: this.disabled, "data-test": this.dataTest }), index.h("span", { key: 'c9f243ee191a52fb9c793132fb8ea6f225c9db91', class: { [sizeSliderClass]: true, [styleState]: true } })));
    }
    static get watchers() { return {
        "checked": ["checkedChanged"]
    }; }
...
//# sourceMappingURL=bds-radio.bds-switch.entry.cjs.js.map

//# sourceMappingURL=bds-radio_2.cjs.entry.js.map