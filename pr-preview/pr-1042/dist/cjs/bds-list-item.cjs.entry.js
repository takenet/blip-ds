...
const ListItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '56f8abbad0d450166ba62956ce3e3fa17dd40e15' }, index.h("div", { key: '42ac5c1f2f37189481108a84e37419123eb124bf', onClick: this.handler, tabindex: "0", class: {
                list_item: true,
                clickable: hasInput,
                border_radius: this.borderRadius,
                [`list_item_${this.size}`]: true,
            }, "data-test": this.dataTest }, this.active && index.h("div", { key: '113b8e54e59723374cfd4f9e9874bb2689498376', class: "active" }), hasLeftInput && (index.h("div", { key: '91b65bee05d965ceccc51841a9cc1fe44957e061', class: { input_list: true } }, this.typeList == 'radio' && index.h("bds-radio", { key: 'b1d4bb209f945de1ffc5055769ecb5e7b505615b', value: this.value, checked: this.checked }), this.typeList == 'checkbox' && (index.h("bds-checkbox", { key: '6592d72497d1f9989772688d0f47cc81094dbb60', refer: "", label: "", name: "cb1", disabled: false, checked: this.checked })))), hasAvatar ? (index.h("bds-avatar", { class: "avatar-item", name: this.avatarName, thumbnail: this.avatarThumbnail, size: "extra-small" })) : (this.icon && (index.h("bds-icon", { class: {
                [`icon-item`]: true,
                [`icon-item-active`]: this.active,
            }, size: "medium", name: this.icon, color: "inherit", theme: this.active ? 'solid' : 'outline' }))), index.h("div", { key: 'ed24b2464863b3050d004b422e03e88e4d2eda3d', class: { [`content-slot`]: true } }, index.h("slot", { key: '92b701d45a847fe523b5757b338332f9aad47259' })), (this.text || this.secondaryText) && (index.h("div", { key: '9937d50680a246a50444880cea3e6cacd2d7f61e', class: {
                [`content-item`]: true,
                [`grow-up`]: !this.hasActionAreaSlot && !this.hasContentAreaSlot && this.internalChips.length < 0,
            } }, this.text && (index.h("bds-typo", { key: '59aadf41d9563848ef055a4b17315d070544c2ce', class: "title-item", variant: "fs-16", tag: "span", bold: this.active ? 'bold' : 'regular' }, this.text)), this.secondaryText && (index.h("bds-typo", { key: 'fd6dac17a8458295f54a5841f2704b12ca82fb21', class: "subtitle-item", variant: "fs-12", "line-height": "small", tag: "span" }, this.secondaryText)))), index.h("div", { key: '41047fcc535640d9091abbe5af4689f8f8cc0840', class: { [`content-area`]: true, [`grow-up`]: true } }, this.internalChips.length > 0 && index.h("div", { key: '9bf4d9e33adc8c84114353fea46573f677a41316', class: "internal-chips" }, this.renderChips()), index.h("slot", { key: '7368ea5db603c6afca931256a985faac6acafdfd', name: "content-area" })), (!this.typeList || this.typeList == 'default') && (index.h("div", { key: '476037573189161ba9f9148825d738ac99e0c56f', class: { [`action-area`]: true } }, this.internalActionsButtons.length > 0 && (index.h("div", { key: '2de36580618a601459ca51c0a3f94acd17543afb', class: "internal-actions-buttons" }, this.renderActionsButtons())), index.h("slot", { key: '16086839c741059cfb8967c397cdf38b75131a9b', name: "action-area" }))), this.typeList == 'switch' && index.h("bds-switch", { key: 'd2802b507bb137154b7ab7bfd1c8f67eff6bfebd', refer: "", name: "", checked: this.checked }))));
    }
