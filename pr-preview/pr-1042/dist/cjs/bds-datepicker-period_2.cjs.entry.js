...
const BdsdatepickerPeriod = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '89a7160112bc413c438f203041e212e8472339b8', class: { datepicker__calendar: true, [`period`]: true } }, index.h("div", { key: '38d08bc76ae8c8107ffaded151b71b8d2f44a09a', class: { datepicker__calendar__selectDate: true } }, index.h("bds-icon", { key: '05f01d81f77548e34ca2cb6a67c63cd696a9c8ef', class: {
                [`arrow-left`]: true,
        ...
        ], index.h("bds-typo", { key: 'e45f1ae1ef8f250697bc6d9499776b16af8217a0', class: "datepicker__calendar__selectDate__futureMonth", variant: "fs-14" }, `${futureMonth[0].label}, ${futureYear}`), index.h("bds-icon", { key: '151f5834ce508f8cf984e3857bbe375151d6cc7c', class: {
                [`arrow-right`]: true,
                [`arrow-right__disable`]: calendar.fillDayList(this.monthsSlide[2].days[0]) > calendar.fillDayList(this.endDate),
                datepicker__calendar__selectDate__icon: true,
            }, name: "arrow-right", theme: "outline", size: "small", onClick: () => this.nextMonth(), dataTest: this.dtButtonNext })), index.h("div", { key: 'e864299856cbee0503b5fb92940120d9660804a4' }, index.h("div", { key: '59954bf4d7da811d930de398c974d62fbcfe027b', class: { datepicker__calendar__week: true } }, index.h("div", { key: '9625acc689ed237f905343d9443ae16d0ce775fa', class: { datepicker__calendar__week__present: true } }, this.week.map((item, idx) => (index.h("bds-typo", { variant: "fs-14", key: idx, class: `datepicker__calendar__week__day` }, item.charAt(0))))), index.h("div", { key: '0ce89bdd417a828282d88ea49347ab43b2cd0837', class: { datepicker__calendar__week__future: true } }, this.week.map((item, idx) => (index.h("bds-typo", { variant: "fs-14", key: idx, class: `datepicker__calendar__week__day` }, item.charAt(0)))))), index.h("div", { key: 'bcdd054ef9d84ef1cab3c64255a2e1ce34cdd4cd', class: { datepicker__calendar__car: true, datepicker__calendar__car__period: true } }, index.h("div", { key: 'd4d9595cf5f9325033dd2f8d4aa13a27069e0967', class: {
...
const BdsdatepickerSingle = class {
    ...
    render() {
        return (index.h("div", { key: '7e0aab067a51bea8fc355d2fab7f8dcebd9376a5', class: { datepicker__calendar: true } }, index.h("div", { key: '769e707225d9e50a73d950c981da4d7203dafdf6', class: { datepicker__calendar__selectDate: true } }, index.h("bds-icon", { key: '145c35fffe029b22f81d899a906dc840aac2dcf2', class: {
                [`arrow-left`]: true,
                [`arrow-left__disable`]: calendar.fillDayList(this.monthsSlide[0].days[this.monthsSlide[0].days.length - 1]) <
                    calendar.fillDayList(this.startDate),
                datepicker__calendar__selectDate__icon: true,
            ...
            this.renderSelectData(this.months, this.monthActivated, 'months'),
            this.renderSelectData(this.years, this.yearActivated, 'years'),
        ], index.h("bds-icon", { key: '15079bef09da8623ef616ceae2fc2fc3cbcc6aa1', class: {
                [`arrow-right`]: true,
                [`arrow-right__disable`]: calendar.fillDayList(this.monthsSlide[2].days[0]) > calendar.fillDayList(this.endDate),
                datepicker__calendar__selectDate__icon: true,
            }, name: "arrow-right", theme: "outline", size: "small", onClick: () => this.nextMonth(), dataTest: this.dtButtonNext })), index.h("div", { key: 'af95fc065627cbc7028a22ad98fbb9197d4daaec' }, index.h("div", { key: '83f8cc833bc19a0123db5d48480878c7b19426e1', class: { datepicker__calendar__week: true } }, this.week.map((item, idx) => (index.h("bds-typo", { variant: "fs-14", key: idx, class: `datepicker__calendar__week__day` }, item.charAt(0))))), index.h("div", { key: '856456a524c27b9f54dd4028d89f298ed4f2a6a5', class: { datepicker__calendar__car: true } }, index.h("div", { key: '65fb3c9e4a013717cf3911b1b157c80821017fff', class: {
                datepicker__calendar__car__slide: true,
                animate__prev: this.animatePrev,
                animate__next: this.animateNext,
            } }, [
