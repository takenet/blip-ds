...
const BdsUpload = class {
    ...
    render() {
        return (index.h("div", { key: '1f75f1bf649088e0893fe64f27a9ef37de84b78a', class: "upload" }, index.h("div", { key: 'b8fc280093d1fd6bdc46583c71a56a4f5a27f9e4', class: "upload-header" }, index.h("bds-icon", { key: '145546937a1399ef5c121b2a1c0bd2545667e987', class: "upload-header_icon", size: "xxx-large", name: "upload" }), index.h("div", { key: '9fff2b1c4d1c5b6a50c18c5ea8fd8a9840552263', class: "upload-header_text" }, index.h("bds-typo", { key: '726cf65caa77d4f372918868d050c8b69e29c038', variant: "fs-16", bold: "bold", "aria-label": this.titleName }, this.titleName), index.h("bds-typo", { key: '2065f3a6ad9157bc014ddb053b0fe73b0b7497b7', variant: "fs-14", bold: "regular", "aria-label": this.subtitle }, this.subtitle))), this.error ? (index.h("bds-banner", { context: "inside", variant: "error", "aria-label": this.error }, this.error)) : (''), this.haveFiles ? (index.h("div", null, index.h("div", { class: "list-preview" }, this.files.map((names, index$1) => (index.h("div", { class: "upload__preview", key: index$1, id: "drop-area" }, index.h("div", { class: "preview", id: "preview" }, index.h("bds-icon", { size: "x-small", name: "attach" }), index.h("p", { class: "preview-text", id: "preview-text", "aria-label": names.name }, names.name), index.h("bds-button-icon", { class: "preview-icon", size: "short", icon: "trash", variant: "secondary", onClick: () => this.deleteFile(index$1), "aria-label": `delete ${names.name}`, "data-test": `${this.dtButtonDelete}-${index$1}` })))))), this.multiple ? (index.h("bds-typo", { variant: "fs-14", italic: true, class: "preview-length", "aria-label": termTranslate(this.language, 'uploaded') }, this.files.length > 1 ? `${this.files.length} ${termTranslate(this.language, 'uploaded')}` : '')) : (''))) : (''), index.h("div", { key: 'd4e4954f155c51071cf3e884a73dd840b0912a8c', class: { upload__edit: true } }, index.h("label", { key: '27ba7a823d4d48d726706f0ab2edecd1e77a4ebf', class: { 'upload__edit--label': true, 'upload__edit--hover': this.hover }, id: "file-label", htmlFor: "file", "data-test": this.dtLabelAddFile, tabindex: "0", onKeyDown: this.handleKeyDown.bind(this) }, index.h("div", { key: 'c3bd4bb2ab9c02c22f12cec3e6de4fa708bcd060', class: { 'text-box': true, 'text-box--hover': this.hover }, id: "file-text_box" }, this.hover ? (index.h("bds-typo", { class: "text", variant: "fs-14", bold: "regular", "aria-label": termTranslate(this.language, 'dropHere') }, termTranslate(this.language, 'dropHere'))) : (index.h("bds-typo", { class: "text", variant: "fs-14", bold: "regular", "aria-label": termTranslate(this.language, 'dropOrClick') }, termTranslate(this.language, 'dropOrClick')))), index.h("img", { key: 'a38b8c18d54da95ac8f75e036f5b17035ea0cbb0', class: { 'upload__img--invisible': true, 'upload__img--visible': this.hover }, src: patternSvg })), index.h("input", { key: 'e7ebf4a4a9180540ee0608ab06278ce07f5db04b', ref: this.refInputElement, type: "file", name: "files[]", id: "file", class: "upload__input", multiple: this.multiple, accept: this.internalAccepts.length > 0 ? this.internalAccepts.toString() : this.accept, onChange: ($event) => this.onUploadClick($event.target.files), "data-test": this.dtInputFiles }))));
    }
