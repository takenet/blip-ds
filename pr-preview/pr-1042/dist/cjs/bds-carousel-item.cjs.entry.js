...
const BdsCarouselItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ebfdf0239ba4d37cf2a4cda25a7f4dc218a54fdc', class: "carrosel-item" }, index.h("bds-theme-provider", { key: '26f07e1cc102f5a4477b53e1328abc85b5770167', theme: this.theme, class: "carrosel-item-frame", style: { background: this.bgColor } }, this.bgImage && (index.h("bds-image", { key: '86e54cca972913460b72afed4ffa520fab8ce9f5', class: "image-bg", alt: "Example of a image", width: "100%", height: "100%", brightness: this.bgImageBrightness, "object-fit": "cover", src: this.bgImage })), index.h("slot", { key: 'b9b4bc60e68d5036ad59547a635487ccc9ff9d9e' }))));
    }
};
