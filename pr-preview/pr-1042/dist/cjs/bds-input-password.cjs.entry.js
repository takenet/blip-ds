...
const InputPassword = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2ee16c187372d72210ea58ec53674505dcbeb815', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: 'b005027cfade6834d2eb329fb398665881f625ec', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: 'f7f481377822534a10f65e674f7375c60a04b227', class: "input__container" }, this.renderLabel(), index.h("div", { key: '4139d4b54c90b4392cf0f209e700c71d8e6d8639', class: { input__container__wrapper: true } }, index.h("input", { key: '63fd523db04ae2eb59e371aa78ec9378bb378e7c', ref: this.refNativeInput, class: { input__container__text: true }, type: type, name: this.inputName, min: this.min, max: this.max, minLength: this.minlength, maxLength: this.maxlength, readOnly: this.readonly, autocomplete: autocomplete, autocapitalize: this.autoCapitalize, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: this.onBlur, onSubmit: this.onSubmit, value: this.value, disabled: this.disabled, "data-test": this.dataTest }))), index.h("div", { key: 'c176777172cb4eae5b2a3d9c0e391e8aa29f5e2f', class: "input__password--icon", onClick: this.toggleEyePassword, onKeyDown: this.handleKeyDown.bind(this), tabindex: "0" }, index.h("bds-icon", { key: 'b2a83e1dc303e7569ee98ff98c1c49e1afd82fdb', size: "small", name: iconPassword, color: "inherit" })), this.success && index.h("bds-icon", { key: 'a6a734b68c325817bed8c9c09b611412d18988f1', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" })), this.renderMessage()));
    }
