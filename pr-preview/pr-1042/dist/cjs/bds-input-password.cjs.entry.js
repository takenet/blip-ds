...
const InputPassword = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a03ff24aa7813fcc8fc970d41a97d9dc4122c424', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '5cd3eb8fd1fdab9577921c892840da06937ff3a2', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: '849eb62baa90563864c15af25c76f952359fdace', class: "input__container" }, this.renderLabel(), index.h("div", { key: '249342ff88aefc7483b33d3c3b3af9f8c7f6aca7', class: { input__container__wrapper: true } }, index.h("input", { key: '116ea563fb0079f3b24038b21ac842ad9a186a44', ref: this.refNativeInput, class: { input__container__text: true }, type: type, name: this.inputName, min: this.min, max: this.max, minLength: this.minlength, maxLength: this.maxlength, readOnly: this.readonly, autocomplete: autocomplete, autocapitalize: this.autoCapitalize, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: this.onBlur, onSubmit: this.onSubmit, value: this.value, disabled: this.disabled, "data-test": this.dataTest }))), index.h("div", { key: '966e07affeaa69be3429234f2cb84927e70d446a', class: "input__password--icon", onClick: this.toggleEyePassword, onKeyDown: this.handleKeyDown.bind(this), tabindex: "0" }, index.h("bds-icon", { key: '749d8d35b016582ed83a847b4802fa069709d65b', size: "small", name: iconPassword, color: "inherit" })), this.success && index.h("bds-icon", { key: '5c449a1dfdecb881a793b5d98c84c1b12b04bc1a', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" })), this.renderMessage()));
    }
