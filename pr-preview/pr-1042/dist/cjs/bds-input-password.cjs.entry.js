...
const InputPassword = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '86e6d8bc2504ca6d4980ef20043db149e5b7008c', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: 'd4043712fbf1a4064b630454191ce5d6dea2066c', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: '21ed1bd9ecdc13ae5432f2892a24f4abeaa18d56', class: "input__container" }, this.renderLabel(), index.h("div", { key: '4e9c17dee3b4f78cc6ba6d0e4ae1e09c1f7bb736', class: { input__container__wrapper: true } }, index.h("input", { key: 'cc557967dffab6d12c5860ae3ce07e60571e0d56', ref: this.refNativeInput, class: { input__container__text: true }, type: type, name: this.inputName, min: this.min, max: this.max, minLength: this.minlength, maxLength: this.maxlength, readOnly: this.readonly, autocomplete: autocomplete, autocapitalize: this.autoCapitalize, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: this.onBlur, onSubmit: this.onSubmit, value: this.value, disabled: this.disabled, "data-test": this.dataTest }))), index.h("div", { key: '2095621ad7d9547825c0ce7dcb69a5d8d4b9a279', class: "input__password--icon", onClick: this.toggleEyePassword, onKeyDown: this.handleKeyDown.bind(this), tabindex: "0" }, index.h("bds-icon", { key: 'df42d7b77177ff9f55a2f0ea8701344702fcba00', size: "small", name: iconPassword, color: "inherit" })), this.success && index.h("bds-icon", { key: 'bdb980d21517bd7aa8423025fcc5937ce83e36fd', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" })), this.renderMessage()));
    }
