...
const InputPassword = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c1bceea35c2bbc4e465ab931993005a3ea9cff27', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '3c61c81d1205ae6cad74f996ab0108f418048002', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: 'aae9473219a3e1054fd37879a8d7ab39b145da11', class: "input__container" }, this.renderLabel(), index.h("div", { key: '43c87bebf51367caccd1c3beb8891aa61885fe9e', class: { input__container__wrapper: true } }, index.h("input", { key: '97b3cfb92c230b68700c1b5feb5bb2e566e8ca8b', ref: this.refNativeInput, class: { input__container__text: true }, type: type, name: this.inputName, min: this.min, max: this.max, minLength: this.minlength, maxLength: this.maxlength, readOnly: this.readonly, autocomplete: autocomplete, autocapitalize: this.autoCapitalize, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: this.onBlur, onSubmit: this.onSubmit, value: this.value, disabled: this.disabled, "data-test": this.dataTest }))), index.h("div", { key: '4aff1a88a8ceb133315ccefc8d5f9b4fd69dfad5', class: "input__password--icon", onClick: this.toggleEyePassword, onKeyDown: this.handleKeyDown.bind(this), tabindex: "0" }, index.h("bds-icon", { key: 'ee975945c0fe8185a64fe6b7f6ce43b0ec591a5a', size: "small", name: iconPassword, color: "inherit" })), this.success && index.h("bds-icon", { key: 'bbbe5fdadaee87ca301a83c6ca9dc23097d58914', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" })), this.renderMessage()));
    }
