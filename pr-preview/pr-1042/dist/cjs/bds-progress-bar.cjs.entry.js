...
const BdsProgressBar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e9b0c2808b8d5e3e417f228f90cf8b8f88d7f28a' }, index.h("div", { key: 'a22838e950ada1be2ab18c0671bb04dd72c67167', class: { progress_bar: true, [`size_${this.size}`]: true }, "data-test": this.dataTest }, index.h("div", { key: 'fbf4eaf26ccdb84513cf881ddb2ab5ba45068301', class: { bar_behind: true } }, index.h("div", { key: '172fc6bc7c23a90a3b0787e1b1ac84294352c2a5', class: { progress: true, [`color_${this.color}`]: true }, style: styles }))), this.text && (index.h("div", { key: '1b15492bcd477f83e0626f27f8568572564c317d', class: { typo_progress: true } }, index.h("bds-typo", { key: '74abf932552e1c254e9f0f7e78d302b248f2cfbc', variant: "fs-14" }, this.text)))));
    }
};
