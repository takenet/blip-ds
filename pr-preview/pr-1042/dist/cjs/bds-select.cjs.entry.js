...
const Select = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '8c93c59df787cbe4b87d05c4b59a7172f3c49e95', class: "select" }, index.h("div", { key: '44d04eee0507d4bcc405b60ef21e63121908c21f', class: { element_input: true }, "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: 'd28d3313083f0dbe4c166323ddf72ccd92a1f3f5', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: '360e2e7534d41723e4fa2018731aed739ec95203', class: "input__container" }, this.renderLabel(), index.h("div", { key: '497d3924fd6e5b40320cf6c6ad1a5767b9af89df', class: { input__container__wrapper: true } }, index.h("input", { key: '66c6eb5f17a8e31d089c783c8c1a8a0d433591c7', ref: this.refNativeInput, class: { input__container__text: true }, onFocus: this.onFocus, onBlur: this.onBlur, value: this.text, disabled: this.disabled, placeholder: this.placeholder, readonly: true, "data-test": this.dataTest, onKeyDown: this.keyPressWrapper.bind(this) }))), index.h("div", { key: 'e98bfbfd6cd63f8c0859c9fd50ce5c05408f4278', class: "select__icon" }, index.h("bds-icon", { key: 'e792991505d99c9b6ffd0936d81c89bee190ffb5', ref: (el) => this.refIconDrop(el), size: "small", color: "inherit" })), this.success && index.h("bds-icon", { key: '3f979efce75c9ab79a0438d9308a62c1ed214643', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" })), this.renderMessage()), index.h("div", { key: 'da526f224278b95483ad2d9dc76e159051be0805', ref: (el) => this.refDropdown(el), class: {
