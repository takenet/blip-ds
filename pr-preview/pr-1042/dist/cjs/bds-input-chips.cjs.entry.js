...
const InputChips = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '807b12574be0c5989502f07ebb2a5cc45cd4c37c', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: 'f35bf7112a89baf53161c21f4d209b0e65581d61', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: '113a4fa787de55024bf4c655e50e7860cf5460ec', class: "input__container" }, this.renderLabel(), index.h("div", { key: '21a9db931f23bf7962603c40b69aa90cfa1ede6b', class: "input__container__wrapper", style: { maxHeight: defaultMaxHeight } }, this.internalChips.length > 0 && this.renderChips(), this.inputAvalible && (index.h("input", { key: '8c6abf61eda8bc2d9314ca23ee7cef5016abed96', ref: (input) => (this.nativeInput = input), class: "input__container__text", name: this.inputName, maxlength: this.maxlength, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: () => this.handleOnBlur(), onChange: () => this.handleChange, value: this.value, disabled: this.disabled, "data-test": this.dataTest })))), this.counterLength && (index.h("bds-counter-text", { key: 'e9a72c25f9c79d0541b36a4f45bc89e3a9158e04', length: this.internalChips.length, max: this.maxChipsLength, active: isPressed })), this.success && index.h("bds-icon", { key: '64ebef026b4032fdfdfe5975d08be1d846f9a71f', class: "icon-success", name: "checkb", theme: "outline", size: "xxx-small" }), index.h("slot", { key: 'e1d022d409287be5300f8533d3a1edb1aeb709d2', name: "input-right" })), this.renderMessage()));
    }
