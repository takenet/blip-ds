...
const InputChips = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2699f5e35e6d903fe4c86a4cb62dbde5e093299b', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '9afabf64ca5593c205c3acea26174183f36d38cc', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: 'c672e4f459d650335a60e86ff61835d49e56bc05', class: "input__container" }, this.renderLabel(), index.h("div", { key: '2bff80c5759f20366b6b0e1d3ffefb3fefae6446', class: "input__container__wrapper", style: { maxHeight: defaultMaxHeight } }, this.internalChips.length > 0 && this.renderChips(), this.inputAvalible && (index.h("input", { key: '6a50922426e8abffc74e1e732291d1164f2e9baa', ref: (input) => (this.nativeInput = input), class: "input__container__text", name: this.inputName, maxlength: this.maxlength, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: () => this.handleOnBlur(), onChange: () => this.handleChange, value: this.value, disabled: this.disabled, "data-test": this.dataTest })))), this.counterLength && (index.h("bds-counter-text", { key: '350f2ca1c120874a03b8adb4afa42fdb85deb956', length: this.internalChips.length, max: this.maxChipsLength, active: isPressed })), this.success && index.h("bds-icon", { key: 'ff293f70d43755dca4be9d3eeb4cad00cd09b4a2', class: "icon-success", name: "checkb", theme: "outline", size: "xxx-small" }), index.h("slot", { key: '661c949f8fe2a4cea1e95ec9bcac04fbcc20edf9', name: "input-right" })), this.renderMessage()));
    }
