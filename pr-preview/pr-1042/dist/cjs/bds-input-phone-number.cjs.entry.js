...
const InputPhoneNumber = class {
    ...
    render() {
        ...
        const flagsNames = Object.keys(this.countries);
        return (index.h(index.Host, { key: '80af7d9987529ce36a774d0e98f2b83cdaf0729c', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '9b3f9354b1f51112b43ab9a3baeff7f33f44594e', class: { element_input: true }, "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '4b417b77765e29a956dcffb9e0b829746bd5a29e', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: '705940a91e47dee1f08d990712d381066f661a2c', onClick: this.toggle, onKeyDown: this.handleKeyDown.bind(this), "data-test": this.dtSelectFlag, class: "input__icon", tabindex: "0" }, index.h("bds-icon", { key: 'da36734f816abced7257183ad3898a0d8c98a4e8', size: "medium", theme: "solid", name: this.selectedCountry, color: "primary" }), index.h("bds-icon", { key: '51b1c1723bfaeb1324d1c374e5caf1e502d22b27', size: "x-small", name: iconArrow })), index.h("div", { key: '16aa521a223443c00794a65f438fea8f538af10f', class: "input__container" }, this.renderLabel(), index.h("div", { key: '3dae7d5e55c11c1807921a64e55d94a6b8d79b69', class: { input__container__wrapper: true } }, index.h("div", { key: '335654457cf752741af259a5f3c4377fa4f76f5e', class: "input__container__country-code" }, index.h("bds-typo", { key: 'e0f3c23a6afa43772f248a9df5563c232e2cc046', "no-wrap": "true", variant: "fs-14" }, this.value)), index.h("input", { key: '00f1f05dbf98d42739669594b900df9eac8fa27a', class: { input__container__text: true }, type: "phonenumber", required: this.required, pattern: "/^(\\(?\\+?[0-9]*\\)?)?[0-9_\\- \\(\\)]*$/", ref: this.refNativeInput, onInput: this.changedInputValue, onFocus: this.onFocus, onBlur: this.onBlur, value: this.text, disabled: this.disabled, "data-test": this.dataTest, maxlength: this.value === '+55' ? 25 : null }))), this.success && index.h("bds-icon", { key: 'b2fe83800fe3eba2cc03fae488d0b0ae6616f9bc', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" }), index.h("slot", { key: '14331733e14ee3ee687952fa077be5d1063a60a3', name: "input-right" })), this.renderMessage()), index.h("div", { key: '1ecc7f21541376658acfd0ac5ffdb0f0138db818', class: {
