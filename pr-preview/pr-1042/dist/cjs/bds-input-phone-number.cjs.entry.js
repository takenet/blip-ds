...
const InputPhoneNumber = class {
    ...
    render() {
        ...
        const flagsNames = Object.keys(this.countries);
        return (index.h(index.Host, { key: '544475022847584bfd0251606b7055c3c37ed4bf', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '5c9890fdc79f2300efc90e679a652b7db93d0f46', class: { element_input: true }, "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '95c40d8489f5a17058a6ec0d623e6ce9b70097ed', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: 'c6b26a34caa587bf12290703ce9c4f1c2e2c8902', onClick: this.toggle, onKeyDown: this.handleKeyDown.bind(this), "data-test": this.dtSelectFlag, class: "input__icon", tabindex: "0" }, index.h("bds-icon", { key: 'f7d0db71ea096d6e2fb0bc3cae44d688775f4ea4', size: "medium", theme: "solid", name: this.selectedCountry, color: "primary" }), index.h("bds-icon", { key: '717fb5a6c9ddf56e7fb9fe2f3a83c4354e8263ea', size: "x-small", name: iconArrow })), index.h("div", { key: '91211b1e0bb13f43886ebc2d5d0d50033015bdf4', class: "input__container" }, this.renderLabel(), index.h("div", { key: '6106bf6fe58c2793694f7f39ae9bb097c9d75277', class: { input__container__wrapper: true } }, index.h("div", { key: '89b22af55d604c26d36a4342e198217914f8bdd5', class: "input__container__country-code" }, index.h("bds-typo", { key: 'a6966011b48fa9799388ee6c8a96192edb111de5', "no-wrap": "true", variant: "fs-14" }, this.value)), index.h("input", { key: 'cf76d226e790edd48b51ae86ce3a91c3a616eb35', class: { input__container__text: true }, type: "phonenumber", required: this.required, pattern: "/^(\\(?\\+?[0-9]*\\)?)?[0-9_\\- \\(\\)]*$/", ref: this.refNativeInput, onInput: this.changedInputValue, onFocus: this.onFocus, onBlur: this.onBlur, value: this.text, disabled: this.disabled, "data-test": this.dataTest, maxlength: this.value === '+55' ? 25 : null }))), this.success && index.h("bds-icon", { key: '8383ae9fdb2cca9e19ef2f969dc177d2eb8536e2', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" }), index.h("slot", { key: 'aca9d5f821c73d57921952093608d00ea89652f5', name: "input-right" })), this.renderMessage()), index.h("div", { key: 'd4f007c25ccfad5242b530504ca291b23dee5ae5', class: {
