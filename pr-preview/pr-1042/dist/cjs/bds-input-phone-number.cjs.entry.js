...
const InputPhoneNumber = class {
    constructor(hostRef) {
        ...
        this.bdsPhoneNumberChange = index.createEvent(this, "bdsPhoneNumberChange");
    ...
    render() {
        ...
        const flagsNames = Object.keys(this.countries);
        return (index.h(index.Host, { key: '963746172577036c35ed5e180b313dad7ecb278e', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: 'b3be44262f36faa6d2bf6dfb5bba13690ba2113b', class: { element_input: true }, "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '308a3eb1cf86b50ad72ab53bc55293a4f9f16e9d', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: '5f713c3155977ddd0d0d99267eb310f6cc483315', onClick: this.toggle, onKeyDown: this.handleKeyDown.bind(this), "data-test": this.dtSelectFlag, class: "input__icon", tabindex: "0" }, index.h("bds-icon", { key: 'a299eae5785df0b86db311a6759b66964ed93b9d', size: "medium", theme: "solid", name: this.selectedCountry, color: "primary" }), index.h("bds-icon", { key: '4cead31a49bd76786618b27e36768c1833cff7ff', size: "x-small", name: iconArrow })), index.h("div", { key: '0fb9d8295bdc203757a1bc76b96fbcdc54379f85', class: "input__container" }, this.renderLabel(), index.h("div", { key: 'f95cd589904d2858e4c50deed8194a5b8fb77239', class: { input__container__wrapper: true } }, index.h("div", { key: 'a6e106f1c59d0a976f765ab3ab3e897a2b02bad2', class: "input__container__country-code" }, index.h("bds-typo", { key: 'ef7bc811cd15fb406240ebe4a335e2575024e18c', "no-wrap": "true", variant: "fs-14" }, this.value)), index.h("input", { key: '80317b9ca62d1ae341459ef44b09e2eb4ec2b0c1', class: { input__container__text: true }, type: "phonenumber", required: this.required, pattern: "/^(\\(?\\+?[0-9]*\\)?)?[0-9_\\- \\(\\)]*$/", ref: this.refNativeInput, onInput: this.changedInputValue, onFocus: this.onFocus, onBlur: this.onBlur, value: this.text, disabled: this.disabled, "data-test": this.dataTest, maxlength: this.value === '+55' ? 25 : null }))), this.success && index.h("bds-icon", { key: 'c8d3b80350a5879d8f999945b9607ae6bc0f2ab2', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" }), index.h("slot", { key: 'ee189c6b765decd5f76e8d4030be67700e360b0d', name: "input-right" })), this.renderMessage()), index.h("div", { key: '658305c6e219db00f548a744bbe0af9398f48559', class: {
...
//# sourceMappingURL=bds-input-phone-number.entry.cjs.js.map

//# sourceMappingURL=bds-input-phone-number.cjs.entry.js.map