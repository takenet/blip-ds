...
const Pagination = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '827398cd46162dab203a12acaf172a472a69f304', class: { full_width: this.pageCounter } }, index.h("bds-grid", { key: 'd2dfbbfed1dec81c08fe6764c0b7a6f966408755', "justify-content": "space-between" }, this.itemsPerPage && this.itemsPage && (index.h("bds-grid", { key: '5d70db426806bdb660de721d75630496cbaeb103', gap: "1", "align-items": "center", class: "items_per_page" }, index.h("bds-typo", { key: '1d97b8ead46b0c6bb74b772a81ef43e392dc1a11', variant: "fs-14" }, currentLanguage.itemsPerPage, ":"), index.h("bds-select", { key: 'a414451b008a42851aa904490cb20ee601718842', class: "actions_select", value: this.itemValue, "options-position": this.optionsPosition }, (_a = this.itemsPage) === null || _a === void 0 ? void 0 : _a.map((el, index$1) => (index.h("bds-select-option", { key: index$1, value: el, onClick: () => this.itemSelected(el) }, el)))), index.h("bds-typo", { key: '0f352f773dcf8b54c21e886b9f2f4e0d08d03736', variant: "fs-14", "no-wrap": "true" }, this.startItem, "-", this.endItem, " ", currentLanguage.of, " ", this.numberItems))), index.h("bds-grid", { key: '5bc8edd434d5781844ce58c6190000d7fd3dbd18', gap: "1", "align-items": "center", class: "actions" }, index.h("bds-button-icon", { key: 'e060ce147917a37cbaa683e9114851f98fb88961', onBdsClick: (ev) => this.firstPage(ev), size: "short", variant: "secondary", icon: "arrow-first", dataTest: this.dtButtonInitial }), index.h("bds-button-icon", { key: '170ad484c3e35f79640944634a3c79cffe9d50d9', onBdsClick: (ev) => this.previewPage(ev), size: "short", variant: "secondary", icon: "arrow-left", dataTest: this.dtButtonPrev }), index.h("bds-select", { key: '5e3283faed149fddbca73f2f6bdc6b30535d1385', class: "actions_select", value: this.value, "options-position": this.optionsPosition }, this.paginationNumbers.map((el, index$1) => (index.h("bds-select-option", { key: index$1, value: el, onClick: () => this.optionSelected(el) }, el)))), this.pageCounter && (index.h("bds-typo", { key: '4c609b1e5b96aa69624416cfec569d88df690e8f', class: "actions--text", variant: "fs-14", "no-wrap": "true" }, currentLanguage.of, " ", this.pages, " ", currentLanguage.pages)), index.h("bds-button-icon", { key: 'dd633f7150efb7211945a61b98feefd6eb914f25', onBdsClick: (ev) => this.nextPage(ev), size: "short", variant: "secondary", icon: "arrow-right", dataTest: this.dtButtonNext }), index.h("bds-button-icon", { key: '67efef479945f2e29d89b425e45a55b10cb5dc50', onBdsClick: (ev) => this.lastPage(ev), size: "short", variant: "secondary", icon: "arrow-last", dataTest: this.dtButtonEnd })))));
    }
