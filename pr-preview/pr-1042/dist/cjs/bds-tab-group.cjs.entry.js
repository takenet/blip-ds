...
const BdsTabGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c4b6f3a649c24d0eccdf10f0a7d8af8419c2d48d' }, index.h("div", { key: 'e72cdbb7df4d4ae377d553dbf0c549c73c52faf2', class: { tab_group: true } }, this.isSlideTabs && this.alignTab != 'left' && (index.h("bds-button-icon", { key: 'b88724ed9f7cc91e64f94f6f145076f7fccfa553', class: "tab_group__slide-button", icon: "arrow-left", size: "short", id: "bds-tabs-button-left", onClick: () => this.prevSlide(), dataTest: this.dtButtonPrev, variant: "secondary" })), index.h("div", { key: '395807e693e03d6c7b003ec108b494f8a005265c', class: { tab_group__header: true, tab_group__slide: this.isSlideTabs }, ref: this.refHeaderElement, style: headerStyle }, index.h("div", { key: '4884525a61c80a22470434e247676d7b0a7175ed', class: {
            ...
            this.internalItens.map((item, index$1) => {
                ...
                return (index.h("div", { class: {
                    ...
                    ? this.renderBadge(item.badgeShape, item.badgeColor, item.badgeIcon, item.badgeAnimation, item.badgeNumber)
                    : ''));
            }))), this.isSlideTabs && this.alignTab != 'right' && (index.h("bds-button-icon", { key: 'ac8a1316476a0174942238157adaf317688a1669', class: "tab_group__slide-button", icon: "arrow-right", size: "short", id: "bds-tabs-button-right", onClick: () => this.nextSlide(), dataTest: this.dtButtonNext, variant: "secondary" })), index.h("div", { key: '01c37895f8995104ae554d749ace98e71ff78049', class: { tab_group__content: true, tab_group__scrolled: this.contentScrollable }, style: contentStyle }, index.h("slot", { key: '34cecbc4dddf5d9d0da144ee5e442030f4efe8b7' })))));
    }
