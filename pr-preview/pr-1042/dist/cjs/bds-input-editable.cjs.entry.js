...
const InputEditable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ee0c0456fa1715f2d4b61d3329b1f351f3c95f86' }, index.h("div", { key: '193a0f9dc8a4f535c799ad4874e174a1b43035f8', class: "input__editable" }, index.h("div", { key: 'b96655fd30e44ce1959a5e46e636278785168851', class: { 'input__editable--static': true, 'input__editable--hidden': this.isEditing }, onClick: this.handleEditing, "data-test": this.dtButtonEdit, tabindex: "0", onKeyDown: this.handleKeyDownToggle.bind(this) }, index.h("bds-typo", { key: 'b7c0cf45a277f1f152ef38cad053a351bfbb0675', tag: "span", part: "input__editable--static__typo", class: "input__editable--static__typo", variant: variant }, this.value), index.h("bds-icon", { key: "edit-icon", class: "input__editable--static__icon", name: "edit" })), index.h("div", { key: '1f11372a0a37d5ffed32d644a0994c0a1bc891d9', class: { 'input__editable--active': true, 'input__editable--hidden': !this.isEditing } }, index.h("div", { key: '915ae52a024940dcb2fc4058ae2b3e07fd901c5e', class: { element_input: true, [inputExpand]: true, [this.size]: true } }, index.h("div", { key: '404ef8c252cfff4868f37f12676d144a6973a01f', class: {
                input: true,
                select: true,
            ...
            }, onClick: this.onClickWrapper }, index.h("div", { key: '0424efc6513f021b38958548c286b925f21b1054', class: "input__container" }, index.h("input", { key: '4bd47f6af12d5f0c37c195120e44e00f7f360a35', class: { input__container__text: true }, ref: (input) => (this.nativeInput = input), minLength: this.minlength, maxLength: this.maxlength, name: this.inputName, onBlur: this.onBlur, onFocus: this.onFocus, onInput: this.changedInputValue, placeholder: this.placeholder, value: this.value, required: true, part: "input", "data-test": this.dataTest })), this.success && index.h("bds-icon", { key: '9841fbc8016ccac973de3858259daf9d08b46412', class: "icon-success", name: "checkball", theme: "solid", size: "xxx-small" })), this.renderMessage()), index.h("div", { key: '3e9924f019ed6167cf759ae2bd55fe1de924a2d7', class: "input__editable--active__icon" }, index.h("bds-icon", { key: "error-icon", class: "input__editable--active__icon--error", theme: "solid", name: "error", onClick: this.handleEditing, tabindex: "0", onKeyDown: this.handleKeyDownToggle.bind(this), dataTest: this.dtButtonClose }), index.h("bds-icon", { key: "checkball-icon", class: {
