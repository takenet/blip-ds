...
const BdsModal = class {
    ...
    render() {
        return (index.h("div", { key: '5286987be5894c0a6d49db43a0910ab159018e5b', class: {
                modal__dialog: true,
                'modal__dialog--open': this.open,
                [`modal__dialog--${this.size}`]: true,
            } }, index.h("div", { key: '1575f3fd0af42afb525bb319593e4a14afd9f110', class: { outzone: true }, onClick: () => this.onClickOutzone(), "data-test": this.dtOutzone }), index.h("div", { key: 'fb160c09847c2d67f24a4efd6f63b67375e9be33', class: { modal: true, [`modal--${this.size}`]: true } }, this.closeButton && (index.h("bds-icon", { key: '4047270d91f508adf60e44cb8781655ae5ac64ad', size: "medium", class: "close-button", name: "close", tabindex: "0", onClick: this.handleMouseClick, dataTest: this.dtButtonClose })), this.size == 'fixed' && index.h("slot", { key: 'f854a59699e9b21ef8f0ffd17c78423ac9efa440' }), this.size !== 'fixed' && (index.h("div", { key: '75693debcc26db92d4ddd971f438eca08aec0481', class: { slot: true, [`slot--${this.size}`]: true } }, index.h("slot", { key: 'de58a6db36fbeb8efcabec578030029d38b3d3fe' }))))));
    }
