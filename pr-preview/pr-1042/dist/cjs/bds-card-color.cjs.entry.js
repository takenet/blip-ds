...
const CardColor = class {
    ...
    render() {
        return (index.h("bds-paper", { key: 'edf1c070c006dbc7179074645c3b3c5e005519f1', class: "card", width: "240px", height: "140px", onClick: () => this.handleCopyVariable(this.variable) }, index.h("bds-grid", { key: 'eae3f63402cd1e571a2f33133fd24a834622b87b', direction: "column", height: "100%" }, index.h("bds-grid", { key: '44095d7b1c8e152212fd77861a4b0421b0bb8d1f', height: "70%", xxs: "12", class: {
                'card-color--color': true,
                [`card-color--${this.variable}`]: true,
            } }), index.h("bds-grid", { key: '0449b9a586dd5f8e2d3b5e672e1a564dab8a9d13', "justify-content": "center", "align-items": "center", height: "30%" }, !this.showMessage ? (index.h("bds-typo", { class: "card-text", variant: "fs-14", bold: "bold" }, "$", this.variable)) : (index.h("bds-typo", { class: "card-text-copie", variant: "fs-14", bold: "bold" }, "Cor copiada!"))))));
    }
};
