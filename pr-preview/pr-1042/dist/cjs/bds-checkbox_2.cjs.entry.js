...
const Checkbox = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '3e2634c267a2e622e34a15bdcf023db081384115', class: {
                checkbox: true,
                [styleState]: true,
            } }, index.h("input", { key: '6227ef611ba1b5f8d8c635365b1876d934faf025', type: "checkbox", ref: this.refNativeInput, id: this.checkBoxId, name: this.name, onClick: (ev) => this.onClick(ev), checked: this.checked, disabled: this.disabled, "data-test": this.dataTest }), index.h("label", { key: 'ac1b5f063f28d5da87436bb634fb27c8be02b182', class: "checkbox__label", htmlFor: this.checkBoxId }, index.h("div", { key: '5e0478de84303efb93c89d8226533a9fe44c5e58', class: "checkbox__icon", tabindex: "0", onKeyDown: this.handleKeyDown.bind(this) }, index.h("bds-icon", { key: 'd1392bf0eb54aa52178c1008d9970d64f94a0620', class: "checkbox__icon__svg", size: "x-small", name: "true", color: "inherit" })), this.label && (index.h("bds-typo", { key: '65590ee0f46a53272848e6fbf7f6b7963c37994b', class: "checkbox__text", variant: "fs-14", tag: "span" }, this.label)))));
    }
};
...
const SelectOption = class {
    ...
    render() {
        return (index.h("div", { key: 'a527e3975ec9feaaca70d2c1996e83c960100f46', id: `bds-select-option-${this.value}`, "data-event": "click", role: "button", onKeyDown: this.attachOptionKeyboardListeners, onClick: this.onClickSelectOption, "data-value": this.value, "data-test": this.dataTest, class: {
            ...
            } }, index.h("div", { key: 'be6c5636c6854c85f782bdd60680dd9bcef6041c', style: { alignSelf: this.slotAlign } }, index.h("slot", { key: 'c2d183da7faa8cfe72bf48fe29ded440a41aa3f7', name: "input-left" })), index.h("div", { key: '696406c237b93f5f8be4c1c8d9190eb6b6919b94', class: {
            ...
            }, onClick: () => this.checkedCurrent() }, this.titleText && (index.h("bds-typo", { key: '561e2a2e2f88ae14bd507d5bb9f91cc2d3aad82a', class: "select-option__container--value", variant: "fs-16", bold: "semi-bold" }, this.titleText)), this.typeOption === 'checkbox' ? (index.h("bds-checkbox", { ref: this.refNativeInput, refer: `html-for-${this.value}`, label: this.element.innerHTML, name: this.value, checked: this.checked, onBdsChange: (ev) => this.optionHandle(ev) })) : (index.h("bds-typo", { class: {
                'select-option__container--value': true,
                'select-option__container__overflow': !!this.status,
            }, noWrap: !!this.status, variant: "fs-14" }, index.h("slot", null)))), this.bulkOption && (index.h("bds-typo", { key: '69065bb4ebd2823994287803939d71d8ac6bc15e', class: "select-option__container--bulk", variant: "fs-10" }, this.bulkOption)), this.status && (index.h("bds-typo", { key: 'c28981c29e8ae881a90f05d8eb20756f5137df7a', class: "select-option__container--status", noWrap: true, variant: "fs-10" }, this.status))));
    }
