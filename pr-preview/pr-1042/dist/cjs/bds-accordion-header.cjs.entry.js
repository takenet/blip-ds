...
const AccordionHeader = class {
    ...
    render() {
        return (index.h("div", { key: 'aa23339d986d7c2f05630ffc59ae2e4fd07704fd', onClick: this.toggleHeader, class: { accordion_header: true }, "data-test": this.dataTest }, this.avatarName || this.avatarThumb ? (index.h("bds-avatar", { name: this.avatarName, thumbnail: this.avatarThumb, size: "extra-small" })) : (this.icon && index.h("bds-icon", { size: "x-large", name: this.icon, color: "inherit" })), this.accordionTitle && (index.h("bds-typo", { key: '44b7f3065cd79a1f267e2957bad75a552cab81ba', bold: "bold", variant: "fs-16", "line-height": "double" }, this.accordionTitle)), index.h("slot", { key: '0802c33c0da12a80096ce5e15f41bffac90bbde3' }), index.h("bds-icon", { key: '86c9c143ec585c6e825a039470d7efd8c5b8f00e', class: {
                accButton: true,
