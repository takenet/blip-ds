...
const Sidebar = class {
    ...
    render() {
        return (index.h("div", { key: 'e6deb15e0767aca5765da85253edb25275a3345c', class: {
                sidebar_dialog: true,
                is_open: this.isOpen,
                [`type_${this.type}`]: true,
            } }, this.type === 'over' ? (index.h("div", { class: { outzone: true }, onClick: () => this.onClickCloseButtom(), "data-test": this.dtOutzone })) : (''), index.h("div", { key: '628e26bb30098a3cf687f449a9e7154d275c8aa6', class: {
                sidebar: true,
                is_open: this.isOpen,
                [`type_${this.type}`]: true,
                [`position_${this.sidebarPosition}`]: true,
                [`background_${this.background}`]: true,
            }, style: { width: `${this.width < 144 ? 144 : this.width}px` } }, this.hasHeaderSlot && (index.h("div", { key: '2e0940cfb93436bfa7ea68f26b2c3c4fc17d338a', class: { header: true } }, index.h("div", { key: '9441898c76d539b0dd037d7f0ddc09a9b97006c0', class: { content: true } }, index.h("slot", { key: '36e6cf1412a711238fb043eda74069a0df5e7ca6', name: "header" })), this.type === 'fixed' ? ('') : (index.h("bds-button-icon", { class: {
                closeButton: true,
            }, icon: "close", size: "short", variant: "secondary", onClick: () => this.onClickCloseButtom(), dataTest: this.dtButtonClose })))), index.h("div", { key: '7b6a4dcb5b5201333150c026424ac466b28b55ae', class: { body: true } }, index.h("div", { key: 'a0d820911e08ee57b6630883314126af7cfa686a', class: { content: true, element_scrolled: true, margin: this.margin } }, index.h("slot", { key: '2bf6b69461b9a15144eb3a71c8a0481a9bf7c0b8', name: "body" }))), this.hasFooterSlot && (index.h("div", { key: '44322eb7b9454fcc463361c186f54472e8b77963', class: { footer: true } }, index.h("div", { key: '9926981535f59752e9451a26fe30bc6ba8c9f67d', class: { content: true } }, index.h("slot", { key: '89db67b27e4a305793d3b5b05c0486715da82cfe', name: "footer" })))))));
    }
