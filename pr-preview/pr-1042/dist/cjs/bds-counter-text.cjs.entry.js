...
const CounterText = class {
    ...
    render() {
        ...
        const actualLength = this.getActualLength();
        return (index.h("div", { key: '0c0a7d72486b8e738b8a949c53fef0a82213fa77', class: {
                'counter-text': true,
                'counter-text--active': this.active,
                [`counter-text--${state}`]: true,
            } }, index.h("bds-typo", { key: 'd0f91f1733aea8e3b914c1b2617c43a382afe55c', variant: "fs-10" }, actualLength)));
    }
};
