...
const BdsCarousel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '3fef27f621f5e29c96b712a640cde809bb64871b', class: { carousel: true } }, index.h("div", { key: 'ca8b92158e455f540a15d88b9f5c1011905577dc', class: {
                carousel_slide: true,
                carousel_slide_fullwidth: this.arrows != 'outside',
                [`carousel_slide_state_${this.autoplayState}`]: this.autoplay,
            }, tabindex: "0", onKeyDown: (ev) => this.setKeydownNavigation(ev), "data-test": this.dtSlideContent }, index.h("div", { key: '2728df7b11e32216669f6673bb802fa9ec45ca4f', ref: (el) => this.refFrame(el), class: { carousel_slide_frame: true, carousel_slide_frame_loading: this.loading }, onMouseOver: () => this.onMouseOver(), onMouseOut: () => this.onMouseOut(), onMouseDown: (ev) => this.onMouseDown(ev), onMouseEnter: () => this.onMouseEnter(), onMouseUp: () => this.onMouseUp(), onMouseMove: (ev) => this.onMouseMove(ev) }, index.h("div", { key: '50deeb720de3ecef867a5c547c30c9e77f041076', ref: (el) => this.refFrameRepeater(el), class: { carousel_slide_frame_repeater: true } }, index.h("slot", { key: '5648ef6d97bd9397bea40ecdc2339e3a4fab2a19' }))), index.h("bds-grid", { key: 'b6fa556f8ff9058af027f53b04b00ccce4c3f3e9', class: { carousel_slide_loading: true, carousel_slide_loading_visible: this.loading } }, index.h("bds-skeleton", { key: 'b0811b187a6634df8e91f47f84141b6cb03fd786', height: "100%", shape: "square", width: "100%" })), this.arrows != 'none' && !this.loading && (index.h(ThemeOrDivArrows, { key: 'ebb89ba46b089601e474ed6c791c87a9289e4e0f', ref: (el) => this.refThemeProviderArrows(el), class: {
                carousel_buttons: true,
                carousel_buttons_fullwidth: this.arrows != 'outside',
            } }, index.h("bds-button", { key: 'f8b48068aa8bc7a79ae440844a89058548ee04bf', variant: "text", iconLeft: "arrow-left", color: "content", onBdsClick: () => this.prevSlide(), disabled: !this.infiniteLoop && this.itemActivated <= 1, dataTest: this.dtButtonPrev }), index.h("bds-button", { key: '88484956a768e802d83afd2763db880a701a8446', variant: "text", iconLeft: "arrow-right", color: "content", onBdsClick: () => this.nextSlide(), disabled: !this.infiniteLoop && this.itemActivated >= this.internalItens.length, dataTest: this.dtButtonNext })))), this.internalItens.length > 1 && this.bullets != 'none' && (index.h("div", { key: 'ac6773fe2063f449a2b0b515a0de79c60a83766f', class: {
            ...
            } }))))))))))), index.h("slot", { key: '9d595528598ac97a0fca9ff8a5e9b4aef8bd20f4', name: "after" })));
    }
