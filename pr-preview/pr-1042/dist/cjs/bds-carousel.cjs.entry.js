...
const BdsCarousel = class {
    constructor(hostRef) {
        ...
        this.bdsChangeCarousel = index.createEvent(this, "bdsChangeCarousel");
    ...
    render() {
        ...
        return (index.h("div", { key: 'aa7aebd1a8d211ab7c482337b1363dafe5e23d01', class: { carousel: true } }, index.h("div", { key: '31a7d3f060d37f7241ff378dfc682d2c4d891ee5', class: {
                carousel_slide: true,
                carousel_slide_fullwidth: this.arrows != 'outside',
                [`carousel_slide_state_${this.autoplayState}`]: this.autoplay,
            }, tabindex: "0", onKeyDown: (ev) => this.setKeydownNavigation(ev), "data-test": this.dtSlideContent }, index.h("div", { key: '5a590d1d40035790ad135954974a8977cdad30b1', ref: (el) => this.refFrame(el), class: { carousel_slide_frame: true, carousel_slide_frame_loading: this.loading }, onMouseOver: () => this.onMouseOver(), onMouseOut: () => this.onMouseOut(), onMouseDown: (ev) => this.onMouseDown(ev), onMouseEnter: () => this.onMouseEnter(), onMouseUp: () => this.onMouseUp(), onMouseMove: (ev) => this.onMouseMove(ev) }, index.h("div", { key: '1478791fb1cdafab371e74d6fc7a8294260955ed', ref: (el) => this.refFrameRepeater(el), class: { carousel_slide_frame_repeater: true } }, index.h("slot", { key: '678c0af549a9171cb7c17db113026dee11c18093' }))), index.h("bds-grid", { key: '2fc13711f365a81f963958f3b5e16a9429967e13', class: { carousel_slide_loading: true, carousel_slide_loading_visible: this.loading } }, index.h("bds-skeleton", { key: 'bb484c25c5a651edd9cb9a41771c46837c13bdc8', height: "100%", shape: "square", width: "100%" })), this.arrows != 'none' && !this.loading && (index.h(ThemeOrDivArrows, { key: '163ea8a0fd5115c988f66532a01cedcf954e6803', ref: (el) => this.refThemeProviderArrows(el), class: {
                carousel_buttons: true,
                carousel_buttons_fullwidth: this.arrows != 'outside',
            } }, index.h("bds-button", { key: '0ec0b57300c808f40e3f378d80474ec38bead9fd', variant: "text", iconLeft: "arrow-left", color: "content", onBdsClick: () => this.prevSlide(), disabled: !this.infiniteLoop && this.itemActivated <= 1, dataTest: this.dtButtonPrev }), index.h("bds-button", { key: '653394988180d1c0a1b8ea2b8d28abdac0fa2676', variant: "text", iconLeft: "arrow-right", color: "content", onBdsClick: () => this.nextSlide(), disabled: !this.infiniteLoop && this.itemActivated >= this.internalItens.length, dataTest: this.dtButtonNext })))), this.internalItens.length > 1 && this.bullets != 'none' && (index.h("div", { key: 'ead3dbd4e1c431bb7259dce22f5acbb224603b55', class: {
                carousel_bullets: true,
                carousel_bullets_inside: this.bullets == 'inside',
            } }, this.loading && this.bullets != 'inside' ? (index.h("bds-grid", { xxs: "12", gap: "1", "justify-content": justifybulletsPosition, padding: this.arrows === 'outside' ? 'x-7' : 'none' }, index.h("bds-skeleton", { height: "16px", width: "16px", shape: "circle" }), index.h("bds-skeleton", { height: "16px", width: "16px", shape: "circle" }), index.h("bds-skeleton", { height: "16px", width: "16px", shape: "circle" }))) : (this.internalItens && (index.h("bds-grid", { xxs: "12", "justify-content": justifybulletsPosition, padding: this.arrows === 'outside' ? 'x-7' : 'none' }, index.h("div", { class: {
                carousel_bullets_card: true,
                carousel_bullets_card_inside: this.bullets == 'inside',
            } }, this.internalItens.map((item, index$1) => (index.h("div", { key: index$1, ref: (el) => this.refBulletElement(el), class: {
                carousel_bullets_item: true,
                carousel_bullets_item_active: item.id == this.itemActivated,
            }, tabindex: "0", onClick: () => this.setActivated(item.id) }, item.id < this.itemActivated && this.autoplay && (index.h("div", { class: { carousel_bullets_item_conclude: true } })), item.id == this.itemActivated && this.autoplay && (index.h("div", { class: { carousel_bullets_item_loader: true }, style: {
                animationDuration: `${this.autoplayTimeout / 1000 - 0.1}s`,
                animationPlayState: this.autoplayState,
            } }))))))))))), index.h("slot", { key: '53f9b8dc67817f99e57bfb72a5d210b93668df24', name: "after" })));
    }
...
//# sourceMappingURL=bds-carousel.entry.cjs.js.map

//# sourceMappingURL=bds-carousel.cjs.entry.js.map