...
const BdsToast = class {
    ...
    render() {
        return (index.h("div", { key: '40f70e2e1e181872ae7327d7fa729473e14cf0e8', class: {
                toast: true,
                [`toast--${this.variant}`]: true,
                [`toast--action--${this.actionType}`]: true,
                [`show show--${this.position}`]: this.show,
                hide: this.hide,
            } }, this.variant === 'notification' && (index.h("bds-icon", { key: '5cc57a3ed32400234d0742882e397a7b2c17d4b1', class: "toast__ballon", theme: "solid", name: "blip-chat", size: "brand" })), this.icon && index.h("bds-icon", { key: '4da81b82315a98da4cdf2d45f4876e50d8bd25dd', class: "toast__icon", theme: "outline", size: "medium", name: this.icon }), index.h("div", { key: '0ffab286d428e5aba62d28dff4568ee461897ff0', class: "toast__content" }, this.toastTitle && (index.h("bds-typo", { key: '342066efc43702381a033b7381ced50c120ffc65', variant: "fs-14", bold: "bold" }, this.toastTitle)), this.toastText && index.h("bds-typo", { key: '7aa59ccd9943d75d61849113c6b4eadab2ff19bc', variant: "fs-14", innerHTML: this.toastText })), index.h("div", { key: '112d873b4345298aae496c60935d488213c93336', class: {
                toast__action: true,
