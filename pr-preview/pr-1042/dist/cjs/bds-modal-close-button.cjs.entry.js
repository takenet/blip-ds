...
const BdsModalCloseButton = class {
    ...
    render() {
        return (index.h("div", { key: '787d12b9c7fe37249144a558a0b72fccc3ba90e7', class: {
                'modal__close__button-icon': true,
                'modal__close__button-icon--active': this.active,
            } }, index.h("bds-icon", { key: 'd3707e3e958da0a510d5fbb31f66f104b84d9704', size: "medium", name: "close" })));
    }
};
