...
const NavTree = class {
    ...
    render() {
        return (index.h(index.Host, { key: '131f28785312becf0e5e693935f8cbb68e8ad9b2' }, index.h("div", { key: '71f1ef136f29462d6daf43c009673a259c8b0cec', tabindex: "0", onKeyDown: this.handleKeyDown.bind(this), class: "focus" }, index.h("div", { key: '224e1f9dbb02f9c89467417f8f6a9d7fe39fc8dc', class: {
                [`nav_main--disable`]: this.disable,
            } }, index.h("div", { key: '3f0fb5dac9d885748f443186b11008e73b221518', onClick: this.handler, class: {
                nav_main: true,
            ...
            }, size: "medium", name: this.icon, color: "inherit", theme: "outline" })) : (''), index.h("div", { key: '92ee11d1514410972eec66d2dfb8b63a5897204e', class: "nav_main_text" }, this.text && (index.h("bds-typo", { key: '75a701317bed9329cbef47a6497a6a65b69754f0', class: { ['title-item']: true, [`title-item--loading`]: this.loading }, variant: "fs-14", tag: "span", "line-height": "small", bold: this.isOpen ? 'bold' : 'semi-bold' }, this.text)), this.secondaryText && (index.h("bds-typo", { key: 'e702fefc0de3d917ff3497ac244a83d84f8d92cd', class: { ['subtitle-item']: true, [`subtitle-item--loading`]: this.loading }, variant: "fs-12", "line-height": "small", tag: "span", margin: false }, this.secondaryText))), index.h("div", { key: '926452b52200ce7eb3f7433fb13f0b66538cfe0b', class: "nav_main_content" }, index.h("slot", { key: 'c3ef5a3d627257ce887159640645393f4142fb81', name: "header-content" })), this.navTreeChild && (index.h("bds-icon", { key: 'e14c12c16d6297bd9deb11e9111a3e41779699fe', name: "arrow-down", class: {
                [`nav_main_arrow`]: true,
                [`nav_main_arrow_active`]: this.isOpen,
                [`nav_main_arrow--loading`]: this.loading,
            } }))))), index.h("div", { key: 'd007ce664cdf5235cfcd0ea39528685fd29824a1', class: {
                accordion: true,
                accordion_open: this.isOpen && this.navTreeChild,
            } }, index.h("div", { key: 'c348e18155fe5c5f3af12578a92c24e807731aa0', class: { ['container']: true, [`container--disable`]: this.disable } }, index.h("slot", { key: '22fb2d8ce369426a90631bb87e13e7706db3ca08' })))));
    }
