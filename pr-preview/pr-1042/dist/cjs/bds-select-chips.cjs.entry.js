...
const SelectChips = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '6215b374a5b32c5b868ad855f812443fd49b9a19', class: "select", tabindex: "0", onFocus: this.setFocusWrapper, onBlur: this.removeFocusWrapper }, index.h("div", { key: '30a8bb1eb2166386a32685ee7dc36b20b385a1d4', class: { element_input: true }, "aria-disabled": this.disabled ? 'true' : null, onClick: this.toggle }, index.h("div", { key: 'dc411d39d50d175988e3e7b29efc2b0aeef0806e', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper }, this.renderIcon(), index.h("div", { key: 'db58d1df7f1ca5ee70ced7eea983fd39bc5c7df4', class: "input__container" }, this.renderLabel(), index.h("div", { key: '13bd58d94203fe860f8cb107c0274a1f717eeff8', class: { input__container__wrapper: true } }, this.internalChips.length > 0 && (index.h("span", { key: '593e7cf88988dcdbf56b2395e65689d89c556b23', style: { height: this.height, maxHeight: this.maxHeight }, class: "inside-input-left" }, this.renderChips())), index.h("input", { key: 'e6d5c71d2489310c4352b1e02f8280ebcc80e187', ref: (input) => (this.nativeInput = input), class: { input__container__text: true }, name: this.inputName, maxlength: this.maxlength, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: () => this.handleOnBlur(), onChange: () => this.handleChange, value: this.value, disabled: this.disabled, "data-test": this.dataTest, onKeyDown: this.keyPressWrapper }))), index.h("div", { key: '08a3a0cd7f09f04b6f969dd1dfffe60b41d5ae03', class: "select__icon" }, index.h("bds-icon", { key: '157933ffaaf7682052335759111daebb098fae44', ref: (el) => this.refIconDrop(el), size: "small", color: "inherit" })), this.success && index.h("bds-icon", { key: '53507dd50b52056fd7cee0d53bed3e93bf04bda9', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" })), this.renderMessage()), index.h("div", { key: '029722625ccdaeb3be74932170e9b7ef033a59f4', ref: (el) => this.refDropdown(el), class: {
                select__options: true,
                'select__options--open': this.isOpen,
            } }, internalOptions.map((option) => (index.h("bds-select-option", { key: this.generateKey(option.value), onOptionSelected: this.handler, value: option.value, status: option.status }, option.label))), index.h("slot", { key: 'f8c7dc9fb27ceb9a0df9f5ad76f0e729d5f582cd' }), this.canAddNew === true && this.enableCreateOption() && (index.h("bds-select-option", { key: 'bec1ed521e6699992bb49ac8993975c71b86dfb4', id: "option-add", value: "add", onClick: () => this.handlerNewOption(this.nativeInput.value) }, this.newPrefix, this.nativeInput.value)), !this.canAddNew && this.enableCreateOption() && (index.h("bds-select-option", { key: '178ab081cdd734ee2951056455f4521f2c87e4e8', id: "no-option", value: "add" }, this.notFoundMessage)))));
    }
