...
const SelectChips = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '771bdae86d7ad715d882d15686b8d6e845e77855', class: "select", tabindex: "0", onFocus: this.setFocusWrapper, onBlur: this.removeFocusWrapper }, index.h("div", { key: '63b0b208a729c7fff16d578776fedd6afa89e3c0', class: { element_input: true }, "aria-disabled": this.disabled ? 'true' : null, onClick: this.toggle }, index.h("div", { key: '2faf389a9bf7b82f45d585c85d5ec24cc2be40ba', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper }, this.renderIcon(), index.h("div", { key: 'e316f6dfc1f0c3481ff145de352e2e4cd2e31394', class: "input__container" }, this.renderLabel(), index.h("div", { key: 'f6d25d13276d9798f25a365949dd4dcfeca6826b', class: { input__container__wrapper: true } }, this.internalChips.length > 0 && (index.h("span", { key: 'a79fba696a5ba00c5ac1c1e673de08896e2a57b3', style: { height: this.height, maxHeight: this.maxHeight }, class: "inside-input-left" }, this.renderChips())), index.h("input", { key: '624ef45abd77dc87257d04e5000d4f4926963f14', ref: (input) => (this.nativeInput = input), class: { input__container__text: true }, name: this.inputName, maxlength: this.maxlength, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: () => this.handleOnBlur(), onChange: () => this.handleChange, value: this.value, disabled: this.disabled, "data-test": this.dataTest, onKeyDown: this.keyPressWrapper }))), index.h("div", { key: '16d1a7119ae5fee2876a3d2400d79dd907a751dc', class: "select__icon" }, index.h("bds-icon", { key: '5a93c463037473e44237a9c4674a975c6b092529', ref: (el) => this.refIconDrop(el), size: "small", color: "inherit" })), this.success && index.h("bds-icon", { key: '56e353e835c6c60c931fdb946b543d56a24c3513', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" })), this.renderMessage()), index.h("div", { key: '8e105cff5fba19771e4f3b4389400a8944cea5ba', ref: (el) => this.refDropdown(el), class: {
                select__options: true,
                'select__options--open': this.isOpen,
            } }, internalOptions.map((option) => (index.h("bds-select-option", { key: this.generateKey(option.value), onOptionSelected: this.handler, value: option.value, status: option.status }, option.label))), index.h("slot", { key: '1ad71b2155f6d08f4f7e939d0d0f54aa79f5489e' }), this.canAddNew === true && this.enableCreateOption() && (index.h("bds-select-option", { key: '82f5eb610b42040a9df74a932432d44d47ce0e0f', id: "option-add", value: "add", onClick: () => this.handlerNewOption(this.nativeInput.value) }, this.newPrefix, this.nativeInput.value)), !this.canAddNew && this.enableCreateOption() && (index.h("bds-select-option", { key: '8717a46e3121f6fb27419fb90578090e643c002a', id: "no-option", value: "add" }, this.notFoundMessage)))));
    }
