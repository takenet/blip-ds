...
const SelectOption = class {
    ...
    render() {
        return (h("div", { key: 'a527e3975ec9feaaca70d2c1996e83c960100f46', id: `bds-select-option-${this.value}`, "data-event": "click", role: "button", onKeyDown: this.attachOptionKeyboardListeners, onClick: this.onClickSelectOption, "data-value": this.value, "data-test": this.dataTest, class: {
            ...
            } }, h("div", { key: 'be6c5636c6854c85f782bdd60680dd9bcef6041c', style: { alignSelf: this.slotAlign } }, h("slot", { key: 'c2d183da7faa8cfe72bf48fe29ded440a41aa3f7', name: "input-left" })), h("div", { key: '696406c237b93f5f8be4c1c8d9190eb6b6919b94', class: {
            ...
            }, onClick: () => this.checkedCurrent() }, this.titleText && (h("bds-typo", { key: '561e2a2e2f88ae14bd507d5bb9f91cc2d3aad82a', class: "select-option__container--value", variant: "fs-16", bold: "semi-bold" }, this.titleText)), this.typeOption === 'checkbox' ? (h("bds-checkbox", { ref: this.refNativeInput, refer: `html-for-${this.value}`, label: this.element.innerHTML, name: this.value, checked: this.checked, onBdsChange: (ev) => this.optionHandle(ev) })) : (h("bds-typo", { class: {
                'select-option__container--value': true,
                'select-option__container__overflow': !!this.status,
            }, noWrap: !!this.status, variant: "fs-14" }, h("slot", null)))), this.bulkOption && (h("bds-typo", { key: '69065bb4ebd2823994287803939d71d8ac6bc15e', class: "select-option__container--bulk", variant: "fs-10" }, this.bulkOption)), this.status && (h("bds-typo", { key: 'c28981c29e8ae881a90f05d8eb20756f5137df7a', class: "select-option__container--status", noWrap: true, variant: "fs-10" }, this.status))));
    }
...
//# sourceMappingURL=bds-checkbox.bds-select-option.entry.js.map

//# sourceMappingURL=bds-checkbox_2.entry.js.map