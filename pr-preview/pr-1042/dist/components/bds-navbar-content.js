...
const NavbarContent = /*@__PURE__*/ proxyCustomElement(class NavbarContent extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
}, [1, "bds-navbar-content"]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["bds-navbar-content"];
    components.forEach(tagName => { switch (tagName) {
        case "bds-navbar-content":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NavbarContent);
            }
            break;
    } });
}

const BdsNavbarContent = NavbarContent;
const defineCustomElement = defineCustomElement$1;

export { BdsNavbarContent, defineCustomElement };
//# sourceMappingURL=bds-navbar-content.js.map
