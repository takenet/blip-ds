...
import { d as defineCustomElement$3 } from './p-DWiWA_5T.js';
...
const Input = /*@__PURE__*/ proxyCustomElement(class Input extends H {
    ...
    render() {
        ...
        return (h(Host, { key: '8a9e0b7a19652cb003a4afd0fa0bcdc4f8aaab96', "aria-disabled": this.disabled ? 'true' : null }, h("div", { key: 'f815cba52d389466413ca7e537cb81bbfb0906b9', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), h("slot", { key: 'f0a09c12cae2663638831aac8a2f8e050fea6999', name: "input-left" }), h("div", { key: '6f411d20274d4adecd91c8c635aebd9e1b1402d1', class: "input__container" }, this.renderLabel(), h("div", { key: '8b73fb0e61f034d304afa08890f6eca50b6c611d', class: { input__container__wrapper: !this.chips, input__container__wrapper__chips: this.chips } }, h("slot", { key: 'f815e13577228e892732d0522e0fda25937c61f0', name: "inside-input-left" }), h(Element, { key: '903e8dbe47c0788e6d04ad4ab056e2f75b591a94', class: { input__container__text: true, input__container__text__chips: this.chips }, ref: (input) => (this.nativeInput = input), rows: this.rows, cols: this.cols, autocapitalize: this.autoCapitalize, autocomplete: this.autoComplete, disabled: this.disabled, min: this.min, max: this.max, minLength: this.minlength, maxLength: this.maxlength, name: this.inputName, onBlur: this.onBlur, onFocus: this.onFocus, onInput: this.onInput, placeholder: this.placeholder, readOnly: this.readonly, type: this.type, value: this.encodeValue(this.value), pattern: this.pattern, required: this.required, part: "input", "data-test": this.dataTest }))), this.counterLength && (h("bds-counter-text", { key: '6b1925d766041cb42a8e11a1be9204925465db23', length: this.value.length, max: this.maxlength, active: isPressed, ...this.counterLengthRule })), this.success && h("bds-icon", { key: '37884af2f8e9c70efe70686c8554422130086811', class: "icon-success", name: "check", theme: "outline", size: "small" }), h("slot", { key: '4930e4d62e8e3eaa611a3e3997243de70158695f', name: "input-right" })), this.renderMessage()));
    }
...
//# sourceMappingURL=p-DIIIBxpr.js.map
