...
import { d as defineCustomElement$3 } from './p-f1kf6rmf.js';
...
const Tabs = /*@__PURE__*/ proxyCustomElement(class Tabs extends H {
    ...
    render() {
        return (h(Host, { key: 'b767846bb81fa90c1fd2d4081f0c2c15ec39e774', class: {
                'bds-tabs': true,
                [`bds-tabs--${this.align}`]: true,
            } }, h("div", { key: '3b6c726a72b9820ade6c16cef706e9f105143000', class: "bds-tabs__header-button-container" }, h("bds-button-icon", { key: 'cd429b849b7458bdbc72b51de7d53d684fdaee12', class: "bds-tabs__header-button", icon: "arrow-left", size: "short", id: "bds-tabs-button-left", onClick: () => this.handleScrollButtonClick("left" /* ScrollDirection.LEFT */), variant: "secondary" })), h("div", { key: '976b7163f3985e3e93ec27d757e28c6e59698d55', class: "bds-tabs__header" }, h("slot", { key: '29b7d2a3f334208cf4fb9a460bacd544965cedf4' })), h("div", { key: 'f74adaec95075c587763c67295610b8aa23a70e6', class: "bds-tabs__header-button-container" }, h("bds-button-icon", { key: 'ea101cb86e98f6bc130a1a3b1d932d4328e4e5ac', class: "bds-tabs__header-button", icon: "arrow-right", size: "short", id: "bds-tabs-button-right", onClick: () => this.handleScrollButtonClick("right" /* ScrollDirection.RIGHT */), variant: "secondary" }))));
    }
    get el() { return this; }
