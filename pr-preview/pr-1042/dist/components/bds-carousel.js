...
const BdsCarousel$1 = /*@__PURE__*/ proxyCustomElement(class BdsCarousel extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        ...
        return (h("div", { key: 'aa7aebd1a8d211ab7c482337b1363dafe5e23d01', class: { carousel: true } }, h("div", { key: '31a7d3f060d37f7241ff378dfc682d2c4d891ee5', class: {
                carousel_slide: true,
                carousel_slide_fullwidth: this.arrows != 'outside',
                [`carousel_slide_state_${this.autoplayState}`]: this.autoplay,
            }, tabindex: "0", onKeyDown: (ev) => this.setKeydownNavigation(ev), "data-test": this.dtSlideContent }, h("div", { key: '5a590d1d40035790ad135954974a8977cdad30b1', ref: (el) => this.refFrame(el), class: { carousel_slide_frame: true, carousel_slide_frame_loading: this.loading }, onMouseOver: () => this.onMouseOver(), onMouseOut: () => this.onMouseOut(), onMouseDown: (ev) => this.onMouseDown(ev), onMouseEnter: () => this.onMouseEnter(), onMouseUp: () => this.onMouseUp(), onMouseMove: (ev) => this.onMouseMove(ev) }, h("div", { key: '1478791fb1cdafab371e74d6fc7a8294260955ed', ref: (el) => this.refFrameRepeater(el), class: { carousel_slide_frame_repeater: true } }, h("slot", { key: '678c0af549a9171cb7c17db113026dee11c18093' }))), h("bds-grid", { key: '2fc13711f365a81f963958f3b5e16a9429967e13', class: { carousel_slide_loading: true, carousel_slide_loading_visible: this.loading } }, h("bds-skeleton", { key: 'bb484c25c5a651edd9cb9a41771c46837c13bdc8', height: "100%", shape: "square", width: "100%" })), this.arrows != 'none' && !this.loading && (h(ThemeOrDivArrows, { key: '163ea8a0fd5115c988f66532a01cedcf954e6803', ref: (el) => this.refThemeProviderArrows(el), class: {
                carousel_buttons: true,
                carousel_buttons_fullwidth: this.arrows != 'outside',
            } }, h("bds-button", { key: '0ec0b57300c808f40e3f378d80474ec38bead9fd', variant: "text", iconLeft: "arrow-left", color: "content", onBdsClick: () => this.prevSlide(), disabled: !this.infiniteLoop && this.itemActivated <= 1, dataTest: this.dtButtonPrev }), h("bds-button", { key: '653394988180d1c0a1b8ea2b8d28abdac0fa2676', variant: "text", iconLeft: "arrow-right", color: "content", onBdsClick: () => this.nextSlide(), disabled: !this.infiniteLoop && this.itemActivated >= this.internalItens.length, dataTest: this.dtButtonNext })))), this.internalItens.length > 1 && this.bullets != 'none' && (h("div", { key: 'ead3dbd4e1c431bb7259dce22f5acbb224603b55', class: {
            ...
            } }))))))))))), h("slot", { key: '53f9b8dc67817f99e57bfb72a5d210b93668df24', name: "after" })));
    }
    ...
    static get style() { return carouselCss; }
        ...
        "autoplayHoverPause": [4, "autoplay-hover-pause"],
        "autoHeight": [4, "auto-height"],
        "bullets": [8],
        "bulletsPosition": [1, "bullets-position"],
        "infiniteLoop": [4, "infinite-loop"],
        "arrows": [1],
        "slidePerPage": [2, "slide-per-page"],
        "gap": [1],
        "grab": [4],
        "loading": [1540],
        "dtSlideContent": [1, "dt-slide-content"],
...
function defineCustomElement$1() {
    ...
    const components = ["bds-carousel", "bds-button", "bds-grid", "bds-icon", "bds-loading-spinner", "bds-skeleton", "bds-typo"];
    components.forEach(tagName => { switch (tagName) {
        case "bds-carousel":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BdsCarousel$1);
            }
            break;
        case "bds-button":
            if (!customElements.get(tagName)) {
...
const BdsCarousel = BdsCarousel$1;
const defineCustomElement = defineCustomElement$1;

export { BdsCarousel, defineCustomElement };
//# sourceMappingURL=bds-carousel.js.map
