...
const BdsAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '91272fc2ad2983366f81eeef73a45e259b0c5bc7', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: 'b4ff62522b4df697ebaf8d3119de944d80c2c11c', class: {
                input: true,
                select: true,
            ...
            }, onClick: this.onClickWrapper }, this.renderIcon(), index.h("div", { key: 'ef88a1ba7f7182ad58aac8ba097412f87d23e591', class: "input__container", tabindex: "0", onFocusout: this.onFocusout }, this.renderLabel(), index.h("div", { key: '02abba7652fbe3696dcf46438dcc10eb995faf7d', class: { input__container__wrapper: true } }, this.textMultiselect?.length > 0 && (index.h("bds-typo", { key: 'a7d2a9138b79b57a7a387945fb11ee1e2fbac2ae', variant: "fs-14", class: "inside-input-left" }, this.textMultiselect)), index.h("input", { key: 'afe8c154d212cb93d0ab759510a81709bc290acd', class: { input__container__text: true }, ref: (input) => (this.nativeInput = input), disabled: this.disabled, onBlur: this.onBlur, onFocus: this.onFocus, onInput: this.changedInputValue, placeholder: this.placeholderState, type: "text", value: this.text, "data-test": this.dataTest, onKeyDown: this.keyPressWrapper.bind(this) }))), index.h("div", { key: 'e662417b3d556350faf1893b279f73895495f508', class: "select__icon" }, index.h("bds-icon", { key: 'b1263ad7057c4a9d3ea7c420605fc45c9d3b9f20', size: "small", name: "error", theme: "solid", onClick: this.cleanInputSelection, class: {
                'icon-hidden': (this.clearIconOnFocus && (!this.isFocused || !this.isOpen)) || !this.value,
            } }), index.h("bds-icon", { key: 'c6384e8fb27588cda0a199473aeb4eec9111c430', ref: (el) => this.refIconDrop(el), size: "small", color: "inherit" }))), this.renderMessage(), this.loading ? (index.h("div", { ref: (el) => this.refDropdown(el), class: {
