...
const BdsDropdown = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '438019f8950c933b25726426cab3ce403ef773ca' }, index.h("slot", { key: 'c9a4bab7e33920c480830cfaef2a2c475ced40cb', name: "dropdown-activator" }), index.h("div", { key: '331776adf4a5682d07120281d2b245a1bc9feee3', ref: (el) => this.refDropElement(el), class: {
                dropdown: true,
                dropdown__open: this.open,
            }, "data-test": this.dataTest, onMouseOver: () => this.onMouseOver(), onMouseOut: () => this.onMouseOut() }, index.h("div", { key: 'c614de397e1effc765489347aa3a74cdd85f3502', class: "content", style: zIndexSubmenu }, index.h("slot", { key: '182665ad37344cb29abe1cc30d0e9e30af103e04', name: "dropdown-content" }))), this.activeMode !== 'hover' && this.open && (index.h("div", { key: '2a847cc13dd3c95de8570807f0d2bd0f30311544', class: { outzone: true }, onClick: () => this.onClickCloseButtom() }))));
    }
