...
const SelectChips = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'c2dcbf9fe411f032d6ec095bf8ee825f8c39cfc6', class: "select", tabindex: "0", onFocus: this.setFocusWrapper, onBlur: this.removeFocusWrapper }, index.h("div", { key: '73106e32d15ff1b71c12f278960c74d4d2aa2a2e', class: { element_input: true }, "aria-disabled": this.disabled ? 'true' : null, onClick: this.toggle }, index.h("div", { key: '21a967a738369fd84b083df9e1130db79fcc29c6', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper }, this.renderIcon(), index.h("div", { key: 'f6ee73e797fa74474c67a48f97fdaa76eb1f7499', class: "input__container" }, this.renderLabel(), index.h("div", { key: '237b4f44657221d355d4b01884b2084631564ae0', class: { input__container__wrapper: true } }, this.internalChips.length > 0 && (index.h("span", { key: '98063111c259554a729f0d61148f8875a1dfbe96', style: { height: this.height, maxHeight: this.maxHeight }, class: "inside-input-left" }, this.renderChips())), index.h("input", { key: '3e12d176f0d5fd9641c64bb9ec5fc76e3c85d4e9', ref: (input) => (this.nativeInput = input), class: { input__container__text: true }, name: this.inputName, maxlength: this.maxlength, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: () => this.handleOnBlur(), onChange: () => this.handleChange, value: this.value, disabled: this.disabled, "data-test": this.dataTest, onKeyDown: this.keyPressWrapper }))), index.h("div", { key: '01711b35c17a8e4a376cf00f4d8c945a6f2c1e7b', class: "select__icon" }, index.h("bds-icon", { key: '1995ae0762325953cf0736811ce491755ccec895', ref: (el) => this.refIconDrop(el), size: "small", color: "inherit" })), this.success && index.h("bds-icon", { key: 'c0664346feeffff0eeaedb349f49ad36713bed29', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" })), this.renderMessage()), index.h("div", { key: '9947a09d7181a0a8e71edcdbc919a513590cbd1a', ref: (el) => this.refDropdown(el), class: {
                select__options: true,
                'select__options--open': this.isOpen,
            } }, internalOptions.map((option) => (index.h("bds-select-option", { key: this.generateKey(option.value), onOptionSelected: this.handler, value: option.value, status: option.status }, option.label))), index.h("slot", { key: '931f47b4a50482a1916ce61b93580f76ea32ba32' }), this.canAddNew === true && this.enableCreateOption() && (index.h("bds-select-option", { key: '76b91b0156c5ebfa09556593265df3dc2dd01f52', id: "option-add", value: "add", onClick: () => this.handlerNewOption(this.nativeInput.value) }, this.newPrefix, this.nativeInput.value)), !this.canAddNew && this.enableCreateOption() && (index.h("bds-select-option", { key: '5f86557642b9211436d30e3b5358cea86fa1f391', id: "no-option", value: "add" }, this.notFoundMessage)))));
    }
