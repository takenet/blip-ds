...
const Image = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '707a66cceac96d4b398d8f6365c591c3341a6b44', class: { empty_img: !this.imageLoaded } }, this.imageLoaded ? (index.h("img", { src: this.currentSrc, alt: this.alt, style: {
