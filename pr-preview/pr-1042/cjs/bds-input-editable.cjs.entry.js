...
const InputEditable = class {
    constructor(hostRef) {
        ...
        this.bdsInputEditableSave = index.createEvent(this, "bdsInputEditableSave");
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '16ef170b5fb5998abe556ff8b168afca4b776100' }, index.h("div", { key: '8252ea677d84efc640f5a56186fd00f5de6853bb', class: "input__editable" }, index.h("div", { key: 'd9bf03d7b4273c005388ede6a0d957e7a3d12002', class: { 'input__editable--static': true, 'input__editable--hidden': this.isEditing }, onClick: this.handleEditing, "data-test": this.dtButtonEdit, tabindex: "0", onKeyDown: this.handleKeyDownToggle.bind(this) }, index.h("bds-typo", { key: '809b5044da89209a49a9dbc59c2d8750e2fc4491', tag: "span", part: "input__editable--static__typo", class: "input__editable--static__typo", variant: variant }, this.value), index.h("bds-icon", { key: "edit-icon", class: "input__editable--static__icon", name: "edit" })), index.h("div", { key: '19906f1baf12241ac45f53eee88b9d87aba4b06a', class: { 'input__editable--active': true, 'input__editable--hidden': !this.isEditing } }, index.h("div", { key: 'ee8f4a00c1c61472b65f5a0cb6db845450326a93', class: { element_input: true, [inputExpand]: true, [this.size]: true } }, index.h("div", { key: 'b460e5a37a4e0425ea74da2cdb185082af54ddaf', class: {
                input: true,
                select: true,
            ...
            }, onClick: this.onClickWrapper }, index.h("div", { key: 'a3c139aae2a2d4e97e725fecbf3bd242dfb9bf00', class: "input__container" }, index.h("input", { key: 'debe365ccb5b4e3d1d254d840fd417a7018fbd56', class: { input__container__text: true }, ref: (input) => (this.nativeInput = input), minLength: this.minlength, maxLength: this.maxlength, name: this.inputName, onBlur: this.onBlur, onFocus: this.onFocus, onInput: this.changedInputValue, placeholder: this.placeholder, value: this.value, required: true, part: "input", "data-test": this.dataTest })), this.success && index.h("bds-icon", { key: 'd0da8d0afce8ea83b5307207f4f1adc9cce6fd9c', class: "icon-success", name: "checkball", theme: "solid", size: "xxx-small" })), this.renderMessage()), index.h("div", { key: '80d3cc9449e5495b0f6a844ea00be2e2204a7704', class: "input__editable--active__icon" }, index.h("bds-icon", { key: "error-icon", class: "input__editable--active__icon--error", theme: "solid", name: "error", onClick: this.handleEditing, tabindex: "0", onKeyDown: this.handleKeyDownToggle.bind(this), dataTest: this.dtButtonClose }), index.h("bds-icon", { key: "checkball-icon", class: {
...
//# sourceMappingURL=bds-input-editable.entry.cjs.js.map

//# sourceMappingURL=bds-input-editable.cjs.entry.js.map