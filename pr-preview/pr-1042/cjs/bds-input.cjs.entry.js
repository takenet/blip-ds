...
const Input = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '39c09fccba401953d4e8cc7a82274010beddd2ff', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: 'a28bc87cb4b7a797ede1c30f7b0d98127b4657d3', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("slot", { key: '98b4311df1b373e2f115fa29d471391cba958b6d', name: "input-left" }), index.h("div", { key: 'e34f562752137a9227e049296d8dad86c7f96788', class: "input__container" }, this.renderLabel(), index.h("div", { key: 'ec1977558ee79babdf60bf0352a74744e0313db8', class: { input__container__wrapper: !this.chips, input__container__wrapper__chips: this.chips } }, index.h("slot", { key: '714f06e86e625aee180df288386123da653f7285', name: "inside-input-left" }), index.h(Element, { key: '5017d068666199b29feb3837a5bfa996b919a760', class: { input__container__text: true, input__container__text__chips: this.chips }, ref: (input) => (this.nativeInput = input), rows: this.rows, cols: this.cols, autocapitalize: this.autoCapitalize, autocomplete: this.autoComplete, disabled: this.disabled, min: this.min, max: this.max, minLength: this.minlength, maxLength: this.maxlength, name: this.inputName, onBlur: this.onBlur, onFocus: this.onFocus, onInput: this.onInput, placeholder: this.placeholder, readOnly: this.readonly, type: this.type, value: this.encodeValue(this.value), pattern: this.pattern, required: this.required, part: "input", "data-test": this.dataTest }))), this.counterLength && (index.h("bds-counter-text", { key: '9372ff8b8b1e094bac0c61f37ce822294cf2c225', length: this.value.length, max: this.maxlength, active: isPressed, ...this.counterLengthRule })), this.success && index.h("bds-icon", { key: 'e1aaf2b977b5aff2d085e6e5e8f19a45cb33fcc2', class: "icon-success", name: "check", theme: "outline", size: "small" }), index.h("slot", { key: '3b32dc7b1bacf9372fdacc58df0225f8da790610', name: "input-right" })), this.renderMessage()));
    }
