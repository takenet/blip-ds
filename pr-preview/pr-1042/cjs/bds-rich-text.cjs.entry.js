...
const RichText = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6e5b218dabb382ebeae52b2ec7a0497d923c999e', class: {
                [`rich-text`]: true,
                [`rich-text-${this.positionBar}`]: true,
            }, style: { height: this.height, maxHeight: this.maxHeight }, tabindex: "0", onMouseEnter: () => (this.insideComponent = true), onMouseLeave: () => (this.insideComponent = false) }, index.h("div", { key: '2909de1adf06e810e9e908309fedbe8c291ec1e4', class: "preview" }, index.h("div", { key: '2a4cab2608c6a0e87c31b047f47b0926d703533a', "data-test": this.dataTest, ref: (el) => this.refeditorElement(el), contentEditable: "true", class: "editor-uai-design-system", tabindex: "0", onBlur: this.onBlur, onFocus: this.onFocus, onMouseUp: () => this.updateToolbarState(), onKeyUp: () => this.updateToolbarState(), onKeyDown: (ev) => this.onKeydown(ev), onInput: (ev) => this.onInput(ev), onPaste: this.handlePaste.bind(this) })), index.h("bds-grid", { key: 'be73afe468fded2e0e2ca9746112c5630daf67a0', class: {
                [`format-buttons`]: true,
                [`format-buttons-active`]: this.weightButton ||
                    ...
                    this.headingButtons ||
                    this.unstyledButton,
            } }, index.h("div", { key: '3e5c6416c1feec757c28e84fff4b3d24713a88b4', class: "accordion-header" }, index.h("bds-grid", { key: 'b9f0d7cadba83d2e69943025dc18005ff91c2964', ref: (el) => this.refButtonsListElement(el), class: "buttons-list", "flex-wrap": "wrap" }, index.h("div", { key: '20ad63af2e1c1659351da25114256ed089f7364c', onFocus: (ev) => this.onFocusEditorBar(ev), tabindex: "1", class: "editor-bar" }), this.weightButton && (index.h("bds-tooltip", { key: 'ca0a51b549024ad47d0d672cb736a25314dfbe0e', "tooltip-text": `${termTranslate(this.language, 'bold')}`, position: "top-center" }, index.h("bds-button", { key: '67618b2a15a542c648805093ec259f1781641e5d', variant: this.buttomBoldActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.wrapSelection(ev, 'b'), "icon-left": "text-style-bold", "aria-label": `${termTranslate(this.language, 'bold')}` }))), this.italicButton && (index.h("bds-tooltip", { key: 'eb92f4188a27c981318edfaa3e001005ee74efbc', "tooltip-text": `${termTranslate(this.language, 'italic')}`, position: "top-center" }, index.h("bds-button", { key: 'fe406619a20057d4750940d941199e6bb2188e6c', variant: this.buttomItalicActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.wrapSelection(ev, 'i'), "icon-left": "text-style-italic", "aria-label": `${termTranslate(this.language, 'italic')}` }))), this.strikeThroughButton && (index.h("bds-tooltip", { key: 'eda674b3cb669ba2752f42891d89301deea7d066', "tooltip-text": `${termTranslate(this.language, 'strike')}`, position: "top-center" }, index.h("bds-button", { key: '646132b6029ac5e0991f7003ba40401e532f5aeb', variant: this.buttomStrikeActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.wrapSelection(ev, 'strike'), "icon-left": "text-style-strikethrough", "aria-label": `${termTranslate(this.language, 'strike')}` }))), this.underlineButton && (index.h("bds-tooltip", { key: '4e17dfe7b9992a52a2f9ac6287c193455c6d0001', "tooltip-text": `${termTranslate(this.language, 'underline')}`, position: "top-center" }, index.h("bds-button", { key: '00fa424858b39fedbb09492daf680ac5c00de5b5', variant: this.buttomUnderlineActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.wrapSelection(ev, 'u'), "icon-left": "text-style-underline", "aria-label": `${termTranslate(this.language, 'underline')}` }))), this.linkButton && (index.h("bds-tooltip", { key: 'd3faef07b29ca078933ba776a50de79b6dcb9f48', "tooltip-text": `${termTranslate(this.language, 'link')}`, position: "top-center" }, this.buttomLinkActive ? (index.h("bds-button", { variant: "solid", color: "content", size: "short", onBdsClick: (ev) => this.wrapSelection(ev, 'a'), "icon-left": "link", "aria-label": `${termTranslate(this.language, 'link')}` })) : (index.h("bds-dropdown", { ref: (el) => this.refDropDownLinkElement(el), activeMode: "click", position: "bottom-left" }, index.h("div", { slot: "dropdown-activator" }, index.h("bds-button", { slot: "dropdown-activator", variant: "text", color: "content", size: "short", onBdsClick: (ev) => this.addSelectionLink(ev), "icon-left": "link", "aria-label": `${termTranslate(this.language, 'link')}` })), index.h("bds-grid", { padding: "half", alignItems: "center", gap: "half", slot: "dropdown-content" }, index.h("bds-input", { ref: this.refInputSetLink, onBdsInput: (ev) => this.addLinkInput(ev), style: { flexShrink: '99999' }, placeholder: "adcione o link aqui", onKeyDown: (ev) => this.createLinkKeyDown(ev), tabindex: this.dropDownLink?.open ? '1' : '-1' }), index.h("bds-button", { disabled: this.buttomLinkValidDisabled, "icon-left": "check", onBdsClick: (ev) => this.createLink(ev), tabindex: this.dropDownLink?.open ? '1' : '-1', "aria-label": `${termTranslate(this.language, 'link')}` })))))), this.codeButton && (index.h("bds-tooltip", { key: '041531585c9a37e2c25db41b88af338228125b8e', "tooltip-text": `${termTranslate(this.language, 'code')}`, position: "top-center" }, index.h("bds-button", { key: 'e417bc2dcbd9795aeb8559ec851f58b0a3332250', variant: this.buttomCodeActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.wrapSelection(ev, 'code'), "icon-left": "code", "aria-label": `${termTranslate(this.language, 'code')}` }))), this.alignmentButtons && (index.h("bds-tooltip", { key: 'dfba3d627d0a02f16b216cb8acaf6822afefd4a5', "tooltip-text": `${termTranslate(this.language, 'align_left')}`, position: "top-center" }, index.h("bds-button", { key: 'e196938e19724120ddf1010ccccd7ccf0a33995a', variant: this.buttomAlignLeftActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.alignText(ev, 'left'), "icon-left": "align-left", "aria-label": `${termTranslate(this.language, 'align_left')}` }))), this.alignmentButtons && (index.h("bds-tooltip", { key: '975b32a5a507aca54467c9513d9e6cdbddcb1963', "tooltip-text": `${termTranslate(this.language, 'align_center')}`, position: "top-center" }, index.h("bds-button", { key: '6dc6bad1bc18543fad221384ce441431c00a3748', variant: this.buttomAlignCenterActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.alignText(ev, 'center'), "icon-left": "align-center", "aria-label": `${termTranslate(this.language, 'align_center')}` }))), this.alignmentButtons && (index.h("bds-tooltip", { key: 'af28535e3b51d7ac07427d0cb2dc2c051e4e4911', "tooltip-text": `${termTranslate(this.language, 'align_right')}`, position: "top-center" }, index.h("bds-button", { key: 'f4c5004621395e7df3f0c0cb5845c9ef28a2e0a5', variant: this.buttomAlignRightActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.alignText(ev, 'right'), "icon-left": "align-right", "aria-label": `${termTranslate(this.language, 'align_right')}` }))), this.listButtons && (index.h("bds-tooltip", { key: 'b141ec79deea39688b1dbbe6b32aae3813658d32', "tooltip-text": `${termTranslate(this.language, 'unordered_list')}`, position: "top-center" }, index.h("bds-button", { key: 'b6289fa008e53346bc9087f607598549717c8fb0', variant: this.buttomUnorderedListActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.createList(ev, 'ul'), "icon-left": "unordered-list", "aria-label": `${termTranslate(this.language, 'unordered_list')}` }))), this.listButtons && (index.h("bds-tooltip", { key: '3609d718564f8839d65b68b283f712250daf46c2', "tooltip-text": `${termTranslate(this.language, 'ordered_list')}`, position: "top-center" }, index.h("bds-button", { key: '6861698a0f7061dfe0664bd2e982ec2d2c369076', variant: this.buttomOrderedListActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.createList(ev, 'ol'), "icon-left": "ordered-list", "aria-label": `${termTranslate(this.language, 'ordered_list')}` }))), this.quoteButton && (index.h("bds-tooltip", { key: '19ab61e66bbadcb06de653ff5aa8ff12d2982091', "tooltip-text": `${termTranslate(this.language, 'quote')}`, position: "top-center" }, index.h("bds-button", { key: '1fe8d1705301db7b1dd28b5ed40bd5139ccdbf22', variant: this.buttomQuoteActive ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.createHeading(ev, 'blockquote'), "icon-left": "quote", "aria-label": `${termTranslate(this.language, 'quote')}` }))), this.headingButtons && (index.h("bds-tooltip", { key: '76623f1100adc9d168622f3651347412d3f8ee5d', "tooltip-text": `${termTranslate(this.language, 'h1')}`, position: "top-center" }, index.h("bds-button", { key: '611a490465bd03d1364ffe7551f4034407baeab1', variant: this.buttomH1Active ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.createHeading(ev, 'h1'), "icon-left": "h-1", "aria-label": `${termTranslate(this.language, 'h1')}` }))), this.headingButtons && (index.h("bds-tooltip", { key: '6db1b911646e7d72c121535e435ad26c51998c4f', "tooltip-text": `${termTranslate(this.language, 'h2')}`, position: "top-center" }, index.h("bds-button", { key: '3e3b3e30b5e335d45c84da60752654b415203e20', variant: this.buttomH2Active ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.createHeading(ev, 'h2'), "icon-left": "h-2", "aria-label": `${termTranslate(this.language, 'h2')}` }))), this.headingButtons && (index.h("bds-tooltip", { key: '0bb9d450b2edc8fdf372e640d47803877341ba0a', "tooltip-text": `${termTranslate(this.language, 'h3')}`, position: "top-center" }, index.h("bds-button", { key: 'bac98c8fffffce09add20f8c988c997993902342', variant: this.buttomH3Active ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.createHeading(ev, 'h3'), "icon-left": "h-3", "aria-label": `${termTranslate(this.language, 'h3')}` }))), this.headingButtons && (index.h("bds-tooltip", { key: '3287842013b159e212da58e166babe8602b97542', "tooltip-text": `${termTranslate(this.language, 'h4')}`, position: "top-center" }, index.h("bds-button", { key: '41b931555201c76a920aed277a563400d90c9afa', variant: this.buttomH4Active ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.createHeading(ev, 'h4'), "icon-left": "h-4", "aria-label": `${termTranslate(this.language, 'h4')}` }))), this.headingButtons && (index.h("bds-tooltip", { key: 'fa9b6bad4abd94cdd890e3eca865a35dabf8798a', "tooltip-text": `${termTranslate(this.language, 'h5')}`, position: "top-center" }, index.h("bds-button", { key: '240a850770957eec90010cb251b668e721199a58', variant: this.buttomH5Active ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.createHeading(ev, 'h5'), "icon-left": "h-5", "aria-label": `${termTranslate(this.language, 'h5')}` }))), this.headingButtons && (index.h("bds-tooltip", { key: 'b81af303389d35979f1714ad50d76e4b614e5f69', "tooltip-text": `${termTranslate(this.language, 'h6')}`, position: "top-center" }, index.h("bds-button", { key: '8031c31d287dc1df60546f6ea7ce9b129627412f', variant: this.buttomH6Active ? 'solid' : 'text', color: "content", size: "short", onBdsClick: (ev) => this.createHeading(ev, 'h6'), "icon-left": "h-6", "aria-label": `${termTranslate(this.language, 'h6')}` }))), this.unstyledButton && (index.h("bds-tooltip", { key: '350c9d6317b3a6491e17e2492920d7d452046bed', "tooltip-text": `${termTranslate(this.language, 'clear_formatting')}`, position: "top-center" }, index.h("bds-button", { key: '6497fd89f2983c2abee0459300174054dcbb937e', variant: "text", color: "content", size: "short", onBdsClick: (ev) => this.clearFormatting(ev), "icon-left": "unstyled", "aria-label": `${termTranslate(this.language, 'clear_formatting')}` })))), index.h("bds-button", { key: 'bc12a6c192e3c50ecccf9ca24f6ba6926b141ff8', id: "buttonAccordion", variant: this.buttomAccordionActive ? 'solid' : 'text', class: "arrow-down", color: "content", size: "short", onBdsClick: () => this.setheaderHeight(), "icon-left": this.positionBar == 'top'
