...
const InputPhoneNumber = class {
    ...
    render() {
        ...
        const flagsNames = Object.keys(this.countries);
        return (index.h(index.Host, { key: 'a2bb01db0139aa94b71e821a83e83c61cda48ebb', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '198d8cf06770348bd1788393149c29cbee489d25', class: { element_input: true }, "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: 'b6ba567dadc1128b610e983da16da992a0cb60fe', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: '38d93f9d333bfc07ba6c6be70fd421a88088d480', onClick: this.toggle, onKeyDown: this.handleKeyDown.bind(this), "data-test": this.dtSelectFlag, class: "input__icon", tabindex: "0" }, index.h("bds-icon", { key: 'c32ed7aeb653cb645cfe2bb22ab0afae80f842dc', size: "medium", theme: "solid", name: this.selectedCountry, color: "primary" }), index.h("bds-icon", { key: '7a348a0abf8a656868485d84513176d0d7bff8b0', size: "x-small", name: iconArrow })), index.h("div", { key: '0c06f44fea58acd68fb41e660542187b25cd7d1d', class: "input__container" }, this.renderLabel(), index.h("div", { key: 'c5d7a479cf577de84c5719304e292938fa5c86a6', class: { input__container__wrapper: true } }, index.h("div", { key: 'ce27ffb03c13aa6ea0681af8ad40689593aaca1f', class: "input__container__country-code" }, index.h("bds-typo", { key: '65d5db0590f90ea82daaf913e6532cab602dbde5', "no-wrap": "true", variant: "fs-14" }, this.value)), index.h("input", { key: '5516bf2a71448e5210de8fba9494ae134e55d69d', class: { input__container__text: true }, type: "phonenumber", required: this.required, pattern: "/^(\\(?\\+?[0-9]*\\)?)?[0-9_\\- \\(\\)]*$/", ref: this.refNativeInput, onInput: this.changedInputValue, onFocus: this.onFocus, onBlur: this.onBlur, value: this.text, disabled: this.disabled, "data-test": this.dataTest, maxlength: this.value === '+55' ? 25 : null }))), this.success && index.h("bds-icon", { key: '0ecb6927011db685067602c4dcb1c0a4904f8c5b', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" }), index.h("slot", { key: '9a95939b3253a45476ca293e629d7ca624036b91', name: "input-right" })), this.renderMessage()), index.h("div", { key: '82398f2be4673b09e2b0aa5d25cece72f86b615f', class: {
