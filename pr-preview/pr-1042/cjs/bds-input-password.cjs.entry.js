...
const InputPassword = class {
    constructor(hostRef) {
        ...
        this.bdsInputPasswordChange = index.createEvent(this, "bdsInputPasswordChange");
        this.bdsInputPasswordInput = index.createEvent(this, "bdsInputPasswordInput");
        this.bdsInputPasswordBlur = index.createEvent(this, "bdsInputPasswordBlur");
        this.bdsInputPasswordFocus = index.createEvent(this, "bdsInputPasswordFocus");
        this.bdsInputPasswordSubmit = index.createEvent(this, "bdsInputPasswordSubmit");
        this.bdsKeyDownBackspace = index.createEvent(this, "bdsKeyDownBackspace");
        /**
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7e31694311d0699ee89239340da854fd4862e6a4', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '1c459cb8a664bb1e1d33773307142e2e261f7fda', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: '78c548c1a6d7ceb975a3404268f8800ce8970308', class: "input__container" }, this.renderLabel(), index.h("div", { key: '4254808e1037a6476025484e168cb23a6fb569e2', class: { input__container__wrapper: true } }, index.h("input", { key: 'f8b4da950f1648a9bb79214ea242c56558ae74ce', ref: this.refNativeInput, class: { input__container__text: true }, type: type, name: this.inputName, min: this.min, max: this.max, minLength: this.minlength, maxLength: this.maxlength, readOnly: this.readonly, autocomplete: autocomplete, autocapitalize: this.autoCapitalize, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: this.onBlur, onSubmit: this.onSubmit, value: this.value, disabled: this.disabled, "data-test": this.dataTest }))), index.h("div", { key: '0502b6ed8d9a2d47e5425fd837b40de6ef96b229', class: "input__password--icon", onClick: this.toggleEyePassword, onKeyDown: this.handleKeyDown.bind(this), tabindex: "0" }, index.h("bds-icon", { key: '59052f30b977d8501dfc519a8f6c8e8c94220f76', size: "small", name: iconPassword, color: "inherit" })), this.success && index.h("bds-icon", { key: '8253c92100519f811555025a8992221bb6b0b059', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" })), this.renderMessage()));
    }
...
//# sourceMappingURL=bds-input-password.entry.cjs.js.map

//# sourceMappingURL=bds-input-password.cjs.entry.js.map