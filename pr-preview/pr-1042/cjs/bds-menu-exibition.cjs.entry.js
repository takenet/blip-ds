...
const BdsMenuExibition = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'be984b557e772b4ffbfae4c16e47744f4f0a72c7', class: {
                menuexibition: true,
                [`menuexibition__disabled`]: this.disabled,
            } }, hasAvatar && (index.h("bds-avatar", { key: 'ef1c82d132c1f0d380e11798155b9f324d3a2cdc', class: "avatar-item", name: this.avatarName, thumbnail: this.avatarThumbnail, size: this.avatarSize })), index.h("div", { key: 'e0b22572406949b55a88ac1de789485ca6351987', class: "content-item" }, this.value && (index.h("bds-typo", { key: '6b1a62042a1c20f410677c8070443109f9d0e40f', class: "title-item", variant: "fs-16", tag: "span" }, this.value)), this.subtitle && (index.h("bds-typo", { key: 'c584b31e29959788fce8fb02ff2737bf5db7ab0d', class: "subtitle-item", variant: "fs-10", tag: "span" }, this.subtitle)), this.description && (index.h("bds-typo", { key: 'cf9b57ac3aa22bfe4db0a6997e9bff558f1e55a7', class: "description-item", variant: "fs-10", tag: "span" }, this.description)))));
    }
};
