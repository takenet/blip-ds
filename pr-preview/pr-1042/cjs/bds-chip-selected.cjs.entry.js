...
const ChipSelected = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1e33ada55a3b814269ecb01d90e89ea3984b0414' }, index.h("div", { key: 'eeff52441ea7b0e67d60d0a02b5fd54c9cd712d6', class: {
                chip: true,
                ...this.getStyleChip(),
                ...this.getDisabledChip(),
            }, onClick: (ev) => this.handleClick(ev), "data-test": this.dataTest }, !this.disabled && index.h("div", { key: '94ccd6403ec0f45d918e6a61dd4ba5b2eff5683f', class: "chip_focus", onKeyDown: this.handleKeyDown.bind(this), tabindex: "0" }), !this.isSelected && !this.disabled && index.h("div", { key: '37a273a6697e37b515ed9429fe71c790263b140b', class: "chip_darker" }), this.icon && !this.isSelected && (index.h("div", { key: '33e618cffbdd77803a61b13e19913a97500e62d4', class: "chip--icon" }, index.h("bds-icon", { key: '59e951a21725aa97dea64d61c7465863aa2c3b77', size: this.getSizeIconChip(), name: this.icon }))), this.isSelected && (index.h("div", { key: '868d5fb08cfe8b9ef0e792ff97004624cf052d65', class: "chip_selected--icon" }, index.h("bds-icon", { key: '8dff7167e05826fac0008c4762ed3506cb12c3c4', size: this.getSizeIconChip(), name: "checkball" }))), index.h("div", { key: '5852b5f684f7672966a411fe66cda045e10c61ad', class: this.isSelected ? `chip_selected--container-text--half` : `chip_selected--container-text--full` }, index.h("bds-typo", { key: '642855e4fb67d2a1dd10494b77b4c8f8b4c5cd7f', class: { 'chip--text': true, ...this.getStyleText() }, variant: "fs-12", "no-wrap": true, bold: "bold" }, index.h("slot", { key: 'b2bf55c0efee784937d1170aadc73f97a7fbfdd4' }))))));
    }
