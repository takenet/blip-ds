...
const Badge = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd20ef9793af71ebc0945fceb95ca517c85de527b' }, index.h("div", { key: '9d4aa070ca534a0edf680daadb1cd78dd99ad695', class: {
                chip_badge: true,
                chip_size: this.number !== 0 ? true : false,
                [`chip_badge--${this.shape}`]: true,
                [`chip_badge--${this.color}`]: true,
            }, "data-test": this.dataTest }, this.type === 'status' && (index.h("div", { key: '17db29aefd614b84e2ad4e14f677e0e9f1270a0a', class: {
                status: true,
                [`status--${this.shape}`]: true,
                [`color--${this.color}`]: true,
                [`status--circle-${this.animation}`]: true,
            } })), this.type === 'icon' && (index.h("div", { key: '5ad822383ab49895d3f9135d36b803c9afec9df3', class: { icon: true, [`icon--${this.shape}`]: true } }, index.h("div", { key: 'd6f9358bd0a441c85043587cda77bfca483a277c', class: { [`color--${this.color}`]: true, trim: true, [`trim-${this.animation}`]: true } }), index.h("bds-icon", { key: '8b760e7b1ddb604659bf886c28d39d88b7711ad2', size: "xxx-small", name: this.icon }))), this.type === 'number' && (index.h("div", { key: '3da3d77e5107792d256b9892be77e15a693bf8a5', class: {
                number: true,
                [`color--${this.color}`]: true,
                [`number--${this.animation}`]: true,
            } }, index.h("bds-typo", { key: '7b6eb54efcb34abd18fcdd232d8a589d4288383d', class: "number_text", variant: "fs-12", bold: "bold", margin: false }, this.number >= 999 ? '999+' : this.number))), this.type === 'empty' && (index.h("div", { key: 'b2c5b644be228c6df3ec179d3c091f6ccdddb19e', class: {
                empty: true,
                [`color--${this.color}`]: true,
...
//# sourceMappingURL=bds-badge.entry.cjs.js.map

//# sourceMappingURL=bds-badge.cjs.entry.js.map