...
const ChipTag = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0f5a04b5c3938eb5a4eda5e82d95bf627813cd22' }, index.h("div", { key: '568966ffe94ac53a3877b9948bc7519e8eec8765', class: {
                chip_tag: true,
                [`chip_tag--${this.color}`]: true,
            }, "data-test": this.dataTest }, this.icon && (index.h("div", { key: '223d5c5caae147ebb6efbd4e8284bba33b65db0f', class: "chip_tag--icon" }, index.h("bds-icon", { key: '1582b675e0433665f87116be02f353da0a6c4be0', size: "x-small", name: this.icon }))), index.h("div", { key: '897273edaf5d01438fcf2511d3ad2f4858830c83', class: this.icon ? `chip_tag--container-text--half` : `chip_tag--container-text--full` }, index.h("bds-typo", { key: '50317d92cc25024cf64761c41028d09ee165bc0b', "no-wrap": "true", class: "chip_tag--text", variant: "fs-12", bold: "bold" }, index.h("slot", { key: 'deae1cb1cc8661e154e488f87df9c815479f18b8' }))))));
    }
};
