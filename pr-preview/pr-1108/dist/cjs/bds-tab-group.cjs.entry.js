...
const BdsTabGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'bb7954172ee37d84e5cad48192187c0c6aea5ace' }, index.h("div", { key: '1a3aa12156fec3cc16fffbfeffe7504111190bc1', class: { tab_group: true } }, this.isSlideTabs && this.alignTab != 'left' && (index.h("bds-button-icon", { key: '71081c94bd1de5b090a35bd45687ca4cd492f5c3', class: "tab_group__slide-button", icon: "arrow-left", size: "short", id: "bds-tabs-button-left", onClick: () => this.prevSlide(), dataTest: this.dtButtonPrev, variant: "secondary" })), index.h("div", { key: '82cbd5a0c47f605424d62856d0d1bb2cb39bb714', class: { tab_group__header: true, tab_group__slide: this.isSlideTabs }, ref: this.refHeaderElement, style: headerStyle }, index.h("div", { key: '95bc772a8bb3ce52e6d6360f97d5cda778ea38b0', class: {
            ...
            this.internalItens.map((item, index$1) => {
                ...
                return (index.h("div", { class: {
                    ...
                    ? this.renderBadge(item.badgeShape, item.badgeColor, item.badgeIcon, item.badgeAnimation, item.badgeNumber)
                    : ''));
            }))), this.isSlideTabs && this.alignTab != 'right' && (index.h("bds-button-icon", { key: '1361f5eeef61af74934e88b77ac16777f95ef16f', class: "tab_group__slide-button", icon: "arrow-right", size: "short", id: "bds-tabs-button-right", onClick: () => this.nextSlide(), dataTest: this.dtButtonNext, variant: "secondary" })), index.h("div", { key: '7ddbb88fe13055456056ddbb869f627b09ffd741', class: { tab_group__content: true, tab_group__scrolled: this.contentScrollable }, style: contentStyle }, index.h("slot", { key: 'ccb397f22da575ecabd65b3fb336fa9e8d9bd485' })))));
    }
