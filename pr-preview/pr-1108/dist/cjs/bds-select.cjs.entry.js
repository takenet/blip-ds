...
const Select = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'd7730cb76798ada0a4e9f940360bbb8082210abd', class: "select" }, index.h("div", { key: '9ab70776d9269eaa4d2633c91aac529130f52164', class: { element_input: true }, "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: 'cf0297b6dc91116e452a5ecb5b554b3ec258777e', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: '14186d2e5c468715e18fc07d23ebd63d7ec7a58d', class: "input__container" }, this.renderLabel(), index.h("div", { key: '892aaa4d448c718b39884558e9165547bfdb78ae', class: { input__container__wrapper: true } }, index.h("input", { key: '6ab4560f369787642d72933b227b319c213b2a6f', ref: this.refNativeInput, class: { input__container__text: true }, onFocus: this.onFocus, onBlur: this.onBlur, value: this.text, disabled: this.disabled, placeholder: this.placeholder, readonly: true, "data-test": this.dataTest, onKeyDown: this.keyPressWrapper.bind(this) }))), index.h("div", { key: 'ed16f046df88e1dee7b48dac58169124f1d266fd', class: "select__icon" }, index.h("bds-icon", { key: '7a17db07d08864c1c795d5968a79f8ec371254a5', ref: (el) => this.refIconDrop(el), size: "small", color: "inherit" })), this.success && index.h("bds-icon", { key: '5671081a9076d85576405dc153762199e71df1fe', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" })), this.renderMessage()), index.h("div", { key: '0c04d519e7c50413099da01e1bf69cb52b67b6af', ref: (el) => this.refDropdown(el), class: {
