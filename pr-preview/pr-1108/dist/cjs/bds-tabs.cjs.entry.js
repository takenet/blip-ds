...
const Tabs = class {
    ...
    render() {
        return (index.h(index.Host, { key: '535e71da47e7db3eb2a445957523822f0dd3bd2c', class: {
                'bds-tabs': true,
                [`bds-tabs--${this.align}`]: true,
            } }, index.h("div", { key: '23cbe8227e984db3e86c7e7e82ff5200c6c9412e', class: "bds-tabs__header-button-container" }, index.h("bds-button-icon", { key: '0d610d95aa9906c68c4e4b9c3c574e0bcf9cbbb8', class: "bds-tabs__header-button", icon: "arrow-left", size: "short", id: "bds-tabs-button-left", onClick: () => this.handleScrollButtonClick("left" /* ScrollDirection.LEFT */), variant: "secondary" })), index.h("div", { key: '0c14802dba6c4db7d431582f2fab92383b7efb3c', class: "bds-tabs__header" }, index.h("slot", { key: '7c8fc5473234f2d5503e348fbaa7a4bec29c3c3d' })), index.h("div", { key: '1c7d5d3fa465320f954dd11d6cf0c7d3e1eace06', class: "bds-tabs__header-button-container" }, index.h("bds-button-icon", { key: '0ed91d23bbe106abf0cb57ed5e7c5aec14219460', class: "bds-tabs__header-button", icon: "arrow-right", size: "short", id: "bds-tabs-button-right", onClick: () => this.handleScrollButtonClick("right" /* ScrollDirection.RIGHT */), variant: "secondary" }))));
    }
