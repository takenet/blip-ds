...
const Input = class {
    constructor(hostRef) {
        ...
        this.bdsOnBlur = index.createEvent(this, "bdsOnBlur");
        this.bdsFocus = index.createEvent(this, "bdsFocus");
        this.bdsSubmit = index.createEvent(this, "bdsSubmit");
        this.bdsPatternValidation = index.createEvent(this, "bdsPatternValidation");
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'cd976d3b96db3046f3a3eba8326bbee46ff9e151', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '6c2ba8cc39bcdc73e2be7604555783d946fac94b', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("slot", { key: '6767cc61b7d22a4f96e857d2c053e758cc8ff081', name: "input-left" }), index.h("div", { key: 'e5716618215cec9a77c90e1e0baa7f878dc27c96', class: "input__container" }, this.renderLabel(), index.h("div", { key: '2916bed57190055ec01438f9be400f74716be5c5', class: {
            ...
            } }, index.h("slot", { key: '0cccef053caf8461e7bf99e8f39386b4150146c9', name: "inside-input-left" }), index.h(Element, { key: 'e1f54dc300b9f12f7123b081a7f05ce8c27246f0', class: {
            ...
            } : {} }))), this.counterLength && (index.h("bds-counter-text", Object.assign({ key: '8665fa48a456ddf90b993442d44e93c116425fdb', length: this.value.length, max: this.maxlength, active: isPressed }, this.counterLengthRule))), this.success && index.h("bds-icon", { key: '244099c9cb2ff093412ed03b4b73207c68530bfd', class: "icon-success", name: "check", theme: "outline", size: "small" }), index.h("slot", { key: 'd882c2f79c904f0adc4d18febd9c5ed77932644a', name: "input-right" })), this.renderMessage()));
    }
...
//# sourceMappingURL=bds-counter-text.bds-input.entry.cjs.js.map

//# sourceMappingURL=bds-counter-text_2.cjs.entry.js.map