...
const SearchAnywhere = class {
    ...
    renderTrigger() {
        return (index.h("div", { class: "search-trigger", onClick: this.handleTriggerClick }, index.h("bds-input", { icon: "search", placeholder: this.triggerPlaceholder, readonly: true, dataTest: "search-anywhere-trigger" }, this.showShortcut && (index.h("div", { slot: "input-right", class: "keyboard-shortcut" }, index.h("bds-typo", { variant: "fs-12", bold: "regular" }, "\u2318K"))))));
    }
    renderResults() {
    ...
    renderModal() {
        ...
        return (index.h("div", { class: "search-modal-overlay", onClick: this.handleModalClick }, index.h("div", { class: "search-modal", onKeyDown: this.handleModalKeydown }, index.h("div", { class: "search-modal-header" }, index.h("div", { class: "search-input-wrapper" }, index.h("bds-icon", { name: "search", size: "medium", class: "search-icon" }), index.h("input", { ref: (el) => (this.inputElement = el), type: "text", class: "search-input", placeholder: this.placeholder, value: this.searchText, onInput: this.handleInputChange, "data-test": "search-anywhere-input" }))), index.h("div", { class: "search-modal-results", ref: (el) => (this.resultsContainerElement = el) }, this.renderResults()), index.h("div", { class: "search-modal-footer" }, index.h("div", { class: "keyboard-hints" }, index.h("span", { class: "hint" }, index.h("bds-typo", { variant: "fs-10" }, "\u2191\u2193 to navigate")), index.h("span", { class: "hint" }, index.h("bds-typo", { variant: "fs-10" }, "\u21B5 to select")), index.h("span", { class: "hint" }, index.h("bds-typo", { variant: "fs-10" }, "\u2318+\u21B5 for new tab")), index.h("span", { class: "hint" }, index.h("bds-typo", { variant: "fs-10" }, "esc to close")))))));
    }
    render() {
        return (index.h(index.Host, { key: '6cf2a68a9d8dbd04a849b6ba09c407c3424c762c' }, this.renderTrigger(), this.renderModal()));
    }
