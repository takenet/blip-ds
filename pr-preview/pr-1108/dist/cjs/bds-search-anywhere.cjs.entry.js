...
const SearchAnywhere = class {
    ...
    renderTrigger() {
        return (index.h("div", { class: "search-trigger" }, index.h("bds-input", { icon: "search", placeholder: this.triggerPlaceholder, readonly: true, dataTest: "search-anywhere-trigger", onClick: this.handleTriggerClick }, this.showShortcut && (index.h("div", { slot: "input-right", class: "keyboard-shortcut" }, index.h("bds-typo", { variant: "fs-12", bold: "regular" }, "\u2318K"))))));
    }
    renderResults() {
        const displayOptions = this.filteredOptions.slice(0, this.maxResults);
        if (displayOptions.length === 0) {
            return (index.h("div", { class: "no-results" }, index.h("bds-typo", { variant: "fs-14", bold: "regular" }, this.searchText.trim() === '' ? 'Start typing to search...' : 'No results found')));
        }
    ...
    renderModal() {
        ...
        return (index.h("div", { class: "search-modal-overlay", onClick: (e) => e.target === e.currentTarget && this.close() }, index.h("bds-paper", { elevation: "primary", class: "search-modal" }, index.h("div", { class: "search-modal-content", onKeyDown: this.handleModalKeydown }, index.h("div", { class: "search-modal-header" }, index.h("div", { class: "search-input-wrapper" }, index.h("bds-icon", { name: "search", size: "medium", class: "search-icon" }), index.h("bds-input", { ref: (el) => (this.searchInputComponent = el), type: "text", placeholder: this.placeholder, value: this.searchText, onBdsChange: this.handleInputChange, dataTest: "search-anywhere-input" }))), index.h("div", { class: "search-modal-results", ref: (el) => (this.resultsContainerElement = el) }, this.renderResults()), index.h("div", { class: "search-modal-footer" }, index.h("div", { class: "keyboard-hints" }, index.h("div", { class: "hint" }, index.h("bds-typo", { variant: "fs-10" }, "\u2191\u2193 to navigate")), index.h("div", { class: "hint" }, index.h("bds-typo", { variant: "fs-10" }, "\u21B5 to select")), index.h("div", { class: "hint" }, index.h("bds-typo", { variant: "fs-10" }, "\u2318+\u21B5 for new tab")), index.h("div", { class: "hint" }, index.h("bds-typo", { variant: "fs-10" }, "esc to close"))))))));
    }
    render() {
        return (index.h(index.Host, { key: '6e15874aaa08b7d2709e0899ed30499363e85243' }, this.renderTrigger(), this.renderModal()));
    }
