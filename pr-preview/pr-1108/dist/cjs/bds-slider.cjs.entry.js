...
const Slider = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd9b6db2b77469a9ac71f06b42502191cf926324c' }, index.h("input", { key: 'ab9222d566bdec5309be70a9cc0f3d2153ab130a', ref: this.refInputSlide, type: "range", class: {
                input_slide: true,
            }, value: this.value, onInput: this.onInputSlide, onMouseEnter: this.onInputMouseEnter, onMouseLeave: this.onInputMouseLeave, "data-test": this.dataTest }), index.h("div", { key: 'e4cd4bc71c69552c76adab8f7b99d5a0574e4a68', class: "track-bg" }, index.h("div", { key: 'adbb417fa2a9eabc533adefef4b519623eaccef5', class: { [`progress-bar`]: true, [`progress-bar-liner`]: this.type !== 'no-linear' }, ref: this.refProgressBar }, index.h("bds-tooltip", { key: 'd8389fd435f6e7f79a57112e36439338f40a6f5c', ref: this.refBdsTooltip, class: { [`progress-bar-tooltip`]: true }, position: "top-center", "tooltip-text": this.inputValue }, index.h("div", { key: '1b3301e96c1194df6b91253427542d57a5ec6b6e', class: { [`progress-bar-thumb`]: true } }))), this.markers &&
