...
const SelectChips = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'ec27907adb8747016edf3ede5051aa8f131d5886', class: "select", tabindex: "0", onFocus: this.setFocusWrapper, onBlur: this.removeFocusWrapper }, index.h("div", { key: '3e4ffd0bfab8312733ebccd72a4d3578b0187fd1', class: { element_input: true }, "aria-disabled": this.disabled ? 'true' : null, onClick: this.toggle }, index.h("div", { key: '24f8d74f695067267d4b02085561a418d3af2b49', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper }, this.renderIcon(), index.h("div", { key: '28e633afd620ad616e2eabb89f34d5e16bc670f4', class: "input__container" }, this.renderLabel(), index.h("div", { key: 'da19c2a8ab630ab0deab1666578eddc643534557', class: { input__container__wrapper: true } }, this.internalChips.length > 0 && (index.h("span", { key: 'fc70a3de3d5d9fa510c22c3f2b69759a93bc75de', style: { height: this.height, maxHeight: this.maxHeight }, class: "inside-input-left" }, this.renderChips())), index.h("input", { key: '821954bd118b0465282845210537c7e65169bd3f', ref: (input) => (this.nativeInput = input), class: { input__container__text: true }, name: this.inputName, maxlength: this.maxlength, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: () => this.handleOnBlur(), onChange: () => this.handleChange, value: this.value, disabled: this.disabled, "data-test": this.dataTest, onKeyDown: this.keyPressWrapper }))), index.h("div", { key: '00dfff67535632789d01e27ffd98c14f1fc41806', class: "select__icon" }, index.h("bds-icon", { key: '74e4f87ce9b72a5d7c8fd2d37cb98a80cff71316', ref: (el) => this.refIconDrop(el), size: "small", color: "inherit" })), this.success && index.h("bds-icon", { key: 'eca65224d2fa47ffd69a317dd13beab307edb408', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" })), this.renderMessage()), index.h("div", { key: '2e072aef03a395f00b2e8d08ace16a6fab1b161a', ref: (el) => this.refDropdown(el), class: {
                select__options: true,
                'select__options--open': this.isOpen,
            } }, internalOptions.map((option) => (index.h("bds-select-option", { key: this.generateKey(option.value), onOptionSelected: this.handler, value: option.value, status: option.status }, option.label))), index.h("slot", { key: '5427792415276a8464517b64a090a656f76cf484' }), this.canAddNew === true && this.enableCreateOption() && (index.h("bds-select-option", { key: 'f40c08f6a6a47610da43653b76abe7fb22799bed', id: "option-add", value: "add", onClick: () => this.handlerNewOption(this.nativeInput.value) }, this.newPrefix, this.nativeInput.value)), !this.canAddNew && this.enableCreateOption() && (index.h("bds-select-option", { key: 'b6398c20210a80cbc8a000d0c415aa839d3af03d', id: "no-option", value: "add" }, this.notFoundMessage)))));
    }
