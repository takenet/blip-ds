...
const BdsStep = class {
    ...
    render() {
        return (index.h("div", { key: 'a0748f1ca2dc9fd4e0f7e6dbca088cf6398fe911', class: "step" }, index.h("div", { key: '1f484fd5e103fc22a08c4ae9f0dcdf570af99b06', class: {
                step__content: true,
                ...
                'step--last': this.last,
            }, "data-test": this.dataTest }, index.h("div", { key: '0244bd77513adfc8b9b01bf3a69dc0ca78d7a027', class: {
            ...
            } }, this.completed && index.h("bds-icon", { key: '6e0f5eaee2c8e3ae6389088978afed64ab73218e', name: "true" }), !this.completed && index.h("bds-typo", { key: 'a5fd230a2df68822270ec9867ea00ba80e2466cd' }, this.index + 1)), index.h("bds-typo", { key: 'ed57207502db70efe8060eedc9e043005f4afdf9', variant: "fs-16", class: {
            ...
            }, bold: this.active ? 'bold' : 'regular' }, index.h("slot", { key: 'e8c522939df2928192c4055c73b9bb580b81dda2' })))));
    }
