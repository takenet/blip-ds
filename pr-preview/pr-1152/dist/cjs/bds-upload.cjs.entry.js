...
const BdsUpload = class {
    ...
    render() {
        return (index.h("div", { key: '3a723b952c40c6aa8c00edf05207c7c60e380e83', class: "upload" }, index.h("div", { key: '8c1d39ad90373de085495a944d7cd75f4192a58e', class: "upload-header" }, index.h("bds-icon", { key: '89e6afe5000e6ed58b11c47b6a5ab1aee1da4799', class: "upload-header_icon", size: "xxx-large", name: "upload" }), index.h("div", { key: '82ea9d997bc184d44ccb335354828597197324bb', class: "upload-header_text" }, index.h("bds-typo", { key: '8086c765fa0964a3ff7bbc7cbe097a021c80e0b9', variant: "fs-16", bold: "bold", "aria-label": this.titleName }, this.titleName), index.h("bds-typo", { key: '9f132ea033bcc93dbc96a90311c1edd84f2cea1c', variant: "fs-14", bold: "regular", "aria-label": this.subtitle }, this.subtitle))), this.error ? (index.h("bds-banner", { context: "inside", variant: "error", "aria-label": this.error }, this.error)) : (''), this.haveFiles && this.showListPreview ? (index.h("div", null, index.h("div", { class: "list-preview" }, this.files.map((names, index$1) => (index.h("div", { class: "upload__preview", key: index$1, id: "drop-area" }, index.h("div", { class: "preview", id: "preview" }, index.h("bds-icon", { size: "x-small", name: "attach" }), index.h("p", { class: "preview-text", id: "preview-text", "aria-label": names.name }, names.name), index.h("bds-button-icon", { class: "preview-icon", size: "short", icon: "trash", variant: "secondary", onClick: () => this.deleteFile(index$1), "aria-label": `delete ${names.name}`, "data-test": `${this.dtButtonDelete}-${index$1}` })))))), this.multiple ? (index.h("bds-typo", { variant: "fs-14", italic: true, class: "preview-length", "aria-label": termTranslate(this.language, 'uploaded') }, this.files.length > 1 ? `${this.files.length} ${termTranslate(this.language, 'uploaded')}` : '')) : (''))) : (''), index.h("div", { key: 'f46767fdeb4dbf1f8bb96be847d7145f02166514', class: { upload__edit: true } }, index.h("label", { key: 'a4d9bc03e632e138a2c3ab6dcc4befcf0695af96', class: { 'upload__edit--label': true, 'upload__edit--hover': this.hover }, id: "file-label", htmlFor: "file", "data-test": this.dtLabelAddFile, tabindex: "0", onKeyDown: this.handleKeyDown.bind(this) }, index.h("div", { key: '7716d464a8a0e7928f79fce1d5bd92c20d582b95', class: { 'text-box': true, 'text-box--hover': this.hover }, id: "file-text_box" }, this.hover ? (index.h("bds-typo", { class: "text", variant: "fs-14", bold: "regular", "aria-label": termTranslate(this.language, 'dropHere') }, termTranslate(this.language, 'dropHere'))) : (index.h("bds-typo", { class: "text", variant: "fs-14", bold: "regular", "aria-label": termTranslate(this.language, 'dropOrClick') }, termTranslate(this.language, 'dropOrClick')))), index.h("img", { key: '16c8ec5073add6515bbb9238415965833fe945be', class: { 'upload__img--invisible': true, 'upload__img--visible': this.hover }, src: patternSvg })), index.h("input", { key: '4a0ae01796ea356767b4f6156eca4847c9154d1b', ref: this.refInputElement, type: "file", name: "files[]", id: "file", class: "upload__input", multiple: this.multiple, accept: this.internalAccepts.length > 0 ? this.internalAccepts.toString() : this.accept, onChange: ($event) => this.onUploadClick($event.target.files), "data-test": this.dtInputFiles }))));
    }
