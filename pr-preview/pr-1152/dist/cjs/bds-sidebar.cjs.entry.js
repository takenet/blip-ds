...
const Sidebar = class {
    ...
    render() {
        return (index.h("div", { key: 'dc07bf50f1abda5223e611167fba96d6436eb797', class: {
                sidebar_dialog: true,
                is_open: this.isOpen,
                [`type_${this.type}`]: true,
            } }, this.type === 'over' ? (index.h("div", { class: { outzone: true }, onClick: () => this.onClickCloseButtom(), "data-test": this.dtOutzone })) : (''), index.h("div", { key: '279f833e63e0ec799101259fee1f4b4cace10363', class: {
                sidebar: true,
                is_open: this.isOpen,
                [`type_${this.type}`]: true,
                [`position_${this.sidebarPosition}`]: true,
                [`background_${this.background}`]: true,
            }, style: { width: `${this.width < 144 ? 144 : this.width}px` } }, this.hasHeaderSlot && (index.h("div", { key: 'e02a6f98a5d39afe207f767449c5437efe93e2c2', class: { header: true } }, index.h("div", { key: '4087e40497b17dd0c0818a7bdbd4a8a03015c126', class: { content: true } }, index.h("slot", { key: 'd123a6196493beb1e1319fd9b223cc9376e2562b', name: "header" })), this.type === 'fixed' ? ('') : (index.h("bds-button-icon", { class: {
                closeButton: true,
            }, icon: "close", size: "short", variant: "secondary", onClick: () => this.onClickCloseButtom(), dataTest: this.dtButtonClose })))), index.h("div", { key: 'c01a4e91490908af75b64f7a25ac149ddabda9aa', class: { body: true } }, index.h("div", { key: 'cb7348c218f17e3f61f40bc969c83a48654cdbef', class: { content: true, element_scrolled: true, margin: this.margin } }, index.h("slot", { key: '59d340a9f35fcec7c46d4246e70d59e6fa5561d5', name: "body" }))), this.hasFooterSlot && (index.h("div", { key: '567471bd57fc44901b5253cfa7bb47c397a2699c', class: { footer: true } }, index.h("div", { key: 'a80389443ef3461858c399daf8554a7b1a030762', class: { content: true } }, index.h("slot", { key: 'e1509d3c597eae64b5fa22892c38edf28f5361f8', name: "footer" })))))));
    }
