...
const BdsAutocomplete = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '5c38016eea67629b0f0e21a583ee1070e6abf32e', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: 'e984282d15c02248116ca226c05b5c8515831446', class: {
                input: true,
                select: true,
            ...
            }, onClick: this.onClickWrapper }, this.renderIcon(), index.h("div", { key: '927fa100058c26da3d666d0877ec0d4c1a2e20cb', class: "input__container", tabindex: "0", onFocusout: this.onFocusout }, this.renderLabel(), index.h("div", { key: '8ee55cc944d8a802e8b0de67a46d964c029d6176', class: { input__container__wrapper: true } }, ((_a = this.textMultiselect) === null || _a === void 0 ? void 0 : _a.length) > 0 && (index.h("bds-typo", { key: '3f9a432f8ea8aaa7b86d9aa66b024eaaabf48bac', variant: "fs-14", class: "inside-input-left" }, this.textMultiselect)), index.h("input", { key: '0ed161498e50f7aabee064293c3564b55e2d4d7f', class: { input__container__text: true }, ref: (input) => (this.nativeInput = input), disabled: this.disabled, onBlur: this.onBlur, onFocus: this.onFocus, onInput: this.changedInputValue, placeholder: this.placeholderState, type: "text", value: this.text, "data-test": this.dataTest, onKeyDown: this.keyPressWrapper.bind(this) }))), index.h("div", { key: '8be191bbc465cc913c2798ea433d735068ebba69', class: "select__icon" }, index.h("bds-icon", { key: '0612bde2939b7a408b2f4653b30b17e80af92ca6', size: "small", name: "error", theme: "solid", onClick: this.cleanInputSelection, class: {
                'icon-hidden': (this.clearIconOnFocus && (!this.isFocused || !this.isOpen)) || !this.value,
            } }), index.h("bds-icon", { key: 'dfee3c2494b1e9cb905a864c269332e24c3fc836', ref: (el) => this.refIconDrop(el), size: "small", color: "inherit" }))), this.renderMessage(), this.loading ? (index.h("div", { ref: (el) => this.refDropdown(el), class: {
                select__options: true,
                'select__options--open': this.isOpen,
            } }, index.h("bds-loading-spinner", { class: "load-spinner", size: "small" }))) : (index.h("div", { ref: (el) => this.refDropdown(el), class: {
                select__options: true,
                'select__options--open': this.isOpen,
            } }, this.selectionTitle && this.selectionType == 'multiple' && (index.h("bds-typo", { class: "selection-title", variant: "fs-10", bold: "bold" }, this.selectionTitle)), this.selectionType == 'multiple' && this.selectedAll && (index.h("bds-checkbox", { ref: this.refCheckAllInput, refer: `refer-multiselect`, label: termTranslate(this.language, 'allSelected'), name: "chack-all", class: "select-all", onBdsChange: (ev) => this.handleCheckAll(ev) })), ((_b = this.checkedOptions) === null || _b === void 0 ? void 0 : _b.length) > 0 && (index.h("span", { class: "content-divisor" }, index.h("span", { class: "divisor" }))), this.internalOptions ? (this.internalOptions.map((option, idx) => (index.h("bds-select-option", { onOptionSelected: this.handler, onOptionChecked: this.handlerMultiselect, selected: this.value === option.value, value: option.value, key: idx, bulkOption: option.bulkOption, status: option.status, "type-option": this.selectionType == 'multiple' ? 'checkbox' : 'default' }, option.label)))) : (index.h("slot", null))))));
    }
