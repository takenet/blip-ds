...
const BdsModal = class {
    ...
    render() {
        return (index.h("div", { key: '7c2245485dc05607d6bf3abc4ba765dcc1a56c26', class: {
                modal__dialog: true,
                'modal__dialog--open': this.open,
                [`modal__dialog--${this.size}`]: true,
            } }, index.h("div", { key: '5129cec6e970ab5688100a916e55b28f615208ac', class: { outzone: true }, onClick: () => this.onClickCloseButtom(), "data-test": this.dtOutzone }), index.h("div", { key: '3ae0b0b3cdad6485c8cf435ed6fbf053435a8b82', class: { modal: true, [`modal--${this.size}`]: true } }, this.closeButton && (index.h("bds-icon", { key: 'a8907580ef453f5227559bbcdd5af19f5c82e2b2', size: "medium", class: "close-button", name: "close", tabindex: "0", onClick: this.handleMouseClick, dataTest: this.dtButtonClose })), this.size == 'fixed' && index.h("slot", { key: '96c3a2963b970ddd6a98c2905e6d5c5c58463828' }), this.size !== 'fixed' && (index.h("div", { key: '61969dce2b8f71df5295ebd738fab61c9d50d367', class: { slot: true, [`slot--${this.size}`]: true } }, index.h("slot", { key: '37d83792edd16c2ce7a7807dfcb722375fd98119' }))))));
    }
