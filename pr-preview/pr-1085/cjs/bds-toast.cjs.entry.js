...
const BdsToast = class {
  ...
  render() {
    return (index.h("div", { class: {
        ...
        hide: this.hide,
      } }, this.variant === 'notification' && (index.h("bds-icon", { class: "toast__ballon", theme: "solid", name: "blip-chat", size: "brand" })), this.icon && index.h("bds-icon", { class: "toast__icon", theme: "outline", size: "medium", name: this.icon }), index.h("div", { class: "toast__content" }, this.toastTitle && (index.h("bds-typo", { variant: "fs-14", bold: "bold" }, this.toastTitle)), this.toastText && index.h("bds-typo", { variant: "fs-14", innerHTML: this.toastText })), index.h("div", { class: {
        toast__action: true,
