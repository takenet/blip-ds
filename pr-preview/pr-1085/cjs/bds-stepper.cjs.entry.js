...
const BdsStepper = class {
  ...
  render() {
    return (index.h(index.Host, { class: "stepper__container" }, index.h("slot", null)));
  }
  get el() { return index.getElement(this); }
};
BdsStepper.style = stepperCss;

exports.bds_stepper = BdsStepper;
