...
const Card = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { style: styleHost }, index.h("bds-paper", { border: this.clickable ? false : true, elevation: this.elevation, class: {
        card: true,
      ...
      }, height: this.height, width: this.width, bgColor: this.bgColor, "data-test": this.dataTest, "border-color": this.borderColor ? this.borderColor : 'border-1' }, index.h("div", { tabindex: "0", class: "focus", onKeyDown: this.handleKeyDown.bind(this) }), index.h("bds-grid", { xxs: "12", direction: "column", gap: "2", padding: "2" }, index.h("slot", null)))));
  }
