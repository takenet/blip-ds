...
const Tabs = class {
  ...
  render() {
    return (index.h(index.Host, { class: {
      ...
      } }, index.h("div", { class: "bds-tabs__header-button-container" }, index.h("bds-button-icon", { class: "bds-tabs__header-button", icon: "arrow-left", size: "short", id: "bds-tabs-button-left", onClick: () => this.handleScrollButtonClick("left" /* ScrollDirection.LEFT */), variant: "secondary" })), index.h("div", { class: "bds-tabs__header" }, index.h("slot", null)), index.h("div", { class: "bds-tabs__header-button-container" }, index.h("bds-button-icon", { class: "bds-tabs__header-button", icon: "arrow-right", size: "short", id: "bds-tabs-button-right", onClick: () => this.handleScrollButtonClick("right" /* ScrollDirection.RIGHT */), variant: "secondary" }))));
  }
