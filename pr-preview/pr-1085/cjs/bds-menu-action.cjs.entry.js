...
const BdsMenuAction = class {
  ...
  render() {
    ...
    return (index.h("div", { class: {
      ...
      }, onMouseOver: openSubmenu, onMouseOut: closeSubmenu }, index.h("button", { class: {
      ...
      } }, this.iconLeft && index.h("bds-icon", { class: "icon-item", name: this.iconLeft, theme: "outline", size: "small" }), index.h("div", { class: "content-item" }, this.buttonText && (index.h("bds-typo", { class: "title-item", variant: "fs-16", tag: "span" }, this.buttonText)), this.subtitle && (index.h("bds-typo", { class: "subtitle-item", variant: "fs-10", tag: "span" }, this.subtitle)), this.description && (index.h("bds-typo", { class: "description-item", variant: "fs-10", tag: "span" }, this.description))), this.subMenu && (index.h("bds-icon", { class: { arrow: true }, name: `arrow-${this.positionSubMenu}`, theme: "outline", size: "small" }))), this.subMenu && (index.h("div", { class: {
        menuaction__submenu: true,
        menuaction__submenu__open: this.delaySubMenu,
      }, style: zIndexSubmenu }, index.h("slot", null)))));
  }
