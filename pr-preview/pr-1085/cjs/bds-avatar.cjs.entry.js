...
const BdsAvatar = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("input", { type: "file", id: "file-input", accept: "image/*", onChange: (event) => this.onFileInputChange(event), style: { display: 'none' } }), index.h("div", { class: {
        avatar: true,
      ...
      }, onClick: (ev) => this.onUploadClick(ev), tabindex: "0", onKeyDown: (ev) => this.onUploadClick(ev), "data-test": this.dataTest }, this.ellipsis ? (index.h("div", { class: "avatar__btn" }, index.h("bds-typo", { margin: false, variant: this.typoSize, tag: "span" }, `+${this.ellipsis}`))) : this.thumbnail ? (this.upload || this.openUpload ? (index.h("div", { class: "avatar__btn" }, index.h("div", { class: `avatar__btn__img avatar__size--${this.size}`, style: thumbnailStyle }), index.h("div", { class: "avatar__btn__thumb" }, index.h("bds-icon", { class: "avatar__btn__thumb__icon", name: "upload", theme: "outline", size: this.iconSize })))) : (index.h("div", { class: "avatar__btn" }, index.h("div", { class: `avatar__btn__img avatar__size--${this.size}`, style: thumbnailStyle })))) : this.name ? (this.upload || this.openUpload ? (index.h("div", { class: "avatar__btn" }, index.h("bds-typo", { margin: false, class: "avatar__btn__text", variant: this.typoSize, tag: "span" }, firstName + lastName), index.h("div", { class: "avatar__btn__name" }, index.h("bds-icon", { class: "avatar__btn__name__icon", name: "upload", theme: "outline", size: this.iconSize })))) : (index.h("div", { class: "avatar__btn" }, index.h("bds-typo", { margin: false, class: "avatar__text", variant: this.typoSize, tag: "span" }, firstName + lastName)))) : this.upload || this.openUpload ? (index.h("div", { class: "avatar__btn" }, index.h("bds-icon", { class: "avatar__btn__icon", name: "user-default", theme: "outline", size: this.iconSize }), index.h("div", { class: "avatar__btn__empty" }, index.h("bds-icon", { class: "avatar__btn__empty__icon", name: "upload", theme: "outline", size: this.iconSize })))) : this.name === null && !this.hasThumb ? (index.h("div", { class: "avatar__btn" }, index.h("bds-icon", { class: "avatar__icon", name: "user-default", theme: "outline", size: this.iconSize }))) : (''))));
  }
  get el() { return index.getElement(this); }
};
BdsAvatar.style = avatarCss;

exports.bds_avatar = BdsAvatar;
