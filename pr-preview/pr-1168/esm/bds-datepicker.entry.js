...
const DatePicker = class {
  constructor(hostRef) {
    ...
    this.emptyConcludeDatepicker = createEvent(this, "emptyConcludeDatepicker", 7);
  ...
  render() {
    return (h(Host, { class: { datepicker: true } }, this.typeOfDate == 'single' ? (h("div", { class: {
