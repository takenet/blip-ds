...
const calendar = require('./calendar-d6db3803.js');
...
const DatePicker = class {
  constructor(hostRef) {
    ...
    this.concludeDatepicker = index.createEvent(this, "concludeDatepicker", 7);
    this.emptyConcludeDatepicker = index.createEvent(this, "emptyConcludeDatepicker", 7);
  ...
  render() {
    return (index.h(index.Host, { class: { datepicker: true } }, this.typeOfDate == 'single' ? (index.h("div", { class: {
