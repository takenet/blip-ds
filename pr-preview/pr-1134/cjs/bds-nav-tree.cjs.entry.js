...
const NavTree = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { tabindex: "0", onKeyDown: this.handleKeyDown.bind(this), class: "focus" }, index.h("div", { class: {
      ...
      }, size: "medium", name: this.icon, color: "inherit", theme: "outline" })) : (''), index.h("div", { class: "nav_main_text" }, this.text && (index.h("bds-typo", { class: { ['title-item']: true, [`title-item--loading`]: this.loading }, variant: "fs-14", tag: "span", "line-height": "small", bold: this.isOpen ? 'bold' : 'semi-bold' }, this.text)), this.secondaryText && (index.h("bds-typo", { class: { ['subtitle-item']: true, [`subtitle-item--loading`]: this.loading }, variant: "fs-12", "line-height": "small", tag: "span", margin: false }, this.secondaryText))), index.h("div", { class: "nav_main_content" }, index.h("slot", { name: "header-content" })), this.navTreeChild && (index.h("bds-icon", { name: "arrow-down", class: {
        [`nav_main_arrow`]: true,
