...
const BdsMenu = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4f7c34c68dd427bfd59e014c4f4ff610e98e359c' }, index.h("div", { key: 'dd7e5c5f09a0df133458f2c76984bcf5e8d1c08c', ref: this.refMenuElement, class: {
                menu: true,
                [`menu__${this.position}`]: true,
                [`menu__open`]: this.open,
            }, style: menuPosition, part: "bds-menu__container" }, index.h("slot", { key: '9d4b91e84f9ce6c4b298cd0bc91059ae91b66613' })), this.open && index.h("div", { key: '63117e957ae3da41519ee5ea67b1cfbe888129ea', class: { outzone: true }, onClick: (ev) => this.onClickCloseButtom(ev) })));
    }
