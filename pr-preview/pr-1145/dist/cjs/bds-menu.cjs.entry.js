...
const BdsMenu = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'eefbfe9249b8945ad1e392e8da192200305edaf9' }, index.h("div", { key: '141d2c3c12809030a7dea5b59cce43354e61d792', ref: this.refMenuElement, class: {
                menu: true,
                [`menu__${this.position}`]: true,
                [`menu__open`]: this.open,
            }, style: menuPosition, part: "bds-menu__container" }, index.h("slot", { key: '82d80465f1ccb1e069adab0cd82efe264ac37250' })), this.open && index.h("div", { key: 'd7d25cc4a82bccff8dca51679740908beb54fed2', class: { outzone: true }, onClick: (ev) => this.onClickCloseButtom(ev) })));
    }
