...
const BdsAutocomplete = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: 'f226d3800c5cecbc67a00f83674b34d48361be7d', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '6456a23accb7adef88832dd37df16a2db69cbecf', class: {
                input: true,
                select: true,
            ...
            }, onClick: this.onClickWrapper }, this.renderIcon(), index.h("div", { key: '2b7cb3428fe0173b1f01dbd1d09cf5f611085d3e', class: "input__container", tabindex: "0", onFocusout: this.onFocusout }, this.renderLabel(), index.h("div", { key: '248ee75d064b64772c5a8ebd46137834fc577456', class: { input__container__wrapper: true } }, ((_a = this.textMultiselect) === null || _a === void 0 ? void 0 : _a.length) > 0 && (index.h("bds-typo", { key: '04a95ae0b3023df04e2e9509c386765898ebfaf4', variant: "fs-14", class: "inside-input-left" }, this.textMultiselect)), index.h("input", { key: '958a00b4bacc0f025d7431e2dd346b09ce646b1a', class: { input__container__text: true }, ref: (input) => (this.nativeInput = input), disabled: this.disabled, onBlur: this.onBlur, onFocus: this.onFocus, onInput: this.changedInputValue, placeholder: this.placeholderState, type: "text", value: this.text, "data-test": this.dataTest, onKeyDown: this.keyPressWrapper.bind(this) }))), index.h("div", { key: '0e845f5f4cc54f4bdb48188b3def7f9c9ffca073', class: "select__icon" }, index.h("bds-icon", { key: 'cd2bbeef646450a3555453e2f6093b8690740240', size: "small", name: "error", theme: "solid", onClick: this.cleanInputSelection, class: {
                'icon-hidden': (this.clearIconOnFocus && (!this.isFocused || !this.isOpen)) || !this.value,
            } }), index.h("bds-icon", { key: '34fd2b6e2569890588bad00f4bccf8aa53299973', ref: (el) => this.refIconDrop(el), size: "small", color: "inherit" }))), this.renderMessage(), this.loading ? (index.h("div", { ref: (el) => this.refDropdown(el), class: {
