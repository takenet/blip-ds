...
const DatePicker = class {
  constructor(hostRef) {
    ...
    this.selectTimeInputOnFocus = (ev) => {
      const bdsInput = ev.target;
  ...
  render() {
    return (index.h(index.Host, { class: { datepicker: true } }, this.typeOfDate == 'single' ? (index.h("div", { class: {
        ...
        datepicker__inputs__open: this.open,
      } }, index.h("bds-input", { class: "input-start", ref: this.refInputSetDate, label: calendar.termTranslate(this.language, 'from'), value: this.typeOfDate === 'period-time'
        ? this.valueDate
          ? `${calendar.typeDateToStringDate(this.valueDate)} ${this.startTime}`
          : ''
        : this.valueDate, placeholder: this.typeOfDate === 'period-time' ? 'dd/mm/aaaa HH:MM' : undefined, disabled: this.disabled, type: this.typeOfDate === 'period-time' ? 'text' : 'date', readonly: this.typeOfDate === 'period-time', maxlength: this.typeOfDate === 'period-time' ? 16 : 10, icon: "calendar", onClick: () => this.openDatepicker(), onFocus: () => this.onFocusDateSelect(), onBdsInput: (ev) => this.onInputDateSelected(ev), danger: this.errorMsgDate ? true : false, errorMessage: this.errorMsgDate, dataTest: this.dtInputStart }), index.h("bds-input", { class: "input-end", ref: this.refInputSetEndDate, label: calendar.termTranslate(this.language, 'to'), value: this.typeOfDate === 'period-time'
        ? this.valueEndDate
          ? `${calendar.typeDateToStringDate(this.valueEndDate)} ${this.endTime}`
          : ''
        : this.valueEndDate, placeholder: this.typeOfDate === 'period-time' ? 'dd/mm/aaaa HH:MM' : undefined, disabled: this.disabled || this.errorMsgDate ? true : !this.dateSelected, type: this.typeOfDate === 'period-time' ? 'text' : 'date', readonly: this.typeOfDate === 'period-time', maxlength: this.typeOfDate === 'period-time' ? 16 : 10, icon: "calendar", onClick: () => this.openDatepicker(), onFocus: () => this.onFocusEndDateSelect(), onBdsInput: (ev) => this.onInputEndDateSelected(ev), danger: this.errorMsgEndDate ? true : false, errorMessage: this.errorMsgEndDate, dataTest: this.dtInputEnd }))), index.h("div", { ref: this.refMenuElement, class: {
        datepicker__menu: true,
        datepicker__menu__open: this.open,
      } }, this.message && (index.h("bds-grid", { margin: "b-2" }, index.h("bds-banner", { variant: this.variantBanner, context: "inside" }, this.message))), this.typeOfDate == 'single' ? (index.h("bds-datepicker-single", { ref: this.refDatepickerSingle, startDate: this.startDateLimit && calendar.dateToDayList(this.startDateLimit), endDate: this.endDateLimit && calendar.dateToDayList(this.endDateLimit), dateSelect: this.dateSelected, onBdsDateSelected: (event) => this.selectDate(event), language: this.language, dtButtonPrev: this.dtButtonPrev, dtButtonNext: this.dtButtonNext, dtSelectMonth: this.dtSelectMonth, dtSelectYear: this.dtSelectYear })) : (index.h("bds-datepicker-period", { ref: this.refDatepickerPeriod, startDate: this.startDateLimit && calendar.dateToDayList(this.startDateLimit), endDate: this.endDateLimit && calendar.dateToDayList(this.endDateLimit), startDateSelect: this.dateSelected, stateSelect: this.stateSelect, endDateSelect: this.endDateSelected, onBdsStartDate: (event) => this.selectDate(event), onBdsEndDate: (event) => this.selectEndDate(event), onBdsClickDayButton: (event) => this.whenClickCalendar(event), language: this.language, dtButtonPrev: this.dtButtonPrev, dtButtonNext: this.dtButtonNext, dtSelectMonth: this.dtSelectMonth, dtSelectYear: this.dtSelectYear })), this.typeOfDate == 'period-time' && (index.h("div", { class: { 'datepicker__menu__time-inputs': true } }, index.h("bds-input", { label: calendar.termTranslate(this.language, 'startTime'), value: this.startTime, type: "text", placeholder: "HH:MM", maxlength: 5, pattern: "([01][0-9]|2[0-3]):[0-5][0-9]", icon: "clock", onBdsFocus: (ev) => this.selectTimeInputOnFocus(ev), onBdsInput: (ev) => this.onInputStartTimeSelected(ev) }), index.h("bds-input", { label: calendar.termTranslate(this.language, 'endTime'), value: this.endTime, type: "text", placeholder: "HH:MM", maxlength: 5, pattern: "([01][0-9]|2[0-3]):[0-5][0-9]", icon: "clock", onBdsFocus: (ev) => this.selectTimeInputOnFocus(ev), onBdsInput: (ev) => this.onInputEndTimeSelected(ev) }))), index.h("div", { class: { datepicker__menu__footer: true } }, index.h("bds-button", { class: "bt-reset", size: "short", variant: "secondary", onClick: () => this.clearDate(), dataTest: this.dtButtonClear }, calendar.termTranslate(this.language, 'reset')), index.h("bds-button", { class: "bt-conclude", size: "short", onClick: this.clickConcludeDatepicker, dataTest: this.dtButtonConfirm }, calendar.termTranslate(this.language, 'conclude')))), this.open && (index.h("div", { class: { outzone: true }, onClick: () => this.clickConcludeDatepicker(), "data-test": this.dtOutzone }))));
  }
